<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aadharForm.aspx.cs" Inherits="aadharForm" %>
...
<head id="Head1" runat="server">
	...
	// var PIDOPTS = '<PidOptions ver=\"1.0\">' + '<Opts fCount=\"1\" fType=\"0\" iCount=\"\" iType=\"\" pCount=\"\" pType=\"\" format=\"0\" pidVer=\"2.0\" timeout=\"20000\" otp=\"\" wadh=\"\" posh=\"\"/>' + '</PidOptions>';
...
<body>
    ...
    <asp:TextBox ID="TextBox1" runat="server" Text="Shivesh" Visible="False"></asp:TextBox>
            <button id="Button2" type="button" onclick="Capture()" runat ="server" visible="False">Capture</button>
