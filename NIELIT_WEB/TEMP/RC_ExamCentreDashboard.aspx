<%@ Page Title="RC Dashboard" Language="VB" MasterPageFile="~/Master-doeacc.master" AutoEventWireup="false" CodeFile="RC_ExamCentreDashboard.aspx.vb" Inherits="RC_ExamCentreDashboard" %>
            ...
            <asp:GridView ID="gvCityPreference" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <%# Eval("city_code") %>
                            <span class="sub"><%# Eval("city_name") %></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
                                ...
                                <asp:GridView ID="gvPrevCentres" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Venue Code">
                                            <ItemTemplate>
                                                <span class="cycle-tag"><%# Eval("venue_code") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Exam Cycle">
                                            <ItemTemplate>
                                                <span class="cycle-tag"><%# Eval("exam_cycle") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <div class="venue-inner">
                                ...
                                <asp:GridView ID="gvVenues" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Venue Code">
                                            <ItemTemplate>
                                                <span class="venue-code-tag"><%# Eval("venue_code") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="ES Name" DataField="es_name" />
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkEditVenue" runat="server" CssClass="action-link" CommandName="EditVenue" CommandArgument='<%# Eval("venue_id") %>' Text="Edit" />
                                                <asp:LinkButton ID="lnkDeleteVenue" runat="server" CssClass="action-link" CommandName="DeleteVenue" CommandArgument='<%# Eval("venue_id") %>' Text="Delete"
