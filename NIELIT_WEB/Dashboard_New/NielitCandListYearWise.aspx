<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DashBoard.master" AutoEventWireup="true" CodeFile="NielitCandListYearWise.aspx.cs" Inherits="Dashboard_New_NielitCandListYearWise" %>
    ...
    <script type="text/javascript">
        ...
        function GridViewBind() {
            ...
            $.ajax({
                ...
                url: "Services/Graph.asmx/RegisterCand",
                data: "{}",
                dataType: "json",
            ...
            function DreawChart(series) {
                ...
                $('#divRegGraph').highcharts({
                    ...
                    title: {
                        ...
                        text: 'NIELIT Students Registered  Till ' + valDate + ''
                    },
                    tooltip: {
                ...
                <center>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-sm-10 ">
                            ...
                            <th style="text-align:center;">Total  Registered Candidates Year-Wise</th>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" HeaderStyle-Font-Size="14px"
                                    ...
                                    OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged" AllowPaging="False" PageSize="45" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
