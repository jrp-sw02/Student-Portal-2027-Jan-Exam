                    ...
                    using (EConnectContext context = new EConnectContext())
                    {
                        ...
                        if (demandNote != null)
                        {
                            if (demandNote.enmPaymentStatus == enmPaymentStatus.Pending)
                            {
                                ...
                                else if (demandNote.enmApplicationType == enmApplicationType.CourseProjectApplication)
                                {
                                    ServiceID = context.CourseProjectApplications.Where(s => s.DemandNoteID == demandNote.ID).FirstOrDefault().Course.ProjectServiceID;
                                }
