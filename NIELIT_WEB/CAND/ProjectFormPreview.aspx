<%@ Page Title="Project Form" Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="ProjectFormPreview.aspx.cs"
    Inherits="ProjectFormPreview" Debug="true" %>
...
<body style="background-color: #ffffff;">
    <form id="form1" runat="server">
        <table  align="center" border="0" cellpadding="0" cellspacing="0" width="977px">
            <tr>
                <td align="center">
                    <asp:Label ID="lblErrorMsg" runat="server" EnableTheming="false" CssClass="error" Width="99%"
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="977px" id="Tblpreview"
        ...
        <tr id="tr_receipt" runat="server" visible="false" style="height: 30px;">
            <td align="right" style="border-bottom: 1px solid #000000; font-size:20px;" valign="middle">
               <asp:HyperLink ToolTip="Generate Receipt" Style="float: right; padding-bottom: 5px;padding-top: 5px;padding-right:5px; color: Blue; cursor: pointer"
                  ID="lbn_generate_receipt" runat="server" Target="_blank">Click here to Generate Payment Receipt</asp:HyperLink>
            ...
            <td align="left" valign="top">
                <table style="width: 100%;" class="preview" border="0" cellspacing="0" cellpadding="2">
                    ...
                    <tr class="head1">
                        <td colspan="2">
                            5.
                            <asp:Label ID="Label1" runat="server" Text="Project Details / प्रोजैक्ट का विवरण"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr class="normal" runat="server" id="Tr1">
                        ...
                        <td align="left" valign="top" id="Td3" runat="server" class="rightBorder">
                            <asp:Label ID="lblCentre1" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="normal" runat="server" id="Tr2">
                        ...
                        <td align="left" valign="top" id="Td5" runat="server" class="rightBorder">
                    ...
                    <tr class="normal" runat="server" id="Tr3">
                        <td valign="top" id="Td6" runat="server">
                            <asp:Label ID="Label8" runat="server" Text="Project Appearing / प्रोजैक्ट देने"></asp:Label>
                        </td>
                        <td align="left" valign="top" id="Td7" runat="server" class="rightBorder">
                            <asp:Label ID="lblprojectmodules" Text="NA" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <!--Added for CHMT(O) project 17 may 2024-->
                    <tr class="normal" runat="server" id="Tr1">
                        <td valign="top" id="Td2" runat="server">
                            <asp:Label ID="Label4" runat="server" Text="Project Title / प्रोजैक्ट देने"></asp:Label>
                        </td>
                        <td align="left" valign="top" id="Td3" runat="server" class="rightBorder">
                            <asp:Label ID="lblProjectTitle" Text="" runat="server"></asp:Label>
                        </td>
                    </tr>  

                    <%--<tr class="normal" runat="server" id="Tr4">
                        <td valign="top" id="Td8" runat="server">
                            <asp:Label ID="Label10" runat="server" Text="Practicals Appearing / प्रैक्टिकल देने"></asp:Label>
                        </td>
                        <td align="left" valign="top" id="Td9" runat="server" class="rightBorder">
                    ...
                    <tr class="normal" runat="server" id="Tr5">
                        <td valign="top" id="Td10" runat="server">
                            <asp:Label ID="Label12" runat="server" Text="">No. of Modules & Fee/Module / मॉड्यूल की संख्या & शुल्क/मॉड्यूल  
                                                                 </asp:Label>
                        </td>
                        <td align="right" valign="top" id="Td11" runat="server" class="rightBorder">
                            <asp:Label ID="lblprojectCount" Style="float: left;" Text="" runat="server"></asp:Label>
                            <asp:Label ID="lblprojectFee" Text="" runat="server"> </asp:Label>
                        </td>
                    </tr>
                   <%-- <tr class="normal" runat="server" id="Tr7">
                    ...
                    <tr class="normal" runat="server" id="Tr6">
                        <td valign="top" id="Td12" runat="server">
                            <asp:Label ID="Label5" runat="server" Text="Form Processing Fees / फार्म का प्रसंस्करण शुल्क"></asp:Label>
                        </td>
                        <td align="right" valign="top" id="tdProcessingFee" runat="server" class="rightBorder">
                            <asp:Label ID="Label7" Text="0.00 (Not Applicable)" runat="server"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr class="normal" id="TrPaymentModeTransactionNo" runat="server">
                        <td align="left" valign="top">
                            ...
                            भुगतान रसीद की ट्रांजेक्शन संख्या
                        </td>
                        <td class="rightBorder">
                    ...
                    <tr class="normal" id="trPaymentNoteInstitute" runat="server">
                        <td align="left" valign="top" colspan="2" class="rightBorder">
                            &nbsp;<strong>Note *: Please pay project fee to the institute mentioned above in
                                the form. /कृपया प्रोजैक्ट शुल्क का भुगतान ऊपर वर्णित संस्थान को करें |</strong>
                        </td>
                    </tr>
                    <tr class="normal" id="trPaymentNoteInstituteSelf" runat="server">
                        <td align="left" valign="top" colspan="2" class="rightBorder">
                            &nbsp;<strong>Note *: Please pay project fee through available payment options and
                                after making payment submit project along with this form and payment receipt for institute verification to the institute
                                mentioned above in the form. /कृपया भुगतान के लिए उपलब्ध विकल्पों में से किसी एक
                                का चयन करके प्रोजैक्ट शुल्क का भुगतान कर ऊपर वर्णित संस्थान को सत्यापन के लिए प्रोजैक्ट
                                के साथ फार्म एवं भुगतान रसीद प्रस्तुत करें |</strong>
                        </td>
                    </tr>
                    <tr class="normal" id="tr12" runat="server">
                        <td align="left" valign="top" colspan="2" class="rightBorder">
                            &nbsp;<strong>Note *: Last date of payment of project fee / प्रोजैक्ट शुल्क का भुगतान
                    ...
                    <tr class="normal">
                        <td align="left" valign="top" colspan="2" class="rightBorder" style="text-align: justify;">
                            ...
                            checks before submitting the Online Project Form. I have read and understood
                            ...
                            related to my Project. I have noted that the Examination Authority
                            has the right to withhold my result ever after appearing in the Project in addition
                            ...
                            for appearing in different projects and I confirm that I fullfill the eligibility
                            for the Project modules, I have applied for.
                        </td>
                    </tr>
