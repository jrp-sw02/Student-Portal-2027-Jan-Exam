<%@ Page Title="Special Re Registration Form" Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="SpecialReRegistration.aspx.cs"
    Inherits="SpecialReRegistration" Debug="true" %>
    ...
    <form id="form1" runat="server">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="500px" id="Tblpreview"
            ...
            <tr>
             ...
             <tr>
     <td align="center">
         <strong id="lblMainHeading" runat="server" style="text-align: center" class="headfont">SPECIAL RE REGISTRATION FORM  
         <%--<asp:Label ID="Label16" runat="server" Text=""></asp:Label>--%></strong>
     </td>
 </tr>
                <tr id="trlblnote" runat="server" visible="false">
        <td colspan="4" style="width: 100%;">
            <span class="lblWarningNew" style="font-size: 15px; width: 99%">Note: Fields highlighted in color are editable. Please verify and update the information using given link before submitting the application.
</span>
        </td>
    </tr>
            <tr>
                ...
                <td align="center">
                    <table style="width: 100%;" class="preview" cellpadding="1" cellspacing="0">
                        <tr class="normal" style="font: bold 18px arial;">
                              <td align="center" id="lblRegFCourse" width="15%" runat="server">Registration For Course
  </td>
  <td align="center" width="15%">Registration Number
  </td>
                            <td align="center" width="15%">Registration Date
                            </td>
                            <td align="center" width="15%">Valid Upto Date
                            </td>
                            <td align="center" width="15%">Registration Type&nbsp;
                            </td>
    ...
    <div class="DivImage">
     ...
     align="center">
     <asp:Label ID="LblCourse" runat="server" Font-Size="Larger"></asp:Label>
 </td>
                             <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding:10px;"
     align="center">
     <asp:Label ID="lblRegistrationNo" runat="server" Font-Size="Larger"></asp:Label>
 </td>
                            <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding:10px;"
                                align="center">
                            ...
                            <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding:10px;"
                             ...
                             <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding:10px;"
     align="center">
     <asp:Label ID="lblRegistrationType" runat="server" Font-Size="Larger"></asp:Label>
 </td>
                          <%--  <td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; padding:10px;"
                                valign="middle">
