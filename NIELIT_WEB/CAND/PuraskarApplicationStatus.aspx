<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MyInfo.master"
    CodeFile="PuraskarApplicationStatus.aspx.cs" Inherits="PuraskarApplicationStatus"  Debug="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <table id="Tblfilter" align="center" class="sample3" width="100%" runat="server" cellpadding="3" cellspacing="1">
        <tr class="gdalternate1">
            <td width="40%">
                <asp:Label ID="Lblsubheading" runat="server" Font-Size ="Large" Text="<b>Puraskar Application Status</b>"></asp:Label>
            </td>
        ...
        <tr class="gdrow1">
            <td width="40%">
                Enter Online Reference ID</td>
            <td>
                <asp:TextBox ID="TxtAppno" runat="server" Width="139px"  MaxLength="30" ></asp:TextBox>
                <span style="text-align:left; vertical-align:top; font-size:8pt;" >(Online Reference ID printed on your application form)</span> 
            </td>
        </tr>
        ...
        <tr class="gdrow1">
            ...
            <td>
                <asp:TextBox ID="txtcode" runat="server" Width="139px" MaxLength="6" onkeypress="checkNumber(this,6,0,event)"
