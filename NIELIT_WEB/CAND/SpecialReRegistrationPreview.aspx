<%@ Page Title="Mercy Case Preview Form" Language="C#" AutoEventWireup="true"  CodeFile="SpecialReRegistrationPreview.aspx.cs"
    Inherits="SpecialReRegistrationPreview" Debug="true" %>
        ...
        <tr>
            <td>
                <uc1:NormalHeader ID="NormalHeader1" runat="server" />
                    ...
                    <tr>
    <td align="center">
        <strong style="text-align: center" class="headfont">SPECIAL REGISTRATION FORM  
     </strong>
    </td>
</tr>
        <tr>
...
runat="server"></asp:Label>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblIsConsentRelation" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification4" runat="server"></asp:Label>
 </td>
    <td>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblproviderName" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification5" runat="server"></asp:Label>
 </td>
    <td>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblAuthMode" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification6" runat="server"></asp:Label>
 </td>
    <td>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblAuthId" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification7" runat="server"></asp:Label>
 </td>
    <td>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblConsentDate" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification8" runat="server"></asp:Label>
 </td>
    <td>
    ...
    <td class="rightBorder" colspan="3">
        <asp:Label ID="lblConsentTime" runat="server"></asp:Label>
                          ...
                          <tr class="normal">
                               <td>
                                   <asp:Label ID="LblIdentification9" runat="server"></asp:Label>
 </td>
    <td>
