            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                if (currentCourse.enmCourseType == enmCourseType.CertificationCourse)
                {
                    ...
                    if (download != null)
                    {
                        ...
                        //else
                        //{
                            Lbename.Text = (!string.IsNullOrEmpty(download.Exam.Name.ToUpper())) ? "CANDIDATE ADMIT CARD <br /> VALID FOR " + download.Exam.Name.ToUpper() + "  EXAMINATION ONLY RESCHEDULE IN MAY 2022" : "";
                        //}
