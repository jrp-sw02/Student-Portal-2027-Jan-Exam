...
public partial class CertificateAdmitCardVersion2 : BasePage
{
    ...
    protected void RenderPage(Int32 currentCourseID)
    {
        try
        {
            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                {                   
                    var download = context.CertificateExamApplications.Find(appid);
    ...
    protected void showofficeaddress()
    {
        try
        {
            using (EConnectContext ctx = new EConnectContext())
            {
                ...
                var organisation = ctx.Organizations.Find(orgID);
