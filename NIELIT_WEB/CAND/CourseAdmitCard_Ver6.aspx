<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseAdmitCard_Ver6.aspx.cs" Debug="true"
...
<body style="background-color: #FFFFFF;">
    <form id="form1" runat="server" style="margin-top: 10px;">
        <table align="center" border="0" cellspacing="0" style="font-size: 14px; font-family: Arial;"
            ...
            <tr class="normal">
                <td colspan="3" align="center" style="padding: 5px;">
                     <span style="width: 110px; float: right; font-size: 12px;">Version : 1.6</span>
                </td>
            </tr>
            <tr>
