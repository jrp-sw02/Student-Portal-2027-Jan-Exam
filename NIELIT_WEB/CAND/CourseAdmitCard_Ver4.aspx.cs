            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                if (currentCourse.enmCourseType == enmCourseType.CertificationCourse)
                {
                    ...
                    if (download != null)
                    {
                        ...
                        {
                            Lbename.Text = (!string.IsNullOrEmpty(download.Exam.Name.ToUpper())) ? "CANDIDATE ADMIT CARD <br /> VALID FOR " + download.Exam.Name.ToUpper() + "  EXAMINATION ONLY" : "";
                        }
            ...
            var newExam = (  from m in context.Exams
             ...
             var applmerge = (from m in context.CourseExamApplications
                             ...
                             new { m.RegistrationNumber, m.ExamID } equals new { c.RegistrationNumber, c.ExamID }
                              ...
                              && m.ApplicationStatusID == 10 && (m.PaymentStatusID == 2 || m.PaymentStatusID == 4)
                             select c).FirstOrDefault();
