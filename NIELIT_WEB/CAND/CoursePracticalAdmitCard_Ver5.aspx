<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CoursePracticalAdmitCard_Ver5.aspx.cs" Inherits="CAND_CoursePracticalAdmitCard_Ver5" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="956px">
        ...
        <tr>
            <td align="center" valign="middle" colspan="3">
                <asp:ImageButton ID="BtnPrint" runat="server" Style="float: right;"
        ...
        <tr>
                        <td colspan="3" align="center">
                            VALID FOR
                            <asp:Label ID="Lbename" runat="server" Text=""></asp:Label>&nbsp; PRACTICAL EXAMINATION ONLY
                        </td>
                    </tr>
       <br/>
        <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                        <td colspan="3" align="left">
                            <strong>*No request regarding Change of Examination Centre or Schedule will be entertained.</strong>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" align="center">
                            <strong>INSTRUCTIONS TO BE FOLLOWED BY CANDIDATES</strong>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: justify;">
                            ...
                            6.	Candidates are advised not to bring any valuable items to the examination centre as arrangements for the safekeeping of such items cannot be assured.<br />
                            ...
                            8.	No candidate shall give or receive aid from any other applicant or source during the examination. No pocketbooks, handbags, books, notes, written or printed material, CDs or data of any kind is allowed in the examination hall. Such cases will be treated as unfair means cases and are liable for strict action.<br />
                            9.	Smoking or Chewing Tobacco or use of Alcohol/Intoxicating substances is strictly prohibited at the Examination Centre. Candidates found doing so during the course of the Examination, shall be liable, to be expelled from the Examination Centre by the Examination Superintendent/Examiner/Observer.<br />
                            10.	Candidates breaking Exam Centre rules, carrying knives or weapons, or using unfair means that disrupt the exam's integrity will be expelled. Their results will be withheld, and appropriate action will be taken as per the SoP. The SoP will make the final decision on penalties.<br />
                            11.	Candidates should follow the instructions of the Invigilator/Centre Superintendent/ Observers of the Examination Centre concerned. Candidates must thoroughly read and follow the instructions which will appear on their respective Exam Panel before starting the examination.<br />
                        </td>
                    </tr>
                </table>
            </td>
