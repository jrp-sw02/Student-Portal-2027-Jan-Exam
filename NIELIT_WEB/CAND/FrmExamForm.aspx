<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmExamForm.aspx.cs"
    Inherits="FrmExamForm" Debug="true" %>
...
return false;
        ...
        function validate() {
         ...
         function CnfrmationBox_moduleCancel() {

             if (!ischecked("chkdisclamier1", "Declaration"))
                 return false;
             var value = document.getElementById("levelNameHidden").value;
             if (value == '3') {
                 if (!confirm("Are you sure you want to Cancel for selected modules!"))
                     return false;
                 return true;
             } else {
                 if (!confirm("Are you sure you want to Cancel for selected modules!"))
                ...
                <tr>
                        ...
                        <table id="tblMain" runat="server" class="sample3" style="width: 100%; text-align: left" border="0" cellpadding="3"
                            ...
                            <tr class="gdalternate1" id="lblMediumrow" runat="server">
                                ...
                                <td style="padding-left: 0px;" align="left">
                                    <asp:RadioButtonList ID="rblMedium" runat="server" RepeatDirection="Horizontal">
                            ...
                            <tr class="gdalternate1">
                                ...
                                <td style="padding-left: 0px;" align="left">
                                    <asp:DropDownList ID="ddlCandidateType" runat="server" Width="537px"
                            ...
                            <tr class="gdrow1">
                                ...
                                <td style="padding-left: 0px;" align="left">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlPaymentOption" runat="server" Width="537px" TabIndex="34">
                          ...
                          <%--Start added code date 27032023 for Any N Module Cancel O Level Specl option--%>
                             <tr id="trModuleOptionOlevelSpecl" runat="server" visible="false">
                                    ...
                                    <table class="sample3" style="width: 100%; text-align: left;" border="0" cellpadding="3"
                                        ...
                                        <tr class="gdalternate1">
                                            <td style="vertical-align: top; " class="auto-style8">
                                                <asp:Label ID="lblserveOlevelSpecl" runat="server"></asp:Label>
                                            </td>
                                            <td class="auto-style9" id="frty" runat="server" visible="false">
                                              <asp:Label ID="lblCoutMessageOlevelSpecl" runat="server" Text="2." visible="false"></asp:Label> <span style="color:red;font-size:12px;font-weight:bold"> Transfer of candidature from old evaluation pattern of the examination system to the current evaluation pattern of the examination system.</span><br/>
                                                <span style="color:black;font-size:10px;font-weight:bold">To enable the above, the candidate is required to surrender any of the one module of his/her choice and needs to apply for the corresponding module in the current evaluation pattern of the examination system. &nbsp;&nbsp;<a target="_blank" style=" font-size: 11px; color: blue;font-style:italic " href="https://nielit.gov.in/sites/default/files/headquarter/pdf/20240424_Notification_OLevel.pdf">Please click here to see the notification</a></span><br/>
                                                <span style="color:maroon;font-size:10px;font-weight:bold">Please Select one of the below listed passed module which you want to cancel in the previous pattern of the Examination and apply equivalent module in the current evaluation pattern of the examination system</span>
                                                <asp:HiddenField ID="lblCoutMessageOlevelSpeclhidden" runat="server" />
                                               
                                            </td>
                                           
                                        </tr>

                                        <tr id="trModuleOptionOlevelSpecl1" class="gdrow1" runat="server" visible="false">
                                            <td style="vertical-align: top; width: 3%;"></td>
                                            <td style="vertical-align: top;" align="left">
                                                <asp:UpdatePanel ID="UpdatePanelOlevelSpecl" runat="server">
                                                    <ContentTemplate>
                                                        <asp:CheckBoxList ID="chklistModulesOlevelSpecl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="chklistModulesOlevelSpecl_SelectedIndexChanged">
                                                        </asp:CheckBoxList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chklistModulesOlevelSpecl" EventName="SelectedIndexChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </td>
                                        ...
                                        <tr class="gdalternate1">
                                            <td style="vertical-align: top; " colspan="3" class="auto-style12"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <td colspan="3" style="vertical-align: top; padding: 0;">
                                    <table class="sample3" style="width: 100%; text-align: left;" border="0" cellpadding="3"
                                        ...
                                        <tr class="gdalternate1">
                                            ...
                                            <td id="divpract1" runat="server" style="width: 27%">Practicals
                                            <td id="divpract" runat="server" colspan="2" style="width: 27%">Practicals
                                            </td>
                                        </tr>
                            ...
                            <tr id="ExamCenterChh" class="head1" runat="server">
                                <td colspan="3">
                            ...
                            <tr class="head1" id="trImprovementHead" runat="server">
                                <td colspan="3">
                            ...
                            <tr id="FeedtlsId" runat="server" class="head1">
                                <td colspan="3">
                                    <asp:Label ID="Label7" runat="server" Text="5."></asp:Label>
                                    Fee Details
                                </td>
                            </tr>
                            <tr id="panelfeedetails" runat="server" class="gdalternate1" valign="top"  visible="true">
                                <td>
                            ...
                            <tr id="disclamrdivid" runat="server" class="head1">
                                <td colspan="3">
                                    <asp:Label ID="lblDeclarationNumber" runat="server" Text="5."></asp:Label>
                                    Declaration / घोषणा
                                </td>
                            </tr>
                            <tr id="disclmrPanel" runat="server" class="gdrow1">
                             ...
                             <tr id="TrOptionOlevelSpecl" class="gdrow1" runat="server" visible="false">
                                <td id="Td1" runat="server" style="text-align: justify; padding-right: 20px; padding-left: 20px;" colspan="3">
                                    <asp:CheckBox ID="chkdisclamier1" runat="server" TabIndex="41" Text="<font color='RED'>*</font>" />
                                    I, hereby undertake to surrender the O Level Module, as selected to attain the transfer from the old evaluation pattern of the examination system to the current evaluation pattern of the examination system, in respect of examinations of O level and its equivalent modules in A Level, conducted by NIELIT.<br/>
                                    I, further undertake that I confirm the surrender of the module, as selected (old evaluation pattern), of O Level and I understand that I will not have any future claims, of any sort which includes the result/module certificate etc. issued by NIELIT in respect of the module surrendered by me.
                                    <br/>
                                    I, further undertake that I will apply for the corresponding module (against my surrendered module) in the upcoming examination cycle(s) under the current evaluation pattern of the examination system, as per my registration validity.
                                    <br/>
                                    I, understand that the surrendering of single module (old evaluation pattern) is a one-time exercise and I will not claim or request NIELIT for any changes/amendments in the module once surrendered by me.
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <tr>
                        <td align="center" colspan="3">
                            <br />
                            <asp:button id="Btncancelmodule" runat="server" text="Cancel Module" OnClientClick="return CnfrmationBox_moduleCancel();" Visible="false" OnClick="btnCaneclModule_Click"/>
