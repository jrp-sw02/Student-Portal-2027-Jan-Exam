<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertificateAdmitCard.aspx.cs"
    Inherits="CertificateAdmitCard" %>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="1px" style="font-size: 16px;">
                   ...
                   <tr>
                    ...
                    <td colspan="3" style="text-align:justify;">
                        a) Candidates shall be admitted to the Examination hall only 15 minutes before the
                        commencement of Examination.<br />
                        b) Before the commencement of the Examination, it is
                        essential and mandatory for all candidates to sign and put Left Thumb Impression
                        on the attendance sheet.<br />
                        c) Candidates must carry their Photo Identity Proof failing
                        ...
                        d) No candidate will be permitted to leave the hall before 30 minutes, after the commencement of Examination.<br />
                        e) Candidates should carry only their admit card issued by NIELIT, a photo identity
                        card and pen at the examination centre.<br />
                        f) No cell phones or any electronic device will be allowed in the examination hall.
                        If any such items are found in possession of the candidate, they will be confiscated.<br />
                        g) No pocketbooks, handbags, books, notes, written or printed material, CDs or data
                        ...
                        h) Candidate will not be allowed to make any notes from memory once he/she enter
                        ...
                        i) No candidate can bring any knife (including any pocketknife or multi-tool with
                        blades), or any weapon of any kind into the examination centre.<br />
                        j) No candidate shall create a continuing distraction by sound or movement which
                        ...
                        peace.<br />
                        k) Candidate should not use abusive/derogatory language orally against the Exam
                        Supdt./Technical Coordinator/Invigilator or threatening/using violence towards Invigilators
                        or Exam Supdt.<br />
                        l) No candidate shall give or receive aid from any other applicant or source during
                        the administration of the examination.<br />
                        m) In case any candidate is found breaching of the hall discipline and / or found
