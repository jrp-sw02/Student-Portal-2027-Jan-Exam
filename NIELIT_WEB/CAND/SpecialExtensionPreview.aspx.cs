...
public partial class SpecialExtensionPreview : BasePage
{
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString))
        {
            using (SqlCommand cmd = new SqlCommand("sp_get_MercyData_Preview", con))
            {
                ...
                if (dr.Read())
                {
                    ...
                    // 🔸 Contact Details
                    LblLandLine.Text = dr["Std"].ToString() + " - " + dr["Phone"].ToString();
    ...
    protected void Btnback_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../CAND/SpecialExtension.aspx?id=" + candidateId + "&courseId=" + courseId + "&applicant_type_id=" + applicant_type_id + "&AccStateID=" + AccStateID
    ...
    protected void Btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand("sp_Update_FinalSpecialExtensionMercyApplication", con))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if ((!String.IsNullOrEmpty(Request.QueryString["Appid"])) && (Request.QueryString["Src"] == "CSC"))
                    ...
                    Response.Redirect("~/CAND/FrmConfirm.aspx?TypeID=" + Convert.ToInt32(enmApplicationType.SpecialExtension).ToString() + "&Appid=" + latestID.ToString() + "&DemandID=" + demandID.ToString());
