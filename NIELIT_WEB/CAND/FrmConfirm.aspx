<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true"
    CodeFile="FrmConfirm.aspx.cs" Inherits="FrmConfirm"  Debug="false"%>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%-- <script src="../Script/GlobalFunction.js" type="text/javascript"></script>--%>    <%--   <script src="../Script/shortcut.js" type="text/javascript"></script>--%>
    <script language="javascript" type="text/javascript">
        ...
        function ValidateFormFields2() {
            if (!isBlank("<%=txtNeftTransNo2.ClientID %>", "Transaction No."))
                return false;
            if (!isBlank("<%=txtNeftDate2.ClientID %>", "Transaction Date"))
                return false;
            if (!isDate("<%=txtNeftDate2.ClientID %>", "Invalid Transaction date", "dd-MMM-yyyy"))
                return false;
            if (!isBlank("<%=txtNeftBank2.ClientID %>", "Bank Name."))
                return false;
            return true;
        }
    </script>
			...
			<tr>
				<td>
                                        <asp:HyperLink ToolTip="Click to pay online" Style="cursor: pointer; color: Blue;"
                                            ID="nPayNow" runat="server">Pay Online</asp:HyperLink></td>
					<td><asp:HyperLink ToolTip="Click to check online Payment Charges" Style="cursor: pointer; color: Blue;"
                                            ID="nCharges" runat="server" NavigateUrl="~/download/Payment_Service_Charges.pdf" Target="_blank">Check Online Payment Charges</asp:HyperLink>
                                    </td>
                                </tr>
			</table>
                                <tr class="gdalternate1">
                        ...
                        <asp:View ID="View4" runat="server">
                            <table width="100%" cellpadding="0" cellspacing="1">
                                <tr class="head1">
                                    <td colspan="2" style="text-align: left;">
                                        <strong>Payment By NEFT RTGS:(w.e.f 16.02.2021) </strong>
                                    </td>
                                </tr>
                                 <tr class="gdalternate1">
                                    <td style="text-align: left; height: 24px;">
                                ...
                                <tr class="gdalternate1">
                                    <td style="text-align: left;">
                                        Please make your Payment by Clicking on this link / कृपया इस लिंक पर क्लिक करके
                                        अपना भुगतान करें
                                        <asp:HyperLink ToolTip="Click to pay" Style="cursor: pointer; color: Blue;"
                                            ID="nPayOffline" runat="server">Pay NEFT/RTGS</asp:HyperLink>
                                    </td>
                                </tr>
                                <tr class="gdalternate1">
                                    <td style="text-align: left; height: 24px;">
                              ...
                              <%--COmment for new neft  <tr class="gdalternate1">
                                <td align="left" width="20%" colspan="2">
                        ...
                        <%-- Added for NEFT changes --%>
                        <asp:View ID="View5" runat="server">
                            <table width="100%" cellpadding="0" cellspacing="1">
                                <tr class="head1">
                                    <td colspan="2" style="text-align: left;">
                                        <strong>NEFT RTGS (Valid for validating payments deposited till 15.2.2021) </strong>
                                    </td>
                                </tr>
                               <%--Commented for validate   <tr class="gdalternate1">
                                <td align="left" width="20%" colspan="2">
                                    <asp:Label ID="Label2" runat="server" Text=" NEFT/RTGS Electronic Transfer Details. / एनईएफटी / आरटीजीएस इलेक्ट्रॉनिक ट्रांसफर विवरण"></asp:Label>
                                </td>
                                </tr>
                                  ...
                                  <tr class="gdrow1">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label3" runat="server" Text="NIELIT"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdalternate1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label4" runat="server" Text="BANK OF INDIA"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdrow1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label13" runat="server" Text="604820100000012"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdalternate1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label14" runat="server" Text="CGO COMPLEX BRANCH"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdrow1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label15" runat="server" Text="6048"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdalternate1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label16" runat="server" Text="110013052"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdrow1">
                                    <td align="left" width="30%">
                                    ...
                                    <td align="left">
                                        <asp:Label ID="Label17" runat="server" Text="BKID0006048"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdalternate1">
                                    <td align="left" width="30%" valign="top">
                                ...
                                <tr class="gdrow1">
                                    <td align="left" width="20%" colspan="2">
                                        <asp:Label ID="Label18" runat="server" Text="Please fill below mentioned NEFT/RTGS details to validate your application./ <br/> कृपया आपके आवेदन को मान्य करने के लिए नीचे उल्लेख  एनईएफटी / आरटीजीएस का पूरा विवरण भरें"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="gdrow1" id="tr6" runat="server">
                                    <td align="left" width="20%" colspan="2">
                                        <asp:Label ID="lblNeftError2" runat="server" ForeColor="Red"></asp:Label>
                                    </td>
                                </tr>
                               <%-- <tr class="gdrow1">
                                    <td align="left" width="30%">
                                ...
                                <tr class="gdalternate1">
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtNeftTransNo2" runat="server" Width="200px" MaxLength="30"></asp:TextBox>
                                        <br />
                                    </td>
                                </tr>
                                <tr class="trgdrow1calendar">
                                    ...
                                    <td valign="bottom" align="left">
                                        &nbsp;<asp:TextBox MaxLength="11" ID="txtNeftDate2" runat="server" Width="160px"></asp:TextBox>
                                        <img id="img1" src="../images/calendaricon.jpg" style="width: 20px; height: 22px;
                                            vertical-align: top;" />
                                        <%--(Demand Draft should be of 3 (three) months validity)--%>
                                        <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="txtNeftDate2" PopupPosition="BottomLeft"
                                            Format="dd-MMM-yyyy" PopupButtonID="img1" runat="server">
                                        </asp:CalendarExtender>
                                    </td>
                                </tr>
                                <tr class="gdalternate1" id="tr7" runat="server">
                                    <td align="left" width="30%">
                                        Amount <b class='mandatory'>*</b>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtNeftAmt2" runat="server" Width="200px" Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="gdrow1" id="tr8" runat="server">
                                    <td align="left" width="30%">
                                        Bank Name <b class='mandatory'>*</b>
                                    </td>
                                    <td align="left">
                                        <%--<asp:TextBox ID="TxtBank" runat="server" Width="200px" MaxLength="50"></asp:TextBox>--%>
                                        <asp:TextBox ID="txtNeftBank2" MaxLength="50" runat="server"></asp:TextBox>
                                        <asp:AutoCompleteExtender ID="AutoCompleteExtender2" ServiceMethod="GetBankNames"
                                            FirstRowSelected="true" ServicePath="~/WS/Common.asmx" TargetControlID="txtNeftBank2"
                                            runat="server" MinimumPrefixLength="1" CompletionInterval="0" EnableCaching="false"
                                            CompletionSetCount="10">
                                        </asp:AutoCompleteExtender>
                                    </td>
                                </tr>
                                <tr class="gdalternate1" id="tr9" runat="server">
                                    <td align="left" width="20%">
                                        &nbsp;
                                    </td>
                                    <td align="left">
                                        <asp:Button ID="btnNeftSubmit2" runat="server" Text="Submit"  
                                            OnClientClick="return ValidateFormFields2();" onclick="Btnneftsubmit2_Click" />
                                    </td>
                                </tr>
                            </table>
                        </asp:View>
