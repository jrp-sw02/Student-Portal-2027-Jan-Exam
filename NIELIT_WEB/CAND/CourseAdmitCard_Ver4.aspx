<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseAdmitCard_Ver4.aspx.cs" Debug="true"
...
<body style="background-color: #FFFFFF;">
    <form id="form1" runat="server" style="margin-top: 10px;">
        <table align="center" border="0" cellspacing="0" style="font-size: 14px; font-family: Arial;"
            ...
            <tr class="normal">
                <td colspan="3" align="center" style="padding: 5px;">
                     <span style="width: 110px; float: right; font-size: 12px;">Version : 1.4</span>
                </td>
            </tr>
            <tr>
                            ...
                            <td style="text-align: left; width: 50%; vertical-align: top;">
                                <table style="height: 2323px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; text-align: justify;">
                                            Candidates should ensure that,they sign on the attendance sheet only against their roll number,&nbsp; name, as a proof of having attended the examination. The answer script of those candidates,who fail to sign the attendance sheet,may not be evaluated. </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left; vertical-align: top;">&nbsp;</td>
