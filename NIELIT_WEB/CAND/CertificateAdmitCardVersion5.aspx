<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertificateAdmitCardVersion5.aspx.cs"
    Inherits="CertificateAdmitCardVersion5" Debug="false" %>
                ...
                <table width="100%" cellspacing="0" cellpadding="4" border="1px" style="font-size: 16px;">
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <b><span>IMPORTANT:CANDIDATES ARE ADVISED TO PUT THEIR SIGNATURE AND LEFT THUMB IMPRESSION(LTI)
                                ...
                                FOR EXAM. CANDIDATE MUST CARRY A VALID ORIGINAL PHOTO IDENTITY CARD ALONG WITH THE
                                ADMIT CARD ISSUED BY NIELIT FAILING WHICH THE CANDIDATES WILL NOT BE ALLOWED TO
                                APPEAR IN THE EXAMINATION.</span>
                                <br />
                                <span>महत्वपूर्ण: अभ्यर्थियों को उपस्थिति-पत्र में अपने हस्ताक्षर व बाएँ हाथ के अंगूठे
                                    ...
                                    साथ एक मूल वैध फोटो पहचान पत्र लाना अनिवार्य है अन्यथा उन्हें परीक्षा में बैठने
                                    की अनुमति नहीं दी जायेगी। </span>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: justify;">
                            a) Candidates are required to report at the examination centre 
                            half hour prior to
                            the scheduled examination time alloted to the candidate.<br />
                            b) Candidates shall be admitted to the Examination hall only 15 minutes before the
                            commencement of Examination and candidates will not be permitted to enter the examination
                            hall after expiry of 30 minutes from the time of commencement of examination.<br />
                            c) Before the commencement of the Examination, it is essential and mandatory for
                            all candidates to sign and put Left Thumb Impression on the attendance sheet.<br />
                            d) <span>Candidate must ensure that s/he appends her/his signature on the attendance
                                sheet at the examination centre in the same manner as uploaded by them at the Student
                                Online Portal while submitting Online Examination Application Form for the particular
                                course. NIELIT at its own discretion may check record of any/all candidate(s) and
                                if any mismatch in the signatures of the candidate on the above said two documents
                                is found, there is a possibility of cancellation of examination of such candidates.</span><br />
                            e) Candidates must carry their Original Photo Identity Proof failing which; the
                            candidates will not be allowed to appear in the examination.The valid photo Identity
                            proofs are Voter ID card, Passport, PAN card, Permanent laminated driving licence,
                            Aadhar card, Student identity card with photograph issued by recognised School/College/ITI/Polytechnic,
                            ...
                            photo issued by Gazetted Officer or Tehsildar on letterhead.
                            <br />
                            f) Candidates will be allowed to leave the examination hall only after completion
                            of
                            <asp:Label ID="lblmintime" runat="server" Text="mintime"></asp:Label>
                            &nbsp;minutes from the time of commencement of examination.<br />
                            g) Candidates should carry only their admit card issued by NIELIT, an original photo
                            identity card and pen at the examination centre.<br />
                            ...
                            him/her. </br> p)<strong>Candidates are advised to strictly adhere to the time schedule
                                and instructions.</strong>
                            <br />
                        </td>
                    </tr>
                </table>
