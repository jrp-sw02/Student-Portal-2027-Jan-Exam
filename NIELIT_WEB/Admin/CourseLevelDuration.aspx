<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="CourseLevelDuration.aspx.cs" Inherits="Admin_CourseLevelDuration"
     %>
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="courseLevelNo" HeaderText="Course Level No." SortExpression="courseLevelNo" Target="_self"><HeaderStyle Width="10%" /></asp:HyperLinkField>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="12%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    ...
                                    Target="_self"><HeaderStyle Width="12%" /></asp:HyperLinkField>   
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                ...
                <tr >                  
                 ...
                 <tr>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label10" runat="server" SkinID="CaptionLabel" Text="Effective_To_Date &lt;b class='mandatory'&gt;*&lt;/b&gt;" ></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
