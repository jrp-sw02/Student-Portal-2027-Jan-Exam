<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="adminaccrediatedcenter.aspx.cs" Inherits="Admin_adminaccrediatedcenter"
    Debug="true" %>
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="New" runat="server">
            <table class="sample2" cellpadding="0" cellspacing="1" width="100%">
                ...
                <tr class="even">
                    <td valign="top">
                        <asp:textbox id="txtInstituteID" runat="server" skinid="txt248" maxlength="10" onkeypress="checkNumber(this,10,0,event)"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                    <td>
                ...
                <tr>
                    <td valign="top">
                        <asp:Label ID="Label12" runat="server" SkinID="CaptionLabel" Text="Email Address-1"></asp:Label>
                    </td>
                    <td valign="top">
