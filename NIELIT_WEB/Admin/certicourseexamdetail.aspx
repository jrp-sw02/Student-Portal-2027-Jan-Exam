<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="certicourseexamdetail.aspx.cs" Inherits="certicourseexamdetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Certificate Course Exam Detail"></asp:Label>
</asp:Content>
...
<ul class="crumbs">
    ...
    <li runat="server" id="liedit" visible="false" ><a href="certicourseexamdetail.aspx?key=July" style="z-index:6;"><span></span>July</a></li>
                        ...
                        <table class="gdbody" cellspacing="1" cellpadding="4" id="cphContents_gvMain" style="width: 99%;">
                                <tr class="gdheader">
                                    ...
                                    <td align="left">
                                        <b>Exam Month</b></td>
                                    <td align="left">
                                        <b>Last Date of Exam Form Submission</b></td>
                                </tr>
                                <tr class="gdrow">
                                    <td align="left" class="style1">
                                        1</td>
                                    <td align="left">
                                    <a href="certicourseexamdetail.aspx?key=July">July</a>
                                        </td>
                                    <td align="left">
                                        June 30
                                    </td>
                                ...
                                <tr class="gdalternate">
                                    <td align="left" class="style1">
                                        2</td>
                                    <td align="left">
                                        <a href="certicourseexamdetail.aspx?key=January">January</a>
                                    </td>
                                    <td align="left">
                                        Decemter 31</td>
                                </tr>
            ...
            <table class="sample2" cellpadding="2" cellspacing ="0">
                ...
                <tr class="even">
                    <td colspan="3" valign="top">
                        Last Date To Fill Exam Form</td>
                </tr>
                <tr class="even">
                    <td colspan="3" valign="top">
    ...
    <table runat="server" visible="false"   align="center" class="nav" cellspacing="0" cellpadding="0" id="tblNavLinks" width="97%">
        ...
        <tr>
            <td style="border: 1px solid #2c5070; background-color: #FFFFFF;" width="100%">
                <a href="certicourseexamdates.aspx" target="_self">Exam Details</a>
            </td>
        </tr>
