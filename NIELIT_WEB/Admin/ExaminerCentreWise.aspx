...
CodeFile="ExaminerCentreWise.aspx.cs" Inherits="Admin_ObserverCentreWise" %>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <ContentTemplate>
                  <%--  <asp:GridView runat="server" ID="grdCandidateData"
                    ...
                    <%--</columns>--%>
                    <asp:Label runat="server" >* To mark absent award -1 Marks</asp:Label>
                                 ...
                                 <%--   <asp:BoundField HeaderStyle-Width="5%" HeaderText="#">
                                    ...
                                    <asp:TemplateField   HeaderText  ="Examiner Marks (Out of 40) ">
                                        <ItemTemplate>                                            
                                         ...
                                         <EditItemTemplate>
                                         <%--  <asp:LinkButton ID="LinkButton1" Text="Update" runat="server"  />
                                           <asp:LinkButton ID="LinkButton2" Text="Cancel" runat="server"  />--%>
