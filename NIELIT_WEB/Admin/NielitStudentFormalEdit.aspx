<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/MasterPages/main.master" CodeFile="NielitStudentFormalEdit.aspx.cs"
    Debug="True"
    Inherits="Admin_NielitStudentFormalEdit" %>
                        ...
                        <td align="left" valign="top">
                            <table style="width: 100%;" class="sample3" border="0" cellpadding="3" cellspacing="1">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                    ...
                                    <td valign="top" width="35%">Semester:
                                ...
                                <tr class="gdalternate1" id="trproject" runat="server" visible="false">
                                    ...
                                    <td width="3%" valign="top" style="padding-right: 13px;">1.3
                                    </td>
                            ...
                            <td>
                                ...
                                <tr class="gdrow1">
                                    <td colspan="3">
                                        ...
                                        <asp:Label ID="lblDocs" runat="server" Text="Documents / दस्तावेज़" Font-Bold="true">
                                        </asp:Label>
