<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPages/main.master" CodeFile="NielitStudentFormal.aspx.cs" Inherits="Admin_NielitStudentFormal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Nielit Student Formal"></asp:Label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphAddNew" runat="Server">
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label13" Width="100%" runat="server" Text="Reference Number"></asp:Label>
    ...
    <uc1:SearchBar ID="ucSearchBar" OnLnkBtnResetSearch="SearchBar_Reset" SearchTextToolTip="Search by Reference Number"
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <%--<asp:LinkButton ID="lbdisable" OnClientClick="return ConfirmAction('Are you sure you want to change the status of the selected exam center!');"
                                        ...
                                        SkinID="lnkbtnAction" ></asp:LinkButton>--%>
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="30%" DataNavigateUrlFields="ID"
                                    ...
                                    HeaderText="Name" SortExpression="Name" Target="_self"></asp:HyperLinkField>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="15%" DataNavigateUrlFields="ID"
                                    ...
                                    HeaderText="Semester" SortExpression="SemNo" Target="_self">
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:HyperLinkField>
        ...
        <asp:View ID="New" runat="server">
            ...
            <div>
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="977px" style="margin-bottom: 20px">
                    ...
                    <tr>
                        <td align="center">
                            <strong style="text-align: center" class="headfont">REGISTRATION APPLICATION FORM –
                    ...
                    <tr>
                        <td align="center" id="tderror" runat="server" visible="false">
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <table style="width: 100%;" class="sample3" border="0" cellpadding="3" cellspacing="1">
                                ...
                                <%--  <tr class="gdalternate1" id="TrPreCentre"  runat="server">
                            ...
                            <td></td>
                                ...
                                <%-- <tr class="gdalternate1" id="trregno" runat="server" visible="false">
                            <td width="3%">
                                1.0.1
                            </td>
                            <td>
                                <asp:Label ID="lblregno" runat="server" Text="Online Reference Number<font color='RED'>*</font>">
                                </asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtregno" runat="server" MaxLength="50"  Width="281px"
                             ...
                             <td align="left" >
                               <asp:Button ID="btnShow" runat="server" Text="Show"  OnClick="btnShow_Click"/>  
                                ...
                                <tr class="gdalternate1" id="traffliated" runat="server" visible="false">
                                ...
                                <tr class="gdalternate1" id="trlateral" runat="server">
                                    ...
                                    <td width="40%" valign="top">
                                        <asp:Label ID="Label15" runat="server" SkinID="CaptionLabel" Text="Lateral Entry  &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                                    </td>
                                    <td style="width: 57%;" valign="top" colspan="2">
                                        <%-- <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>--%>
                                        <asp:RadioButtonList ID="rdblateralEntry" runat="server" RepeatDirection="Horizontal"
                                            TabIndex="2" Width="412px" AutoPostBack="True" OnSelectedIndexChanged="rdblateralEntry_SelectedIndexChanged"
                                            Style="height: 27px" Font-Bold="True">
                                        ...
                                        <%-- </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="rdblateralEntry" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>--%>
                                    </td>
                                    <td></td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    ...
                                    <td valign="top" width="25%">Course:
                                <%--<asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate> --%>
                                        <asp:DropDownList ID="ddlCourse" runat="server" Width="281px" AutoPostBack="True" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" TabIndex="1">
                                        </asp:DropDownList>
                                        <%--</ContentTemplate>
                            <Triggers>  
                            </Triggers>
                                    ...
                                    <td valign="top" width="25%">Batch:
                               <%-- <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>  --%>
                                        <asp:DropDownList ID="ddlBatch" runat="server" Width="250px" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <%-- </ContentTemplate>
                            <Triggers>  
                            </Triggers>
                                    ...
                                    <td valign="top" width="27%">Semester:
                                <%--<asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate> --%>
                                        <asp:DropDownList ID="ddlsemester" runat="server" Width="100px" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlsemester_SelectedIndexChanged">
                                            <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                        </asp:DropDownList>
                                        <%-- </ContentTemplate>
                            <Triggers>  
                                ...
                                <tr class="gdalternate1">
                                    ...
                                    <td valign="top" width="20%">Poject Student:

                                <asp:DropDownList ID="ddlWheatherPojectStu" runat="server" SkinID="ddl250"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlWheatherPojectStu_SelectedIndexChanged">
                                    ...
                                    <td valign="top" width="20%" id="trRegNo" runat="server" visible="false">
                                        <asp:Label ID="lblregistration" runat="server" SkinID="CaptionLabel" Text="University  Registration No.:"></asp:Label>

                                        <asp:TextBox ID="txtRegistrationNo" runat="server" MaxLength="16" Width="250px"
                                            onpaste="return false;" oncopy="return false;" oncut="return false;"></asp:TextBox>
                                ...
                                <tr class="gdalternate1" id="trews" runat="server">
                                    ...
                                    <td>
                                        ...
                                        <asp:RadioButtonList ID="RdisEWS" runat="server" RepeatDirection="Horizontal"
                                            TabIndex="19"
                                            OnSelectedIndexChanged="RdisEWS_SelectedIndexChanged">
                                            <asp:ListItem Value="N" Selected="True">No / नहीं </asp:ListItem>
                                            <asp:ListItem Value="Y">Yes / हाँ </asp:ListItem>
                                        </asp:RadioButtonList>
                                        <%-- added by amit end --%>
                                ...
                                <tr class="gdalternate1">
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlcordistrict" runat="server" TabIndex="31" Width="375px">
                                                    <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            <Triggers>
                            ...
                            <td>
                                ...
                                <tr class="gdalternate1" id="UIDtr" runat="server">
                                    ...
                                    <td>
                                        ...
                                        &nbsp &nbsp &nbsp
                                <asp:TextBox ID="UidNumberTxt" runat="server" MaxLength="12" placeholder="ID Card Number" TextMode="Password" autocomplete="off"
                                    Width="300px">
                                </asp:TextBox>
                                    </td>
                                </tr>
                            ...
                            <td>
                                ...
                                <tr class="gdalternate1" id="trwhetherCourseComplete" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlCourseComplete" runat="server" Width="375px">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                            <asp:ListItem Value="2">No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr class="gdalternate1" id="trwhetherCertificateIssued" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlwhetherCertificateIssued" runat="server" Width="375px">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                            <asp:ListItem Value="2">No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr class="gdalternate1" id="trcertificateIssueDate" runat="server" visible="false">
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox MaxLength="11" ID="txtcertificateIssueDate" Visible="false" runat="server" SkinID="txtDate" Width="99px"
                                            TabIndex="15" onpaste="return false;" oncopy="return false;" oncut="return false;"
                                ...
                                <tr class="gdalternate1" id="trWhetherPlaced" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlWhetherPlaced" AutoPostBack="true" OnSelectedIndexChanged="ddlWhetherPlaced_SelectedIndexChanged" runat="server" Width="375px">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                            <asp:ListItem Value="2">No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr class="gdalternate1" id="trWhetherPlacedDate" runat="server" visible="false">
                                    ...
                                    <td>
                                        <%--<asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                    <ContentTemplate>--%>
                                        <asp:TextBox MaxLength="11" ID="txtPlacementDate" runat="server" SkinID="txtDate" Width="99px"
                                            TabIndex="15" onpaste="return false;" oncopy="return false;" oncut="return false;"
                                            AutoPostBack="true"></asp:TextBox>
                                ...
                                <tr class="gdrow1" id="trPersonDetails" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPersonName" runat="server" Enabled="false" Width="520px" TabIndex="26" MaxLength="30"
                                            onpaste="return false;" oncopy="return false;" oncut="return false;"></asp:TextBox>
                                        <br />
                                    </td>
                                </tr>
                                ...
                                <tr class="gdrow1" id="tr2" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMob" runat="server" Enabled="false" Width="520px" TabIndex="26" MaxLength="30"
                                            onpaste="return false;" oncopy="return false;" oncut="return false;"></asp:TextBox>
                                        <br />
                                    </td>
                                </tr>
                                ...
                                <tr class="gdalternate1" id="trCmpDistrict" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlCmpDistrict" runat="server" TabIndex="31" Width="375px" Enabled="False">
                                                    <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            <Triggers>
                                ...
                                <tr class="head1" id="traffidavit" runat="server" visible="false">
                                    <td colspan="3">
                                ...
                                <tr class="gdrow1" id="trAffidiate" runat="server" visible="false">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAffidiavitNo" runat="server" Width="520px" TabIndex="26" MaxLength="30"
                                ...
                                <tr class="gdrow1">
                                    ...
                                    <td>
                                        <asp:TextBox MaxLength="11" ID="txtAffidiavitDate" Visible="false" runat="server" SkinID="txtAffidiavitDate" Width="99px"
                                            TabIndex="15" onpaste="return false;" oncopy="return false;" oncut="return false;"
                                            AutoPostBack="true"></asp:TextBox>
                                ...
                                <tr class="gdalternate1" id="traff" runat="server" visible="false">
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlAffidiavitVerified" Visible="false" runat="server" Width="375px">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                            <asp:ListItem Value="2">No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <asp:Label ID="Label16" runat="server" Text="Documents / दस्तावेज़" Font-Bold="true">
                                        </asp:Label>
                                ...
                                <tr>
                                    <td colspan="3">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Download Format">
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="hylFormat" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                        ...
                                        <asp:HiddenField ID="hfapplcode" runat="server" />
                                    </td>
                                </tr>
                                <%-- Added by Amit end --%>

                                <tr class="gdrow1" runat="server" visible="true">
                                    <td colspan="3">
