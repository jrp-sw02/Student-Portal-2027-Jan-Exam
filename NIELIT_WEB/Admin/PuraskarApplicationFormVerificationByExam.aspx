<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PuraskarApp.master" AutoEventWireup="true" CodeFile="PuraskarApplicationFormVerificationByExam.aspx.cs"
    Inherits="Admin_PuraskarApplicationFormVerificationByExam" Debug="true" %>
...
<script type="text/javascript">
    $("[src*=plus]").live("click", function () {
        $(this).closest("tr").after("<tr><td></td><td colspan = '11'>" + $(this).next().html() + "</td></tr>")
    ...
    <script language="javascript" type="text/javascript">
        ...
        window.onload = function () {
            ...
            TotalChkBx = parseInt('<%= this.gvMain.Rows.Count %>');
        ...
        function HeaderClick(CheckBox) {
            ...
            var Inputs1 = TargetBaseControl.find("input");
 
            //Checked/Unchecked all the checkBoxes in side the GridView.
            for (var n = 0; n < Inputs.length; ++n)
                if (Inputs[n].type == 'checkbox' &&
                        Inputs[n].id.indexOf(TargetChildControl, 0) >= 0)
                    if (TargetChildControl.enabled = true)
           ...
           <tr class="gdalternate1">
                ...
                <td style="width: 20%;" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlflExam" Width="75%" runat="server" backColor="AliceBlue" Enabled="true" AutoPostBack="true" OnSelectedIndexChanged="ddlflExam_SelectedIndexChanged" >   
        ...
        <asp:UpdatePanel EnableViewState="true" ID="uPnlGrid" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="lblAffiliatedInst" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar Candidates List for Verification by Exam" Visible="true"></asp:Label><br />
                <asp:Label Width="99%" EnableTheming="false" CssClass="error" ID="lblError" Visible="false"
                    runat="server"></asp:Label>
                <asp:GridView ID="gvMain" runat="server" DataKeyNames="Regno, Examid" OnSorting="gvMain_Sorting" CssClass="Grid"
                    ...
                    <Columns>
                       ...
                       <%-- <asp:BoundField DataField="Examid" HeaderText="Examid1" Visible="false" />
                        <asp:BoundField DataField="Regno" HeaderText="Registration Number" Visible="false" />--%>
                        <%--  <asp:HyperLinkField HeaderStyle-Width="15%"
                        ...
                        <asp:TemplateField HeaderText="VerifiedStatus" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="110px">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("examRejectionReason") %>' Width="150px" Style="word-wrap: break-word;" ForeColor="#ff6600"></asp:Label>
                                <asp:TextBox ID="txtexamRejectionReason" runat="server" Text='<%# Eval("examRejectionReason") %>'
                                ...
                                <asp:TextBoxWatermarkExtender ID="txtName_TextBoxWatermarkExtender" runat="server"
                                    Enabled="True" TargetControlID="txtexamRejectionReason" WatermarkText="*Enter Reason for Rejection" WatermarkCssClass="Watermark">
                                </asp:TextBoxWatermarkExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtexamRejectionReason"
                        ...
                        <asp:ButtonField  Text="View" CommandName="Select" ItemStyle-Width="30"  HeaderText="Modules" />
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>                
                <asp:Button ID="btnSave" runat="server" OnClick="SaveRecord"
                    Text="Save Candidates Status" Visible="false" />
