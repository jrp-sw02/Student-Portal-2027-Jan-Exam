<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true" CodeFile="CourseCategory.aspx.cs" Inherits="Admin_CourseCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" Runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Course Categories"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphAddNew" Runat="Server">
                            ...
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlficoursecategory" Width="100%" runat="server">
    ...
    <uc1:SearchBar ID="ucSearchBar" OnLnkBtnResetSearch="SearchBar_Reset" SearchTextToolTip="Search by Category Name or Category code"
...
<script language="javascript" type="text/javascript" src="../Script/browserDetect.js"></script>
        function ValidateLogin() {
            if (!isBlank("<%=Txtcatname.ClientID %>", "Course Category"))
                return false;
            if (!isBlank("<%=Txtcatcode.ClientID %>", "Course Category Code"))
                return false;
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="categoryname" HeaderText="Category Name" SortExpression="categoryname"
                                    Target="_self" />
                                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="categorycode" HeaderText="Category Code" SortExpression="categorycode"
                                    Target="_self" />
            ...
            <table class="sample2" cellpadding="2" cellspacing="0">
                <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblCategory" runat="server" SkinID="CaptionLabel" Text="Course Category Name &lt;b class='mandatory'&gt;*&lt;/b&gt;"
                            Width="100%"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblCourseName" runat="server" SkinID="CaptionLabel" Text="Course Category Code&lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblDownloadType" runat="server" SkinID="CaptionLabel" Text="Display Order &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="Txtcatname" runat="server" SkinID="txt248" onblur="return onlyAlphabets(event,this);" MaxLength="60"  ></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="Txtcatcode" runat="server" SkinID="txt248" MaxLength="10" ></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="Txtdisplayorder" runat="server" SkinID="txt248" MaxLength="2" ></asp:TextBox>
                    </td>
                </tr>
            </table>
