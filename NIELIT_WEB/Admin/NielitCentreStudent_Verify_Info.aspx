<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true"
    CodeFile="NielitCentreStudent_Verify_Info.aspx.cs" Inherits="NielitCentreStudent_Verify_Info" Debug="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="NielitCentreStudent: Application Status"></asp:Label>
