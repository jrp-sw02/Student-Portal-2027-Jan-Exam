<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NielitCentreStudent.aspx.cs" Inherits="Admin_NielitCentreStudent" %>--%>

<%--<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="NielitCentreStudent.aspx.cs" Inherits="Admin_NielitCentreStudent"  Debug="true" %>--%>

<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="NielitCentreStudent.aspx.cs"
    Inherits="Admin_NielitCentreStudent" MasterPageFile="~/MasterPages/main.master"
    Debug="true" %>
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <%--  <tr>
                                    <td>
                                        <asp:Label ID="Label14" Width="100%" runat="server" Text="Course Category"></asp:Label>
                                ...
                                <%--<tr>
                                    <td>
                                        <asp:Label ID="Label15" Width="100%" runat="server" Text="Course"></asp:Label>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateForm() {
            ...
            if (!isSelected("ddlWheatherPojectStu", "Project Student"))
                return false;
                            ...
                            <asp:UpdatePanel ID="updpanelmain" runat="server" UpdateMode="Conditional">
                                ...
                                <font color='RED'>*</font>
                                        ...
                                        <tr class="gdalternate1" id="trappno" runat="server" visible="false">
                                            <td width="3%" valign="top">1.0.0
                                            </td>
                                            <td width="40%" valign="top">Course Type (Registration or Examination)                               
                               
                                <font color='RED'>*</font>
                                            </td>
                                            <td style="width: 57%;" valign="top" colspan="2">

                                                <asp:RadioButtonList ID="RadioButtonListRegType" runat="server" RepeatDirection="Horizontal"
                                                    Width="440px" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonListRegType_SelectedIndexChanged">
                                                    <asp:ListItem Value="R">Registration No. (Other Courses)</asp:ListItem>
                                        ...
                                        <tr class="gdalternate1" id="trregno" runat="server" visible="false">
                                            ...
                                            <td>
                                                <asp:Label ID="lblregno" runat="server" Text="Registration No <font color='RED'>*</font>">
                                                </asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtregno" runat="server" MaxLength="50" Width="281px"></asp:TextBox>
                               ...
                               <!-- <asp:Label ID="lblwarn" runat ="server" Text ="Old batch entry disallowed" Font-Bold ="true"  ForeColor ="Red" ></asp:Label>-->
                                                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlBatch" runat="server" Width="337px" TabIndex="1">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                    </Triggers>
								...
								<asp:UpdatePanel ID="UpdatePanePrSt" runat="server">
                                    <ContentTemplate>
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="ddlWheatherPojectStu" EventName="SelectedIndexChanged" />
                                    </Triggers>
                                </asp:UpdatePanel>
                                            ...
                                            <td valign="top" width="57%" colspan="2">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanePrNm" runat="server">
                                                    <ContentTemplate>
                                                    ...
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="ddlProcname" EventName="SelectedIndexChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </td>
                                ...
                                <br />--%>
                                    ...
                                    height: 22px; vertical-align: top;" />--%>
                                        ...
                                        <tr class="gdalternate1" id="trcategory" runat="server">
                                            ...
                                            <td>
                                                <%--  <asp:DropDownList ID="ddlCategory" runat="server" Width="375px" TabIndex="17" AutoPostback="true" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged">
                                </asp:DropDownList >--%>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="RdisEWS" runat="server" RepeatDirection="Horizontal"
                                                            OnSelectedIndexChanged="RdisEWS_SelectedIndexChanged" AutoPostBack="true" TabIndex="19">
                                                            <asp:ListItem Value="N" Selected="True">No / नहीं </asp:ListItem>
                                                            <asp:ListItem Value="Y">Yes / हाँ </asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </ContentTemplate>
                                        ...
                                        <tr class="gdalternate1">
                                            ...
                                            <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlcordistrict" runat="server" TabIndex="31" Width="375px" AutoPostBack="True" OnSelectedIndexChanged="ddlcordistrict_SelectedIndexChanged">
                                                            <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div id="gridRow" runat="server">
                                                    ...
                                                    <asp:UpdatePanel ID="upnluploaded" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>

                                                            <asp:GridView ID="GridView_uploaded" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblSerialNumber" runat="server"></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Upload Status">
                                                                        <ItemTemplate>
                                                                            <asp:Label Text="Uploaded" runat="server" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
                                                    ...
                                                    <asp:HiddenField ID="hfapplcode" runat="server" Value="" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel15" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <table style="width: 100%; text-align: center;" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <!-- Row 1: Text + Captcha + Refresh -->
                                        <tr>
                                            <td style="text-align: center;">
                                                <div style="display: inline-flex; align-items: center; gap: 10px;">

                                                    <span style="font-size: 12px; font-weight: bold;">Please enter the following number you see into the textbox below.
                                                    </span>

                                                    <img src="" id="imgcap" runat="server" alt="Captcha Code"
                                                        width="150" height="55" />

                                                    <asp:ImageButton ID="ImgBtnRefresh"
