...
public partial class Admin_DVPBCC_RejectedCandidateList : BasePage
{
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //Response.Redirect("~/Admin/DVPBCC_RejectedCandidateList.aspx");
        }
        catch (Exception ex)
        {
    ...
    public DataSet GetExamData(Int32 examId, Int32 instituteId)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("get_DVPBCC_RejectedCandidateList", con))
            {
    ...
    void downloadReport()
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=DVPBCC_RejectedCandidateList.pdf");
    ...
    protected void ShowTableHeader(DataTable tab)
    {
        try
        {
            ...
            th.Cells.Add(tcCol);
            //Added for application no.
            TableHeaderCell tcCol1a = new TableHeaderCell();
            tcCol1a.Width = Unit.Percentage(10);
            tcCol1a.Text = "Application Number";
        ...
        try
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    tdRow1a.Text = ds.Tables[0].Rows[i]["Number"].ToString();
                    ...
                    tdRow3.Text = (String.IsNullOrEmpty(ds.Tables[0].Rows[i]["Exam_Centre_Address"].ToString()) ? "NA" : ds.Tables[0].Rows[i]["Exam_Centre_Address"].ToString());
                    //tdRow6.Text = (String.IsNullOrEmpty(ds.Tables[0].Rows[i]["GuardianName"].ToString()) ? "NA" : ds.Tables[0].Rows[i]["GuardianName"].ToString());
                    ...
                    tdRow7.Width = Unit.Percentage(7);
                    ...
                    tdRow10.Text = ds.Tables[0].Rows[i]["Date_of_Exam"].ToString();
                    tdRow10.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow10);

                    TableCell tdRow11 = new TableCell();
                    tdRow11.Width = Unit.Percentage(7);
                    tdRow11.Text = ds.Tables[0].Rows[i]["Reporting_Time"].ToString();
                    ...
                    tdRow8.Text = ds.Tables[0].Rows[i]["Reason"].ToString();
                    tdRow8.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow8);

                    TableCell tdRow9 = new TableCell();
                    tdRow9.Width = Unit.Percentage(7);
                    tdRow9.Text = ds.Tables[0].Rows[i]["DateOfReason"].ToString();
