<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/main.master" CodeFile="MISCourseRegistrationPolicy.aspx.cs" Inherits="Admin_MISCourseRegistrationPolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="MIS Course Registration Policy"></asp:Label>
