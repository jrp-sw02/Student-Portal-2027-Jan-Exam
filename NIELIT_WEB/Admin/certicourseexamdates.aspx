<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="certicourseexamdates.aspx.cs" Inherits="certicourseexamdates" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Course Exam Session Details"></asp:Label>
</asp:Content>
...
<ul class="crumbs">
	<li class="first"><a href="CertificateCourse.aspx" style="z-index:9;"><span></span>Certification Course</a></li>
	<li><a href="CertificateCourse.aspx?key=S101" style="z-index:8;"><span></span>S101</a></li>
    <li><a href="certicourseexamdetail.aspx" style="z-index:7;"><span></span>Exam</a></li>
    <li><a href="certicourseexamdetail.aspx?key=July" style="z-index:6;"><span></span>July</a></li>
    <li><a href="certicourseexamdates.aspx" style="z-index:5;"><span></span>Exam Details</a></li>
    <li id="lbledit" runat="server" visible="false"><a href="certicourseexamdates.aspx?key=July2010" style="z-index:4;"><span></span>July2010</a></li>
    
    <%--<li runat="server" id="li1" visible="false" ><a href="CertificateCourse.aspx?key=S101" style="z-index:8;"><span></span>S101</a></li>--%>
                         ...
                         <table class="gdbody" cellspacing="1" cellpadding="4" id="cphContents_gvMain" style="width: 99%;">
                                ...
                                <tr class="gdrow">
                                    <td align="left" class="style1">
                                        1</td>
                                    <td align="left">
                                        <a href="certicourseexamdates.aspx?key=July2010">July2010 </a>
                                        </td>
                                    <td align="left">
                                        01 to 15 July</td>
                                </tr>
                                <tr class="gdalternate">
                                    <td align="left" class="style1">
                                        2</td>
                                    <td align="left">
                                         <a href="certicourseexamdates.aspx?key=July2011">July2011</a>
                                    </td>
                                    <td align="left">
                                        01 to 15 July</td>
                                </tr>
                                <tr class="gdrow">
                                    ...
                                    <td align="left">
                                         <a href="certicourseexamdates.aspx?key=July2012">July2012</a>
                                    </td>
                                    <td align="left">
                                        01 to 15 July</td>
                                </tr>
                ...
                <tr class="even">
                    ...
                    <td style="width:33%;" valign="top">
                        <asp:DropDownList ID="ddlEntity0" runat="server" onchange="SetNames(this);" 
                            ...
                            <asp:ListItem>B Level</asp:ListItem>
                            <asp:ListItem>C Level</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td style="width:33%;" valign="top">
    ...
    <table runat="server" visible="false"   align="center" class="nav" cellspacing="0" cellpadding="0" id="tblNavLinks" width="97%">
        ...
        <tr>
            <td style="border: 1px solid #2c5070; background-color: #FFFFFF;" width="100%">
                <a href="certicextimetable.aspx" target="_self">Time Table</a>
            </td>
        </tr>
