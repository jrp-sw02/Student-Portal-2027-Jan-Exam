    ...
    protected void OnUpdate(object sender, EventArgs e)
    {
      ...
      //  GridViewRow row = grdCandidateData.Rows[rowIndex];
        ...
        //Fetch value of Country
          ...
          string sql = " update Practical_candidate_marks  set  Examiner_marks_40 = '" + examinerMarks + "'  where Registration_no = '" + registrationNumber + "'  and module_id = '" + moduleType  + "'";
...
" pm.center_Code ='" + CentreCode + "'   and Examiner_marks_40 is null order by    pm.Exam_date, Exam_report_time, Registration_no ";
