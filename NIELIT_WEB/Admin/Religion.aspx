<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="Religion.aspx.cs" Inherits="Admin_Religion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Religion"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphAddNew" runat="Server">
    ...
    <asp:Panel runat="server" ID="pnlFilter" Visible="false">
        <div id="filterContainer">
            ...
            <div id="filterBox" align="left" runat="server" visible="false">
                <div id="filterPannel">
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" Width="100%" runat="server" Text="Religion"></asp:Label>
                                        <asp:DropDownList ID="ddlReligion" Width="100%" runat="server" AutoPostBack="True">
    ...
    <uc1:SearchBar ID="ucSearchBar" OnLnkBtnResetSearch="SearchBar_Reset" SearchTextToolTip="Search by Religion Name,Code"
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (!isBlank("<%=txtReligion.ClientID %>", "Religion Name"))
                return false;
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="35%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="Name" HeaderText="Religion" SortExpression="Name" Target="_self">
        ...
        <asp:View ID="New" runat="server">
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtReligion" runat="server" SkinID="txt248" MaxLength="50" onkeypress="return isNumberKey(event);"></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
