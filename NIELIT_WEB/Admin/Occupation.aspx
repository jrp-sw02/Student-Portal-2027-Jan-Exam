<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="Occupation.aspx.cs" Inherits="Admin_Occupation" Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Occupation"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphAddNew" runat="Server">
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" Width="100%" runat="server" Text="Occupation"></asp:Label>
                                        <asp:DropDownList ID="ddlOccupation" Width="100%" runat="server" AutoPostBack="True">
    ...
    <uc1:SearchBar ID="ucSearchBar" OnLnkBtnResetSearch="SearchBar_Reset" SearchTextToolTip="Search by Occupation,Code"
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (!isBlank("<%=txtOccupation.ClientID %>", "Occupation Name"))
                return false;
                        ...
                        <table id="popup" clientidmode="Static" runat="server" cellpadding="2" cellspacing="0"
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <asp:LinkButton ID="lbdisable" OnClientClick="return ConfirmAction('Are you sure you want to change the status of the selected occupation!');"
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="45%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="Name" HeaderText="Occupation" SortExpression="Name" Target="_self">
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="Active" HeaderText="Active" SortExpression="Active" Target="_self">
                                    <HeaderStyle Width="10%" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:HyperLinkField>
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label3" runat="server" SkinID="CaptionLabel" Text="Name &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label4" runat="server" SkinID="CaptionLabel" Text="Display Order &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtOccupation" runat="server" SkinID="txt248" MaxLength="100" onkeypress="return isNumberKey(event);"></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtCode" runat="server" MaxLength="3" SkinID="txt248" onkeypress="return isNumberKey(event);"></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtDisplayOrder" runat="server" SkinID="txt248" ToolTip="Display Order"
                            MaxLength="2" onkeypress="checkNumber(this,2,0,event)"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td valign="middle" colspan="2">
                        <asp:Label ID="Label2" runat="server" SkinID="CaptionLabel" Text="Occupation-Course Mapping Details"></asp:Label>
                    </td>
                    <td align="right">
                ...
                <tr class="even">
                    <td valign="top" colspan="3">
                        <asp:updatePanel ID="upnl" runat="server">
                           <ContentTemplate>
                           <asp:CheckBoxList ID="chkcourses" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
