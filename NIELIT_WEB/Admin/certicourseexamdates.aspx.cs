...
using EConnect.URM;
using EConnect.DAL;
public partial class certicourseexamdates : BasePage
{
    ...
    protected void ShowEditMode()
    {
        ...
        try
        {
            ...
            btnSave.Text = "Update";
            lblHeading.Text = "Course Exam Session Details";
    ...
    protected void ToggleViewMode_Changed(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("certicourseexamdates.aspx", true);
        }
    }
    ...
    protected void SaveRecord(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("certicourseexamdates.aspx?msg=" + strMessage);
        }
        catch (Exception ex)
        {
            ShowAlert(ex.Message, true);
