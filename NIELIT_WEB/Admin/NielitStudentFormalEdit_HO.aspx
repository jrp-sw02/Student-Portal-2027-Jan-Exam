<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/MasterPages/main.master" CodeFile="NielitStudentFormalEdit_HO.aspx.cs"  Inherits="Admin_NielitStudentFormalEdit_HO" %>
...
<asp:content id="Content3" contentplaceholderid="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Nielit Student Formal Edit"></asp:Label>
...
<asp:content id="Content6" contentplaceholderid="cphContents" runat="Server">
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="977px" style="margin-bottom:20px">          
            ...
            <tr>
                <td align="center" id="tderror" runat="server">
                ...
                <td align="left" valign="top">
                    <table style="width: 100%;" class="sample3" border="0" cellpadding="3" cellspacing="1">
                            ...
                            <td>
                             ...
                             <td  width="30%" >
                               <asp:Button ID="btnShow" runat="server" Text="Show"  OnClick="btnShow_Click"/> 
                                   <%--&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="btnNext" runat="server" Text="Switch to Next Semester" visible="false" OnClick="btnNext_Click"  />--%>   
                            </td>
                        ...
                        <tr class="gdalternate1"  id="trcourse" runat="server" visible="false" >
                            ...
                            <td width="3%" valign="top" style="padding-right: 13px;" class="auto-style1">
                                1.2
                            </td>

                            

                            <td valign="top" width="30%" class="auto-style1">
                                Course:
                            ...
                            <ContentTemplate>  
                                <asp:DropDownList ID="ddlBatch" runat="server" Width="337px" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged" Enabled="false">
                                </asp:DropDownList>
                                </ContentTemplate>
                            <Triggers>  
                            </Triggers>
                            ...
                            <td valign="top" width="35%" class="auto-style1" >
                                Semester:
                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate>  
                                <asp:DropDownList ID="ddlsemester" runat="server" Width="250px" TabIndex="1" Enabled="false">
                         ...
                         <%-- Added on 27 June 2024--%>   
                           ...
                           <tr class="gdalternate1">
                            ...
                            <td align="left" colspan="4">
                                 University Registration Number / विश्वविद्यालय पंजीयन संख्या
                            </td>
                        </tr>
                        ...
                        <tr  class="gdalternate1">
                            <td align="left" colspan="4" class="auto-style2" >
                                <asp:TextBox style="width:501px;" ID="UniversityRegNo" runat="server" Enabled="false"  Width="150px" ></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr class="gdalternate1"  id="trproject" runat="server" visible="false">
                            ...
                            <td valign="top" width="40%">
                                ...
                                <asp:DropDownList ID="ddlWheatherPojectStu" runat="server" SkinID="ddl250"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlWheatherPojectStu_SelectedIndexChanged" Enabled="true">
                            ...
                            <td valign="top" width="57%" colspan="2">
                                <asp:Label ID="LblProjectname" runat="server"  SkinID="CaptionLabel" Text="Project Name :"
                                    ></asp:Label>
                                <asp:DropDownList ID="ddlProcname" runat="server" Enabled="true" SkinID="ddl250" OnSelectedIndexChanged ="ddlProcname_SelectedIndexChanged"
                                    AutoPostBack="true">
                                </asp:DropDownList> 
                        ...
                        <tr>
                            <td align="center" colspan="3">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Update" TabIndex="53" OnClick="btnSave_Click"
                                 ...
                                 <asp:Button ID="btnSaveNext" runat="server" Text="Submit" TabIndex="53" OnClick="btnSaveNext_Click"
