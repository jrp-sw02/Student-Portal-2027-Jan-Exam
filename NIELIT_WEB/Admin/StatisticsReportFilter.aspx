<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true" CodeFile="StatisticsReportFilter.aspx.cs" Inherits="Admin_StatisticsReportFilter" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
            var projectID;
            projectID = document.getElementById('<%=ddlProjectName.ClientID %>').value;
         ...
         //       window.open("../HO/Rpt/StatisticsReport.aspx?DateFrom=" + datefrom + "&DateTo=" + dateto);
         //   }
         //   else {
         //       window.open("../HO/Rpt/StatisticsReportProjectWise.aspx?DateFrom=" + datefrom + "&DateTo=" + dateto + "&projectID=" + projectID);
         //   }
         //window.open("../HO/Rpt/ConsolidatedPaymentApplicationReport.aspx?ExamId=" + ExamId + "&TypeId=" + TypeId + "&applicantTypeID=" + applicantTypeID + "&InstituteID=" + instituteid + "&Category=" + Category + "&Occupation=" + Occupation + "&RegID=" + RcentreID + "&paymentStatusId=0");
     ...
     <table class="sample2" width="100%" border="0" cellpadding="2" cellspacing="0">
            ...
            <td width="33%">
             ...
             <td width="33%">
                <asp:Label ID="Label1" runat="server" SkinID="CaptionLabel" Text="Project Name &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
            </td>
        </tr>
        <tr id="TrExamInput" runat="server" class="even">
            ...
            <td width="33%">
                <asp:DropDownList ID="ddlProjectName" runat="server" SkinID="ddl250" Width="185px" TabIndex="27"  
...
<%--<asp:Button ID="btnView" runat="server" Text="Generate Report" 
    ...
    OnClientClick="return OpenWindow();"/>--%>
    <%--<asp:Button ID="btnView" runat="server" Text="Generate Report" 
    OnClick="btnView_Click" OnClientClick ="document.forms[0].target = '_blank';" />--%>
    <asp:Button ID="btnView" runat="server" Text="Generate Report" 
