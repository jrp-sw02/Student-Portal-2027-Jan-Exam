...
public partial class Admin_ObserverCentreWise : BasePage
{
    ...
    private DataTable GetData()
    {
        ...
        string sql = "PracticalVivaMarksEntry_BatchWise";
    ...
    protected void OnUpdate(object sender, EventArgs e)
    {
           ...
           // string registrationNumber = row.Cells[2].Text;
           // string moduleType = row.Cells[5].Text;
            ...
            try
            {
                using (var context = new EConnectContext())
                {
                    ...
                    updateMarks1.ObserverMarks20 = Int32.Parse(observerMarks20);
                    updateMarks1.ObserverMarks20EntryDate = DateTime.Now;
                    context.SaveChanges();
                }
    ...
    protected void grdCandidateData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            TextBox txtObserver20 = (TextBox)e.Row.FindControl("txtObserver20");

            //Button btnSubmit = (Button)e.Row.FindControl("lnkOUpdate");
            var value = EConnect.Utils.Data.DbUtility.ExecuteScaller("select  Observer_marks_20 from  Practical_candidate_marks   where  Registration_no = '" + registrationNumber + "'and   Batch_code = '" + ddlBatch.SelectedValue + "'", new EConnect.Connections.SqlCon(), null, CommandType.Text, false);

            if (value != DBNull.Value)
            {
                //meters += Convert.ToDecimal(value);
                txtObserver20.Enabled = false;
                txtObserver20.Text = Convert.ToString(value);
    ...
    protected void BindGridView()
    {
        try
        {
                ...
                //|| dt_result.Rows.Count !=   Convert.ToInt32(txtCount.Text))
            {
                ...
                lblInfo.Text = "Marks are not enterd  by the the  examiner/observer for this  batch";
