<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/main.master" CodeFile="VirtualAcademyCutOffDate.aspx.cs" Inherits="Admin_VirtualAcademyCutOffDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Virtual Academy Cut-Off-Dates"></asp:Label>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (document.getElementById("<%= ddlBatch.ClientID %>").disabled == false) {
            ...
            if (!isBlankDate("<%=txtRegStartDate.ClientID %>", "Reg Start Date", "dd-MMM-yyyy"))
                return false;
            if (!isDate("<%=txtRegStartDate.ClientID %>", "Invalid Reg Start Date", "dd-MMM-yyyy"))
                return false;

            if (!isBlankDate("<%=txtEffectiveDate.ClientID %>", "Effective Date", "dd-MMM-yyyy"))
                return false;
            if (!isDate("<%=txtEffectiveDate.ClientID %>", "Invalid Effective Date", "dd-MMM-yyyy"))
                return false;
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                               <asp:BoundField HeaderStyle-Width="5%" HeaderText="#">
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ID,CourseID" DataNavigateUrlFormatString="?Key={0}&CourseID={1}"
                                    DataTextField="Name" HeaderText="Course Name" SortExpression="Name"
                                    Target="_self" >
                                <ItemStyle Width="13%" HorizontalAlign="Center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="ID,CourseID" DataNavigateUrlFormatString="?Key={0}&CourseID={1}"
                                    DataTextField="ActivityName" HeaderText="Activity" SortExpression="ActivityName" Target="_self" >
                                     <ItemStyle Width="13%" HorizontalAlign="Center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="ID,CourseID" DataNavigateUrlFormatString="?Key={0}&CourseID={1}"
                                    DataTextField="ApplicantName" HeaderText="Type" SortExpression="ApplicantName" Target="_self">
                                     <ItemStyle Width="13%" HorizontalAlign="Center" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="ID,CourseID" DataNavigateUrlFormatString="?Key={0}&CourseID={1}"
                                    DataTextField="regnStartDate" HeaderText="Reg Start Date" SortExpression="regnStartDate" 
                                    Target="_self" DataTextFormatString="{0:dd-MMM-yyyy}" >
                                <ItemStyle Width="10%" HorizontalAlign="Center" />
                                </asp:HyperLinkField>
                                 <asp:HyperLinkField DataNavigateUrlFields="ID,CourseID" DataNavigateUrlFormatString="?Key={0}&CourseID={1}"
                                    DataTextField="Efferctive_Date" HeaderText="Reg End Date" SortExpression="Efferctive_Date" 
                                    Target="_self" DataTextFormatString="{0:dd-MMM-yyyy}" >
                                <ItemStyle Width="10%" HorizontalAlign="Center" />
                                </asp:HyperLinkField>
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:Label ID="Label3" runat="server" SkinID="CaptionLabel" Text="Batch Name&lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlBatch" runat="server" SkinID="ddl250" 
                                    AutoPostBack="true">
                                    <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                ...
                <tr>
                    <td valign="top" style="width: 33%;">
                        <asp:Label ID="Label10" runat="server" SkinID="CaptionLabel" Text="Activity Name&lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                     ...
                     <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label1" runat="server" SkinID="CaptionLabel" Text="Reg End Date&lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td valign="top" style="width: 33%;" >
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                        <asp:DropDownList ID="Ddlactivity" runat="server" SkinID="ddl250" 
                            AutoPostBack="true">
                        </asp:DropDownList>
                            </ContentTemplate>
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:TextBox ID="txtRegStartDate" runat="server" SkinID="txt210"></asp:TextBox>
                        <img id="img1" src="../images/calendaricon.jpg" style="width: 20px; height: 22px;
                            vertical-align: top;" />
                        <asp:CalendarExtender ID="CalendarExtender1" TargetControlID="txtRegStartDate" PopupPosition="BottomLeft"
                      ...
                      <td valign="top" style="width: 33%;">
                        ...
                        <img id="img2" src="../images/calendaricon.jpg" style="width: 20px; height: 22px;
                            vertical-align: top;" />
                        <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="txtEffectiveDate" PopupPosition="BottomLeft"
                            Format="dd-MMM-yyyy" PopupButtonID="imgDob" runat="server">
                        </asp:CalendarExtender>
                    </td>
