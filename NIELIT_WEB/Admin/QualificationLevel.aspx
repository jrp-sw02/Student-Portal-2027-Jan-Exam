<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="QualificationLevel.aspx.cs" Inherits="Admin_QualificationLevel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Qualification Level"></asp:Label>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphAddNew" runat="Server">
    ...
    <uc1:SearchBar ID="ucSearchBar" OnLnkBtnResetSearch="SearchBar_Reset" SearchTextToolTip="Search by Qualification Level,Code"
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (!isBlank("<%=txtQualificationLevel.ClientID %>", "Qualification Level"))
                return false;
            if (!isBlank("<%=txtCode.ClientID %>", "Code"))
                return false;
            if (!isBlank("<%=txtDisplayOrder.ClientID %>", "Display Order"))
                return false;
            if (!isNumber("<%=txtDisplayOrder.ClientID %>"))
                return false;
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="30%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="Name" HeaderText="Qualification Level" SortExpression="Name" Target="_self">
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="DisplayOrder" HeaderText="Order" SortExpression="DisplayOrder"
                                    Target="_self">
                                    <HeaderStyle Width="10%" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:HyperLinkField>
        ...
        <asp:View ID="New" runat="server">
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtQualificationLevel" runat="server" SkinID="txt248" MaxLength="150"  onkeypress="return isNumberKey(event);"></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtCode" runat="server" MaxLength="10" SkinID="txt248" onkeypress="return isNumberKey(event);"></asp:TextBox>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtDisplayOrder" runat="server" MaxLength="3" SkinID="txt248" onkeypress="checkNumber(this,2,0,event)"></asp:TextBox>
                    </td>
                </tr>
            </table>
