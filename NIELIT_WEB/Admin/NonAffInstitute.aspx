...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="NonAffInstitute.aspx.cs" Inherits="Admin_NonAffInstitute"
    Debug="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Non Accredited Centers"></asp:Label>
</asp:Content>
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblUserType" Width="100%" runat="server" Text="Non Accredited Centre"></asp:Label>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (!isBlank("<%=txtemail1.ClientID %>", "Email Id"))
                return false;
            if (!isValidEmail("<%=txtemail1.ClientID %>", "Invalid E-Mail ID"))
                return false;
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="60%" DataNavigateUrlFields="ID,Name" DataNavigateUrlFormatString="?Key={0}&Name={1}"
                                    DataTextField="Name" HeaderText="Non Accredited Centre" SortExpression="Name" Target="_self">
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="15%" DataNavigateUrlFields="ID,Name" DataNavigateUrlFormatString="?Key={0}&Name={1}"
                                    DataTextField="MobileNumber" HeaderText="MobileNumber"
                                    Target="_self">
        ...
        <asp:View ID="New" runat="server">
            <table class="sample2" cellpadding="0" cellspacing="1" width="100%">
                <tr class="heading">
                    <td colspan="3">Institute Details
                    </td>
                </tr>
                <tr Visible="false" runat="server">
                    <td valign="top" >
                        <asp:Label ID="Label2" runat="server" Visible="false" SkinID="CaptionLabel" Text="Institute ID &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                <tr class="even" Visible="false" runat="server">
                    <td valign="top">
                        <asp:TextBox ID="txtInstituteID" Visible="false" runat="server" SkinID="txt248" MaxLength="150" ></asp:TextBox>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr class="even">
                    <td colspan="2" valign="top">
                        <asp:TextBox ID="txtaccentre" runat="server" MaxLength="100" onblur="return onlyAlphabets(event,this);"  SkinID="txt502"></asp:TextBox>
                    </td>
                    <td valign="top">
                        <asp:TextBox ID="txtcontactperson" runat="server" MaxLength="100" SkinID="txt248"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtdesignation" SkinID="txt248" MaxLength="50" runat="server"></asp:TextBox>
                    </td>
                    ...
                    <td style="height: 25%;" valign="top">
                        <asp:TextBox ID="txtphone1" SkinID="txt248" runat="server" MaxLength="7" onkeypress="checkNumber(this,7,0,event)" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtphone2" runat="server" SkinID="txt248" MaxLength="7" onkeypress="checkNumber(this,7,0,event)" ></asp:TextBox>
                    </td>
                    <td valign="top" style="height: 25%;">
                        <asp:TextBox ID="txtfaxno" runat="server" SkinID="txt248" MaxLength="6" onkeypress="checkNumber(this,6,0,event)"></asp:TextBox>
                    </td>
                    <td style="height: 25%;" valign="top">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtemail1" SkinID="txt248" MaxLength="70" runat="server"></asp:TextBox>
                    </td>
                    <td valign="top" style="height: 25%;">
                        <asp:TextBox ID="txtemail2" runat="server" MaxLength="70" SkinID="txt248"></asp:TextBox>
                    </td>
                    <td style="height: 25%;" valign="top">
                        <asp:TextBox ID="txtwebaddress" runat="server"  MaxLength="50" SkinID="txt248"></asp:TextBox>
                    </td>
                </tr>
                <tr class="heading">
                    <td colspan="3">Contact Details
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtadd1" SkinID="txt248"  MaxLength="250" runat="server"></asp:TextBox>
                    </td>
                    <td valign="top" style="height: 25%;">
                        <asp:TextBox ID="txtadd2" runat="server"  MaxLength="250" SkinID="txt248"></asp:TextBox>
                    </td>
                    <td style="height: 25%;" valign="top">
                        ...
                        <asp:TextBox ID="txtadd3" runat="server" MaxLength="100" SkinID="txt248"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                ...
                <tr class="even">
                    ...
                    <td valign="top" style="height: 25%;"></td>
                    <td style="height: 25%;" valign="top"></td>
                </tr>
            </table>
    ...
    <table runat="server" align="center" class="nav" cellspacing="0" cellpadding="0"
        ...
        <tr>
            <td style="border: 1px solid #2c5070; background-color: #FFFFFF;" width="100%">
                ...
                <asp:HyperLink ID="hl1" runat="server" Target="_self">Non Accredited Details</asp:HyperLink>
            </td>
        </tr>

         <tr>
            <td style="border: 1px solid #2c5070; background-color: #FFFFFF;" width="100%">
                <asp:HyperLink ID="hl2" runat="server" Target="_self">Non Accredited Institute Courses</asp:HyperLink>
