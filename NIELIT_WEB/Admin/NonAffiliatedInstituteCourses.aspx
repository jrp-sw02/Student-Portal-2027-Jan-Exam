<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="NonAffiliatedInstituteCourses.aspx.cs" Inherits="NonAffiliatedInstituteCourses"  Debug="false"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="NonAccredited Centres Courses Details"></asp:Label>
</asp:Content>
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                <tr>
                                 ...
                                 <tr>
                                    <td>
                                        <asp:Label ID="Label10" Width="100%" runat="server" Text="Project"></asp:Label>
                                        <asp:DropDownList ID="ddlProjectF" Width="100%" runat="server" 
                                            onselectedindexchanged="ddlProjectF_SelectedIndexChanged" AutoPostBack="true">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlcategryF" Width="100%" runat="server" 
                                            onselectedindexchanged="ddlcategryF_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Value="0" Text="--Select One--"></asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlcourF" Width="100%" runat="server">
                                            <asp:ListItem Value="0" Text="--Select One--"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlstsF" Width="100%" runat="server">
                                            <asp:ListItem Value="99" Text="--All--"></asp:ListItem>
                                            <asp:ListItem Value="0" Text="Withdrawn"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Running"></asp:ListItem>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function validatefilter() {
            ...
            if (!isSelected("<%=ddlcategryF.ClientID %>", "Course Category"))
                return false;
            if (!isSelected("<%=ddlcourF.ClientID %>", "Course"))
                return false;
        ...
        function ValidateFormFields() {
            ...
            if (!isCompare("<%=txteffectivefrom.ClientID %>","<%=txteffectiveto.ClientID %>", "", "dd-MMM-yyyy"))
                return false;
                            ...
                            <Columns>
                                <asp:BoundField HeaderStyle-Width="5%" HeaderText="#"><HeaderStyle Width="5%" /><ItemStyle HorizontalAlign="Right" /></asp:BoundField>
                                  <asp:HyperLinkField HeaderStyle-Width="40%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="ProjectName" HeaderText="Project Name" SortExpression="Name" Target="_self"><HeaderStyle Width="20%" /><ItemStyle HorizontalAlign="Left" /></asp:HyperLinkField>
                                  <asp:HyperLinkField HeaderStyle-Width="40%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="40%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="CourseLinkNumber" HeaderText="CourseLink Number" SortExpression="AccreditationNumber"
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="40%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="LinkStatusID" HeaderText="Status" SortExpression="SNAME" Target="_self"><HeaderStyle Width="40%" /><ItemStyle HorizontalAlign="Left" /></asp:HyperLinkField>
                    <%--  <asp:HyperLinkField HeaderStyle-Width="40%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
            ...
            <table class="sample2" cellpadding="2" cellspacing="0">
                <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label3" runat="server" SkinID="CaptionLabel" Text="Project &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlProject" runat="server" SkinID="ddl250" AutoPostBack="True" 
                    ...
                    <td style="width: 33%;" valign="top">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlCourse" runat="server" SkinID="ddl250"  OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" AutoPostBack="True" >
                                     <asp:ListItem Value="0" Text="--Select One--"></asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers><asp:AsyncPostBackTrigger ControlID="ddlCourse" EventName="SelectedIndexChanged" /></Triggers>
                        </asp:UpdatePanel>
                       ...
                       <%-- <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                        <asp:TextBox ID="txtaccno" runat="server" SkinID="txt248" ToolTip="Accredition Number" Enabled="false" MaxLength="25"></asp:TextBox>
                                </ContentTemplate>
...
<%--                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlcoursecategory" runat="server" SkinID="ddl250" AutoPostBack="True" Enabled="false"
                                    OnSelectedIndexChanged="ddlcoursecategory_SelectedIndexChanged">
                                </asp:DropDownList>
                            </ContentTemplate>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlaccfor" runat="server" SkinID="ddl250"  OnSelectedIndexChanged="ddlaccfor_SelectedIndexChanged" AutoPostBack="True" >
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers><asp:AsyncPostBackTrigger ControlID="ddlaccfor" EventName="SelectedIndexChanged" /></Triggers>
                        </asp:UpdatePanel>
                ...
                <tr>
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:Label ID="Label1" runat="server" SkinID="CaptionLabel" Text="Link Status &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:DropDownList ID="ddlstatus" runat="server" SkinID="ddl250"  OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged" AutoPostBack="True"   >
                 ...
                 <tr id="withdrawlDate" runat ="server">
                    <td valign="top" style="width: 33%;" >
                <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Course Linked Number &lt;b class='mandatory'&gt;&lt;/b&gt;"
                ...
                <tr class="even">
                 ...
                 <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                          <asp:TextBox ID="txtCourseLindedNumber" runat="server" SkinID="txt210" MaxLength="11" Visible ="true" Enabled="false" ></asp:TextBox>         </ContentTemplate>
                         
                        </asp:UpdatePanel>
                    </td>
                
                    <td valign="top" style="width: 33%;" colspan="3">
                         <asp:TextBox ID="txtWithdrawldate" runat="server" SkinID="txt210" MaxLength="11" Visible ="true" ></asp:TextBox>
			...
			<asp:Label ID="lblBlockDate" runat="server" SkinID="CaptionLabel" Text="Temporary Block Date &lt;b class='mandatory'&gt;&lt;/b&gt;"
                    ...
                    <td colspan="2">
                           <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                    <asp:Label ID="lblerror" runat="server" SkinID="CaptionLabel" Text="" ForeColor="Red" ></asp:Label>
                                </ContentTemplate>
