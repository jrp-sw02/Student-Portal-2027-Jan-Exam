<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="ModuleParity.aspx.cs" Inherits="ModuleParity" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Modules Parity"></asp:Label>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidateLogin() {
            //            if (!isSelected("<%=ddlNewRevNo.ClientID %>", "New Revision No"))
            //                return false;
            return true;
            ...
            <table class="sample2" cellpadding="2" cellspacing="0">
                <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblOldRevNo" runat="server" SkinID="CaptionLabel" Text="Old Revision No."></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblNewRevNo" runat="server" SkinID="CaptionLabel" Text="New Revision No."></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:DropDownList ID="ddlOldRevNo" runat="server" AutoPostBack="True" SkinID="ddl250"
                            Height="22px" OnSelectedIndexChanged="ddlOldRevNo_SelectedIndexChanged">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlNewRevNo" runat="server" SkinID="ddl250"
                                    Height="22px">
                                    <asp:ListItem Text="--Select One--" Value="-1"></asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddlOldRevNo" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td style="width: 33%;" valign="top" align="center">
                        <asp:Button ID="btnShow" runat="server" Text="Show" OnClick="btnShow_Click" OnClientClick="return ValidateLogin();" />
                        <asp:Button ID="btnPrint" runat="server" Text="Print" 
                            OnClientClick="return ValidateLogin();" Width="48px" Visible="false" />
                    </td>
                </tr>
            </table>
            <div id="divGrid" runat="server">
                <asp:UpdatePanel EnableViewState="true" ID="uPnlGrid" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Label EnableTheming="false" ID="lberror" CssClass="error" width="99%" visible="false" runat="server"></asp:Label>
