    ...
    protected void OnUpdate(object sender, EventArgs e)
    {
      ...
      //  GridViewRow row = grdCandidateData.Rows[rowIndex];
        ...
        GridViewRow row = (sender as LinkButton).NamingContainer as GridViewRow;
          string observerMarks40 = (row.FindControl("txtObserver40") as TextBox).Text;
        ...
        //Fetch value of Country
          ...
          string sql = " update Practical_candidate_marks  set  Observer_marks_40 = '" + observerMarks40 + "'  where Registration_no = '" + registrationNumber + "' and module_id = '" + moduleType + "' ";
...
" pm.center_Code ='" + CentreCode + "'   and ( Examiner_marks_40 is not null and  Examiner_marks_40  >= 0 )   and  Observer_marks_40  is null order by    pm.Exam_date, Exam_report_time, Registration_no ";
