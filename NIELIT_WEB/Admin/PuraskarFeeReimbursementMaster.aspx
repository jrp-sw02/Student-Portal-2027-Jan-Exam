<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PuraskarFeeReimbursementMaster.aspx.cs"
    Inherits="Admin_PuraskarFeeReimbursementMaster" MasterPageFile="~/MasterPages/main.master"
    Debug="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Puraskar Fee Reimbursement Master"></asp:Label>
</asp:Content>
    ...
    <script language="javascript" type="text/javascript">
        function ValidateFormFields() {
            ...
            if (!isSelected("<%=ddlcourses.ClientID  %>", "Course Name"))
                return false;
            if (!isBlank("<%=txtinstalments.ClientID  %>", "Total Instalments"))
                return false;

            if (!isBlank("<%=txtTotalAmount.ClientID  %>", "Total Amount"))
                return false;
            if (!isBlankDate("<%=txteffectivefromDate.ClientID %>", "Effective From Date", "dd-MMM-yyyy"))
                return false;

            if (!isNumber("txtinstalments"))
                return false;
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="20%" DataNavigateUrlFields="ID"
                                    DataNavigateUrlFormatString="?Key={0}" DataTextField="TotalInstalments"
                                    HeaderText="Total Instalments" SortExpression="TotalInstalments" Target="_self">
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID"
                                    DataNavigateUrlFormatString="?Key={0}" DataTextField="TotalAmt"
                                    HeaderText="Total Amount" SortExpression="TotalAmt" Target="_self">
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:HyperLinkField>
        ...
        <asp:View ID="New" runat="server">
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Total Instalments &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">

                        <asp:Label ID="Label2" runat="server" SkinID="CaptionLabel" Text="Total Amount &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtinstalments" runat="server" onkeypress="return numeric(event)" onpaste="return false;" SkinID="txt248" MaxLength="1"></asp:TextBox>
                            </ContentTemplate>
                            <Triggers>
                            </Triggers>
                        </asp:UpdatePanel>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:TextBox ID="txtTotalAmount" SkinID="txt248" runat="server" onkeypress="return numeric(event)" onpaste="return false;" Width="200px" MaxLength="5"></asp:TextBox>
