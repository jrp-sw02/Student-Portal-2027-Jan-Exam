...
using EConnect.DAL;
public partial class certificateexamdetail : BasePage
{
    ...
    protected void ToggleViewMode_Changed(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("certificateexamdetail.aspx", true);
        }
    }
    ...
    protected void SaveRecord(object sender, EventArgs e)
    {
        ...
        //    Response.Redirect("certificateexamdetail.aspx?msg=" + strMessage);
        //}
        //catch (Exception ex)
        //{
        //    ShowAlert(ex.Message, true);
