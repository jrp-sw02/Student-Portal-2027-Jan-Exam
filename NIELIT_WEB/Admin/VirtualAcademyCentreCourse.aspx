<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/main.master" CodeFile="VirtualAcademyCentreCourse.aspx.cs" Inherits="Admin_VirtualAcademyCentreCourse" %>
...
<asp:content id="Content3" contentplaceholderid="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Virtual Academy Centre Course"></asp:Label>
</asp:content>
...
<asp:content id="Content6" contentplaceholderid="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidateLogin() {
            ...
            if (!isSelected("<%=cbNielitCentres.ClientID %>", "Center Name"))
                return false;
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblsr" runat="server" Text='<%# Bind("Id") %>'></asp:Label>                           
                                  ...
                                  <asp:HyperLinkField HeaderStyle-Width="16%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="CentreName" HeaderText="Centre Name" SortExpression="Name" Target="_self"><HeaderStyle Width="16%" /></asp:HyperLinkField>
                                  <asp:HyperLinkField HeaderStyle-Width="16%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="IsActive" HeaderText="IsActive" SortExpression="isActive" Target="_self"><HeaderStyle Width="10%" />  <ItemStyle HorizontalAlign="Center" /></asp:HyperLinkField>
            ...
            <table class="sample2" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    <td style="width:33%;" valign="top">
                        <asp:Label ID="Label3" runat="server" SkinID="CaptionLabel" Text="Center &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td style="width:33%;" valign="top">
                ...
                <tr class="even">
                 ...
                 <tr id="trisactive" runat="server" visible="false">
                    <td style="width:33%;" valign="top">
                        <asp:Label ID="Label2" runat="server" SkinID="CaptionLabel" Text="IsActive &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                       <asp:Label ID="lblactiveerror" runat="server" ForeColor="Red" Font-Size="Small" Font-Italic="true" Width="100%"></asp:Label>
                    </td>
                    
                                        
                </tr>
                <tr class="even" id="trisactive1" runat="server" visible="false">

                    <td style="width:33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlIsActive" Width="100%" runat="server" SkinID="ddl250" AutoPostBack="true" >
