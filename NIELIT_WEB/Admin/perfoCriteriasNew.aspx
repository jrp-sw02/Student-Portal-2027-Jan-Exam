<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="perfoCriteriasNew.aspx.cs" Inherits="perfoCriteriasNew" %>
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                              ...
                              <%--  <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    ...
                                    Target="_self" />--%>
                                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                                    DataTextField="stateCriteria" HeaderText="States Criteria" SortExpression="stateCriteria"
                                    Target="_self" />
                                 <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="?Key={0}"
                ...
                <tr>
                    ...
                    <td style="width: 33%;" valign="top">
                        <%--<asp:Label ID="lblCityType" runat="server" Text="City Type <b class='mandatory'>*</b>"
                            SkinID="CaptionLabel"></asp:Label>--%>
                        <asp:Label ID="lblStateCriteria" runat="server" Text="States Criteria <b class='mandatory'>*</b>"
                            SkinID="CaptionLabel"></asp:Label>
                    </td>
                ...
                <tr class="even">
                    ...
                    <td valign="top" style="width: 33%;">
                        <asp:DropDownList ID="ddlCityType" runat="server" SkinID="ddl250"
                         ...
                         <asp:DropDownList ID="ddlstatesCriteria" runat="server" SkinID="ddl250"
                            TabIndex="1">
                            <asp:ListItem Text="--Select One--" Value="0"></asp:ListItem>
                             <asp:ListItem Text="Others" Value="O"></asp:ListItem>
                             <asp:ListItem Text="UTs and NE" Value="E"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td style="width: 33%;" valign="top">
