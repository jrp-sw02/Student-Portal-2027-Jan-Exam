...
using EConnect.DAL;
public partial class certicextimetable : BasePage
{
    ...
    protected void ShowEditMode()
    {
        ...
        try
        {
            ...
            btnSave.Text = "Update";
            lblHeading.Text = "Course Exam TimeTable";
    ...
    protected void ToggleViewMode_Changed(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("certicextimetable.aspx", true);
        }
    }
    ...
    protected void SaveRecord(object sender, EventArgs e)
    {
        ...
        //    Response.Redirect("certicextimetable.aspx?msg=" + strMessage);
        //}
        //catch (Exception ex)
        //{
        //    ShowAlert(ex.Message, true);
