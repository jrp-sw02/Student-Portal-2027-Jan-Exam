<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="AccrediationDetailsAsprD.aspx.cs" Inherits="AccrediationDetailsAsprD"  Debug="true"%>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function validatefilter() {
            ...
            if (!isSelected("<%=ddlNielitCentre.ClientID %>", "linked To Centre"))
                return false;
        }
            ...
            <table class="sample2" cellpadding="2" cellspacing="0">
                ...
                <tr class="even">
                 ...
                 <tr>
                    ...
                    <td valign="top" style="width: 33%;" >
                        <asp:Label ID="Label11" runat="server" SkinID="CaptionLabel" Text="Link to Centre &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                      <td colspan="2">
                ...
                <tr class="even">
                    ...
                    <td valign="top" style="width: 33%;" colspan="3">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                        <asp:DropDownList ID="ddlNielitCentre" runat="server" SkinID="ddl250" >
                        </asp:DropDownList>
