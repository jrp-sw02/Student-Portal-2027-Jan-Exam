...
public partial class HO_StudentUPMSPCorrection : BasePage
{
    Int32 loginUserNo = 0;
    Int64 entityID = 0;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //{
            //    conn.Open();
            //    SqlCommand cmd = new SqlCommand("Select COUNT(*) from CourseRegnApplicationHistory where Apaar_ID = @apaarid", conn);
