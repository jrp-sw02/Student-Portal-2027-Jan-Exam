<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    Debug="true" CodeFile="RegistrationProcess.aspx.cs" Inherits="RegistrationProcess"
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Registration Process"></asp:Label>
</asp:Content>
                            ...
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlCandidateType" Width="240px" runat="server" AutoPostBack="true"
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label7" Width="100%" runat="server" Text="Exam Year"></asp:Label>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlApplStatus" runat="server" Width="240px">
                                            <asp:ListItem Value="N"> Not Processed</asp:ListItem>
                                            <asp:ListItem Value="P">Processed</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
        <asp:View ID="List" runat="server">
                    ...
                    <table cellpadding="0" cellspacing="1" width="100%" id="tbl1" runat="server">
                        ...
                        <tr>
                            <td align="right" valign="bottom">
                                <asp:Button ID="btnProcess" Visible="false" runat="server" Text="Process" OnClientClick="return Validate_Checkbox('Are you sure you want to process the Registration of selected applications!')"
            ...
            <br />
            <asp:UpdatePanel EnableViewState="true" ID="UpnlShow" UpdateMode="Conditional"
                runat="server">
                <ContentTemplate>
                    <table cellpadding="0" cellspacing="1" width="100%" id="tblShowDetail1" runat="server"
                        visible="false">
                        <tr>
                            <td>
                                <asp:Label ID="lblTitle" runat="server" CssClass="error" EnableTheming="false" Text="Processed Application Details are:"
                                    Width="99%"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div id="divShowdetail" style="width: 100%; height:200px; overflow:scroll;" runat="server">
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <asp:View ID="New" runat="server">
            ...
            <div id="DivRegdetail" runat="server" style="text-align: right; margin-top: 10px"
                class="box">
                <table style="width: 100%;" class="sample3" cellpadding="2" cellspacing="1">
                    <tr class="head1">
                        <td align="left" colspan="2">
                            Previous Registration Detail<asp:Button ID="BtnProcess2" runat="server" OnClick="BtnProcess2_Click"
                                Style="float: right;" Text="Process" OnClientClick="return confirm('Are you sure you want to process the registration?');"
                                Visible="false" />
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td align="left" colspan="2" style="width: 103%; border-bottom: 1px solid #000000;">
                            <asp:Label ID="lblRegStatus" runat="server" ForeColor="#FF5050" Text="Fresh Registration"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdrow1" runat="server" id="trddlConfirm" visible="false">
                        <td align="left" colspan="2" width="50%">
                            <asp:DropDownList ID="ddlNewRegistration" runat="server" Width="375px" Enabled="false">
                                <asp:ListItem Value="C"> Cancel My Existing Registration</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td align="left" width="20%" colspan="2" style="width: 99%">
                            &nbsp;
                        </td>
                    </tr>
                    <tr class="gdrow1">
                        ...
                        <td align="left" width="79%">
                            <asp:Label ID="lblRegNo" runat="server" Text="NA"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td align="left">
                        ...
                        <td align="left">
                            <asp:Label ID="lblRegDate" runat="server" Text="NA"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdrow1">
                        <td align="left">
                        ...
                        <td align="left">
                            <asp:Label ID="lblRegCourse" runat="server">NA</asp:Label>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td align="left" colspan="2">
            ...
            <div id="divTbl" class="box" runat="server">
                <table style="width: 100%;" class="sample3" cellpadding="2" cellspacing="1">
                    <tr class="head1">
                        <td colspan="2" style="width: 100%" width="25%">
                            <font color="white">Your Current Registration Detail is as follows:</font>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td width="25%">
                    ...
                    <tr class="gdalternate1">
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="Exam Name"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr class="gdrow1">
                        <td>
                            <asp:Label ID="Label13" runat="server" Text="Registration Number"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblCurrntRegNo" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Registration Date"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblCurrntRegDate" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdrow1">
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblCurrntRegCourse" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Commencement From Date"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblCommncmntFrmDate" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdrow1">
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Valid Upto Date"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblValidUpToDate" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
