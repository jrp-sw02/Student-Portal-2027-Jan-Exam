<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPages/main.master" CodeFile="NielitCentreAspirationalStudentEdit.aspx.cs" Inherits="HO_NielitAspirationalCentreStudentEdit" Debug="true" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="977px" style="margin-bottom:20px">          
            ...
            <tr>
                <td align="center">
                    <strong style="text-align: center" class="headfont">ASPIRATIONAL STUDENT UPDATE FORM
                ...
                <td align="left" valign="top">
                        ...
                        <tr class="gdalternate1"  id="trcourse" runat="server" visible="false">
                            ...
                            <td valign="top" width="30%">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlCenter" Width="100%" runat="server" AutoPostBack="True"  OnSelectedIndexChanged="ddlCenter_SelectedIndexChanged" Enabled="False" >
                    ...
                    <table id="TblFormDetail" runat="server" class="sample3" style="width: 100%; text-align: left"
                        ...
                        <tr class="gdrow1">
                            ...
                            <td>
                                <asp:DropDownList Width="95px" runat="server" ID="ddlSalutaionName" OnSelectedIndexChanged="ddlSalutaionName_SelectedIndexChanged"
                                    AutoPostBack="True" TabIndex="7" Enabled="False">
                        ...
                        <tr class="gdalternate1">
                            ...
                            <td align="left">
                                <asp:RadioButtonList ID="Rdoownertype" runat="server" RepeatDirection="Horizontal"
                                    Width="300px" AutoPostBack="True" TabIndex="1" OnSelectedIndexChanged="Rdoownertype_SelectedIndexChanged" Enabled="False">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                       <%-- <asp:RadioButtonList ID="rdbtnlstgender" runat="server" RepeatDirection="Horizontal"
                                         ...
                                         <asp:DropDownList ID="ddl_gender" runat="server" Width="375px" Enabled="False" /> 
                                    </ContentTemplate>
                                    <Triggers>
                        ...
                        <tr class="trgdalternate1calendar" id="trdob" runat="server">
                            ...
                            <td>
                                <asp:TextBox MaxLength="11" ID="txtDob" runat="server" SkinID="txtDate" Width="99px"
                                    ...
                                    AutoPostBack="true" OnTextChanged="txtDob_TextChanged" Enabled="False"></asp:TextBox>
                        ...
                        <tr class="gdrow1" id="trmaritalstatus" runat="server">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlMStatus" runat="server" Width="375px" TabIndex="16" Enabled="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr class="gdalternate1" id="trcategory" runat="server">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCategory" runat="server" Width="375px" TabIndex="17" Enabled="false">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr class="gdrow1" id="trreligion" runat="server">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlReligion" runat="server" Width="375px" TabIndex="20" Enabled="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr class="head1">
                        ...
                        <tr class="gdalternate1">
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlPdistrict" runat="server" TabIndex="31" Width="375px" Enabled="False">
                                            <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                    <Triggers>
                        ...
                        <tr class="gdrow1">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCorState" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCorState_SelectedIndexChanged"
                                    TabIndex="38" Width="375px" Enabled="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr class="gdalternate1">
                            ...
                            <td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlcordistrict" runat="server" TabIndex="31" Width="375px" Enabled="False">
                                            <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                    <Triggers>
                        ...
                        <tr class="gdalternate1" id="UIDtr" runat="server">
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="UidNumberTxt" runat="server" MaxLength="12" placeholder="ID Card Number"
                                    Width="300px" onpaste="return false;" oncopy="return false;" oncut="return false;" Enabled="False"></asp:TextBox>
                            </td>
                        </tr>
                        <%--<tr class="gdrow1">
                            <td height="130">
                        ...
                        <tr class="gdalternate1" id ="trwhetherCourseComplete" runat="server" visible="false">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCourseComplete" runat="server" Width="375px" Enabled="False" CssClass="auto-style1">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                    <asp:ListItem Value="2">No</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr class="gdalternate1" id ="trwhetherCertificateIssued" runat="server" visible="false">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlwhetherCertificateIssued" runat="server" Width="375px" Enabled="False">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                    <asp:ListItem Value="2">No</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr class="gdalternate1" id ="trWhetherPlaced" runat="server" visible="false">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlWhetherPlaced" AutoPostBack="true" OnSelectedIndexChanged="ddlWhetherPlaced_SelectedIndexChanged" runat="server" Width="375px" Enabled="False">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                    <asp:ListItem Value="2">No</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr class="gdrow1" id ="trAffidiate" runat="server" visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="txtAffidiavitNo" runat="server" Width="520px" TabIndex="26" MaxLength="30"
                                    onpaste="return false;" Visible="false" oncopy="return false;" oncut="return false;" Enabled="False"></asp:TextBox>
                                <br />
                            </td>                          
                        </tr>                  
                        ...
                        <tr class="gdalternate1">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlAffidiavitVerified" Visible="false" runat="server" Width="375px" Enabled="False">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                    <asp:ListItem Value="2">No</asp:ListItem>
                                </asp:DropDownList>
