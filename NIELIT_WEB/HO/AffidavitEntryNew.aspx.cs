...
public partial class HO_AffidavitEntryNew : BasePage
{
    Int32 entityID = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Affidavit Entry Process (New cases)", "#", ""));
                //bindCourse();
                BindCourseType();
                ...
                if (currentRoleId == 3)
                {
                    using (EConnectContext context = new EConnectContext())
                    {
                        ...
                        var candidate = (from a in context.CourseRegistrationApplications
                                         ...
                                         where a.FinalSubmitted == true && a.Number.Trim() == txtRegNo .Text 
                                         && a.GuardianName != null && a.GuardianName.Trim().Length != 0
                                         && a.affidavitNo != null && a.affidavitUpload != null
                                         && a.CourseID == Convert.ToInt32 (ddlCourseName .SelectedValue )
                                         select a).FirstOrDefault();
                        ...
                        BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Application No. " + txtRegNo .Text , "#", ""));
                        ...
                        showData(courseType, courseID, txtRegNo .Text );
                        ddlCourseName.SelectedValue = courseID.ToString();
                ...
                else
                {
                    if (!string.IsNullOrEmpty(Convert.ToString(Request.QueryString["CourseID"])) && !string.IsNullOrEmpty(Convert.ToString(Request.QueryString["RegNo"])) && !string.IsNullOrEmpty(Convert.ToString(Request.QueryString["CourseTypeID"])))
                    {
                       ...
                       // BreadCrumb1.RemoveLastBreadCrumbItem();
                        ...
                        showData(courseType, courseID, appNo);
                        ddlCourseName.SelectedValue = courseID.ToString();
                        DivSearch.Visible = false;
    ...
    protected void showData(Int32 courseTypeID, Int32 courseID, string appNo)
    {
        try
        {
            Resetcontrols();
            using (EConnectContext context = new EConnectContext())
            {
                if (ddlCourseType.SelectedValue == "1")
                {
                    Label4.Text = "Application Number:";
                    ...
                    var candidate = (from a in context.CourseRegistrationApplications
                                    // join g in context.RegistrationDetails on a.CandidateID  equals g.CandidateID 
                                     where (
                                     a.FinalSubmitted == true && a.CourseID == courseID && a.Number  == appNo.Trim()
                                    && a.GuardianName != null
                                    && a.GuardianName.Trim().Length != 0
                                    && a.affidavitDate == null
                                    && a.affidavitNo == null
                    ...
                    if (candidate != null)
                    {
                        ...
                        //contact details
                        var contact = (from a in context.CourseRegistrationApplications
                                       // join g in context.RegistrationDetails on a.CandidateID  equals g.CandidateID 
                                       where (
                                       a.FinalSubmitted == true && a.CourseID == courseID && a.Number == appNo.Trim()
                                      && a.GuardianName != null
                        ...
                        var currentaddress = (from a in context.CourseRegistrationApplications
                                       // join g in context.RegistrationDetails on a.CandidateID  equals g.CandidateID 
                                       where (
                                       a.FinalSubmitted == true && a.CourseID == courseID && a.Number == appNo.Trim()
                                      && a.GuardianName != null
                      ...
                      //  foreach (var currentaddress in address)
                       // {
                          //  if (count == 0) //current address
                           // {
                                LblAdd1.Text = string.IsNullOrEmpty(currentaddress.CorAddressLine1 ) == false && !string.IsNullOrWhiteSpace(currentaddress.CorAddressLine1) ? GetInitCap(currentaddress.CorAddressLine1) : "NA";
                                LblAdd2.Text = string.IsNullOrEmpty(currentaddress.CorAddressLine2) == false && !string.IsNullOrWhiteSpace(currentaddress.CorAddressLine2) ? GetInitCap(currentaddress.CorAddressLine2) : "NA";
                                lblAdd3.Text = string.IsNullOrEmpty(currentaddress.CorAddressLine3) == false && !string.IsNullOrWhiteSpace(currentaddress.CorAddressLine3) ? GetInitCap(currentaddress.CorAddressLine3) : "NA";
                                LblCity.Text = string.IsNullOrEmpty(currentaddress.CorCityName) == false && !string.IsNullOrWhiteSpace(currentaddress.CorCityName) ? GetInitCap(currentaddress.CorCityName) : "NA";
                                LblState.Text = currentaddress.CorStateID != 0 ? GetInitCap(currentaddress.CorState.Name) : "NA";
                                if (currentaddress.CorDistrictID.HasValue)
                                { LblDistrict.Text = GetInitCap(currentaddress.CorDistrict.Name); }
                                else
                                { LblDistrict.Text = "NA"; }
                                LblPinCode.Text = currentaddress.CorPinCode.ToString() ;
                                count = count + 1;
                            //}
            ...
            using (EConnectContext context = new EConnectContext())
            {
                if (courseTypeID == 1)
                {
                    var candidate = (from a in context.CourseRegistrationApplications
                                    // join g in context.RegistrationDetails on a.CandidateID  equals g.CandidateID 
                                     where (
                                     a.FinalSubmitted == true && a.CourseID == courseID && a.Number .ToString().Trim() == regNo.Trim()
                                    && a.GuardianName != null
                                    && a.GuardianName.Trim().Length != 0
                                    && a.affidavitDate == null
                                    && a.affidavitNo == null
