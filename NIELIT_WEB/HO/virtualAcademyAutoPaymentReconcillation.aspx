<%@ Page Language="C#" AutoEventWireup="true" CodeFile="virtualAcademyAutoPaymentReconcillation.aspx.cs"
    Inherits="HO_virtualAcademyAutoPaymentReconcillation" MasterPageFile="~/MasterPages/main.master"
    Debug="false" %>
...
<asp:content id="Content2" contentplaceholderid="chpHeading" runat="Server">
    <asp:label id="lblHeading" runat="server" text="Virtual Academy Auto Payment Reconcillation"></asp:label>
</asp:content>
