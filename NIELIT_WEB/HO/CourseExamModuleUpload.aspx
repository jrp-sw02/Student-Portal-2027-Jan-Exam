<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseExamModuleUpload.aspx.cs"
    Inherits="HO_CourseExamModuleUpload" MasterPageFile="~/MasterPages/main.master"
    Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Upload Module Data"></asp:Label>
</asp:Content>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateFormFields() {
            ...
            if (!isSelected("<%=ddlExamName.ClientID %>", "Exam Name"))
                return false;
            if (!isSelected("<%=ddlprocess.ClientID %>", "Process Option"))
                return false;
        ...
        <asp:View ID="New" runat="server">
            <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Process Options &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlprocess" runat="server" SkinID="ddl250" AutoPostBack="true">
                                    <asp:ListItem Value="0">--Select One--</asp:ListItem>
                                    <asp:ListItem Value="1">Update Applied Modules</asp:ListItem>
                                    <asp:ListItem Value="2">Remove Applied Modules</asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label13" runat="server" SkinID="CaptionLabel" Text="Module Type &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                    </td>
                    <td colspan="2">
                ...
                <tr class="even">
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="Ddlmoduletype" runat="server" SkinID="ddl250" AutoPostBack="true">
                                    <asp:ListItem Value="0">--Select One-</asp:ListItem>
            ...
            <div id="divprint" runat="server">
                <table class="sample3" id="tblprint" style="width: 100%; text-align: left" border="0"
                    ...
                    <tr class="gdrow1">
                        ...
                        <td>
                            <asp:Label ID="lbmodule" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr class="gdalternate1">
                        <td width="40%" valign="top">
                            Practicals Apppearing
                        </td>
                        <td>
                            <asp:Label ID="lbpmodule" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <%-- <tr class="gdalternate1">
                        <td width="25%">
