<%@ Page Title="NSQFCandFeeReport" Language="C#" AutoEventWireup="true" CodeFile="NSQFCandFeeReport.aspx.cs" Inherits="HO_Rpt_NSQFCandFeeReport"
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContents" runat="server">
       ...
       <span class="lblWarningNew">Please enter one Financial Year only.
   </span>
    <table border="0" width="100%" cellpadding="2" cellspacing="0">
        ...
        <tr class="gdalternate1">
            <td>
                <asp:Label ID="lblstartyr" runat="server" Text="Start Date&lt;font color='RED'&gt;*&lt;/font&gt;"></asp:Label>
            </td>
        ...
        <tr class="gdrow1">
            <td>
                <asp:Label ID="lblendyr" runat="server" Text="End Date&lt;font color='RED'&gt;*&lt;/font&gt;"></asp:Label>
            </td>
