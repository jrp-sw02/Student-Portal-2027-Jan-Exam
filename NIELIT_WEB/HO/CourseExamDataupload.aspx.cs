...
public partial class CourseExamDataupload : BasePage
{
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (Request.QueryString["CourseID"] != null && Request.QueryString["ExamID"] != null)
                    {
                        ...
                        BreadCrumb1.RemoveLastBreadCrumbItem();
                        BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Upload Admit Card Data: " + ddlflCourse.SelectedItem.Text + "-" + "(" + ddlflExam.SelectedItem.Text + ")", "HO/CourseExamDataUpload.aspx?CourseID=" + ddlflCourse.SelectedValue + "&ExamID=" + ddlflExam.SelectedValue + "&ExamCycleID=" + ddlflExamCycle.SelectedValue + "&ExamYear=" + ddlflExamYear.SelectedValue + "&modulefilter=" + ddlmodulefilter.SelectedValue, ""));
                        BreadCrumb1.Render();
                        BindGridView();
                    }
                    else
                    {
                        BreadCrumb1.RemoveLastBreadCrumbItem();
                        BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Upload Admit Card Data", "HO/CourseExamDataUpload.aspx", ""));
                        BreadCrumb1.Render();
                    }
    ...
    protected void ShowEditMode()
    {
        try
        {
            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem(application.RegistrationNumber + "-" + "(" + application.Candidate.Name + ")", "HO/CourseExamDataUpload.aspx?" + Request.QueryString.ToString(), ""));
    ...
    protected void ToggleViewMode_Changed(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Request.QueryString["CourseID"] != null && Request.QueryString["ExamID"] != null)
            {
                Response.Redirect("CourseExamDataUpload.aspx?CourseID=" + Request.QueryString["CourseID"] + "&ExamID=" + Request.QueryString["ExamID"] + "&ExamCycleID=" + Request.QueryString["ExamCycleID"] + "&ExamYear=" + Request.QueryString["ExamYear"] + "&modulefilter=" + Request.QueryString["modulefilter"], true);
            }
            else
                Response.Redirect("CourseExamDataUpload.aspx", true);
        }
    }
    ...
    protected void AllyFilter(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                BreadCrumb1.UpdateLastBreadCrumbItem(new BreadCrumbItem("Upload Admit Card Data: " + ddlflCourse.SelectedItem.Text + "-" + "(" + ddlflExam.SelectedItem.Text + ")", "HO/CourseExamDataUpload.aspx?CourseID=" + ddlflCourse.SelectedValue + "&ExamCycleID=" + ddlflExamCycle.SelectedValue + "&ExamYear=" + ddlflExamYear.SelectedValue + "&ExamID=" + ddlflExam.SelectedValue + "&modulefilter=" + ddlmodulefilter.SelectedValue, ""));
                BreadCrumb1.Render();
                upBread.Update();
            }
            PagingBar1.CurrentPageIndex = 0;
                ...
                {                  
                    ...
                    while (dr.Read())
                    {
                        ...
                        {                           
                            ...
                            ExamCenter examcentre = context.ExamCenters.Where(s => s.Code.ToUpper() == ExamCentreCode.ToUpper() && s.CourseCategoryID == CourseCategoryID && s.IsEnabled== true ).FirstOrDefault();
                            //ExamVenue examvenue = context.ExamVenues.Where(s => s.Code.ToUpper() == ExamvenueCode.ToUpper() && s.CourseID == CourseID ).FirstOrDefault();
                            var examvenue = (from m in context.ExamVenues where m.Code.ToUpper() == ExamvenueCode.ToUpper() && m.IsActive == true  && m.CourseID == CourseID && m.ExamCentreID == examcentre.ID select new { Id = m.ID }).FirstOrDefault();
                            ...
                            {
                                if (rs.RollNumber.HasValue == true)
                                {
