<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtsahanPuraskarReconcillation.aspx.cs"
    Inherits="HO_ProtsahanPuraskarReconcillation" MasterPageFile="~/MasterPages/main.master"
    Debug="false" %>
...
<asp:content id="Content2" contentplaceholderid="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Protsahan Puraskar Online Reconcillation"></asp:Label>
</asp:content>
...
<asp:content id="Content5" contentplaceholderid="cphContents" runat="Server">
    ...
    <asp:Label ID="lblheading2" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Amount Released List Recieved from Bank for Updation" Visible="true"></asp:Label>
           ...
           <tr class="gdalternate1">
                ...
                <td style="width: 20%;" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlflExam" Width="75%" runat="server" backColor="Cornsilk" Enabled="true"  AutoPostBack="true" OnSelectedIndexChanged="ddlflExam_SelectedIndexChanged" >   
        ...
        <table class="sample3" id="tblValidateData" style="width: 100%; text-align: left"
            ...
            <tr class="gdrow1">
                <td width="40%" colspan="2">
                    <asp:Label ID="Label12" runat="server" Text="The unsaved records may be due to data discrepancies or duplicacy or data not found in the databse."
    ...
    <div style="text-align: right; margin-top: 10px">
        <asp:Button ID="btnSave" runat="server" Text="Upload Data" OnClick="btnSave_Click" OnClientClick="return ValidateFormFields()" />
