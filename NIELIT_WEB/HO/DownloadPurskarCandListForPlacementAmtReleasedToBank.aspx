<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="DownloadPurskarCandListForPlacementAmtReleasedToBank.aspx.cs" Inherits="DownloadPurskarCandListForPlacementAmtReleasedToBank" Debug="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Download Purskar Placement Candidates List to be sent to Bank for Amount Release"></asp:Label>
</asp:Content>
        ...
        <asp:UpdatePanel EnableViewState="true" ID="uPnlGrid" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="lblheading2" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar Placement Candidates List to be sent to Bank for Amount Release" Visible="true"></asp:Label><br />
                    ...
                    <Columns>
                       ...
                       <asp:BoundField HeaderText="Level" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10px" DataField="Level">
                        ...
                        <asp:BoundField HeaderStyle-Width="15%"
                         ...
                         <asp:TemplateField HeaderText="AadhaarNumber" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10px">
                            <ItemTemplate>
                      ...
                      <%--  <asp:BoundField HeaderStyle-Width="15%"
                            DataField="AadharNumber" HeaderText="AadharNumber" SortExpression="AadharNumber">
                            <HeaderStyle Width="15%" />
                        </asp:BoundField>--%>
                         <asp:BoundField HeaderStyle-Width="15%"
                            DataField="TotalAmtAsPerPaperPassed" HeaderText="TotalAmtAs PerPaperPassed" SortExpression="TotalAmtAsPerPaperPassed">
                            <HeaderStyle Width="15%" />
                        </asp:BoundField>
                         <asp:BoundField HeaderStyle-Width="15%"
                            DataField="PreviousAmountReleased" HeaderText="Previous AmountReleased" SortExpression="PreviousAmountReleased" >
                            <HeaderStyle Width="15%" />
                        </asp:BoundField>
                         <asp:BoundField HeaderStyle-Width="15%"
