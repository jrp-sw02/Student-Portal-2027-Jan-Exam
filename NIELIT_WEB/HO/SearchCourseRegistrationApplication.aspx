<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchCourseRegistrationApplication.aspx.cs"
    Inherits="HO_SearchCourseRegistrationApplication" MasterPageFile="~/MasterPages/main.master"
    Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Search Course Registration Applications"></asp:Label>
</asp:Content>
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" Width="100%" runat="server" Text="Registration Type"></asp:Label>
                                        <asp:DropDownList ID="ddlregtype" Width="100%" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <asp:GridView ID="gvMain" runat="server" OnSorting="gvMain_Sorting" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ID,Appno,apptypeID,key,examID" DataTextField="Appno"
                                    HeaderText="Application No." SortExpression="Appno" Target="_self" DataNavigateUrlFormatString="ApplicationDetails.aspx?ID={0}&Appno={1}&ApplicationTypeID={2}&key={3}&examID={4}&Src=CRS"><HeaderStyle Width="10%" /><ItemStyle HorizontalAlign="Right" /></asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="ID,Appno,apptypeID,key,examID" DataTextField="Appdate"
                                    ...
                                    DataNavigateUrlFormatString="ApplicationDetails.aspx?ID={0}&Appno={1}&ApplicationTypeID={2}&key={3}&examID={4}&Src=CRS"><HeaderStyle Width="13%" /><ItemStyle HorizontalAlign="center" /></asp:HyperLinkField>
                                <asp:HyperLinkField DataNavigateUrlFields="ID,Appno,apptypeID,key,examID" DataTextField="Name"
                                    HeaderText="Candidate Name" SortExpression="Name" Target="_self" DataNavigateUrlFormatString="ApplicationDetails.aspx?ID={0}&Appno={1}&ApplicationTypeID={2}&key={3}&examID={4}&Src=CRS"><HeaderStyle Width="25%" /><ItemStyle HorizontalAlign="left" /></asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="15%" DataNavigateUrlFields="ID,Appno,apptypeID,key,examID"
                                    DataTextField="fathername" HeaderText="Father Name" SortExpression="fathername"
                                    Target="_self" DataNavigateUrlFormatString="ApplicationDetails.aspx?ID={0}&Appno={1}&ApplicationTypeID={2}&key={3}&examID={4}&Src=CRS"><HeaderStyle Width="15%" /><ItemStyle HorizontalAlign="left" /></asp:HyperLinkField>
