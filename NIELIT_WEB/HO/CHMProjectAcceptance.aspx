<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true" CodeFile="CHMProjectAcceptance.aspx.cs" Inherits="HO_CHMProjectAcceptance" %>
<%@ Register Src="../UserControl/PagingBar.ascx" TagName="PagingBar" TagPrefix="uc3" %>
<%@ Register Src="../UserControl/ToggleView.ascx" TagName="ToggleView" TagPrefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" Runat="Server">
     CHM(T) O  Level  Project Receipt
</asp:Content>
                ...
                <table cellpadding="0" cellspacing="1" width="100%" id="tbl1" runat="server">
                    ...
                    <tr>
                        <td align="right" valign="bottom">
                            <asp:Button ID="btnVerify" runat="server" Text="Verify" Visible="false"
                                OnClientClick="return Validate_Checkbox('Are you sure you want to verify selected applications!')"
                                 OnClick="btnVerify_Click" Width="104px" />
                        ...
                        <td>
                            ...
                            <HeaderStyle Width="150px" />
                                    ...
                                    <asp:TemplateField HeaderText="Project Receipt Date">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDate" runat="server" AutoPostBack="true"  ToolTip="yyyy-mm-dd" Placeholder="yyyy-mm-dd"  Width="120px" onblur="validateDateFormat(this);" ></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   <%-- <asp:TemplateField>
                                        <ItemTemplate>
        ...
        <table width="100%">
            ...
            <tr align="right">
                <td>
                    ...
                    <asp:Button ID="btnReport" runat="server" visible="false"  Text="View Report" Height="27px" Width="118px" OnClick="Button1_Click"   />
                </td>
