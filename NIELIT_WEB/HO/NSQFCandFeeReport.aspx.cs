...
public partial class HO_Rpt_NSQFCandFeeReport : BasePage
{
    Int64 entityID = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //if (!UserManager.HasRight(currentRoleId, enmRight.View, "HO/Rpt/NSQFCandFeeReport.aspx"))
            //{
    ...
    protected bool isValidForm()
    {
        try
        {
            ...
            {
                throw new Exception("Please choose only 1 year difference.");
            }
    ...
    protected void BindGridView()
    {
        try
        {
            ...
            using (var connection = new SqlConnection(ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString))
            {
                ...
                string required_SP = "getNSQFcandfeereport"; 
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        String today_date = DateTime.Today.ToString("dd-MM-yyyy");
        String filename = "NSQF_Candidate_Fees_Report" + "_From Period_" + txtStartDate.Text + "_to_" + txtEndDate.Text+"_"; 
        ...
        Response.AddHeader("content-disposition", "attachment;filename=" + filename  + "_Generated_Date_" + today_date +".xls");
        Response.Charset = "";
    ...
    private void AddReportHeader()
    {
        ...
        titleCell.Text = "NSQF Candidate Fees Report , from Period : " + txtStartDate.Text + " to  " + txtEndDate.Text;
