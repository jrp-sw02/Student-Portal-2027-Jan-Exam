<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPages/main.master" CodeFile="NielitCentreStudentEdit_HO.aspx.cs" Inherits="HO_NielitCentreStudentEdit_HO" 
    Debug="True" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Nielit Centre Student Corrections"></asp:Label>
                ...
                <td align="left" valign="top">
                    <table style="width: 100%;" class="sample3" border="0" cellpadding="3" cellspacing="1">
                        ...
                        <tr class="gdalternate1" id="trregno" runat="server" >
                            ...
                            <td>
                                <asp:TextBox ID="txtrefno" runat="server" MaxLength="50"  Width="281px"></asp:TextBox>                               
                            </td>
