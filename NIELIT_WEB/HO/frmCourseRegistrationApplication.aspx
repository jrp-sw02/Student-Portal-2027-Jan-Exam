<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true" CodeFile="frmCourseRegistrationApplication.aspx.cs" Inherits="HO_frmCourseRegistrationApplication"  Debug="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" Runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Course Registration Applications"></asp:Label>
</asp:Content>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvMain" runat="server" OnSorting="gvMain_Sorting" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="20%" DataNavigateUrlFields="ID,examID,categoryid,courseid,examyear,regtype,paymentStatus"
                                    DataTextField="examName" HeaderText="Exam Name" SortExpression="examName" Target="_self"
                                    DataNavigateUrlFormatString="?Key={0}&examID={1}&categoryid={2}&courseid={3}&examyear={4}&regtype={5}&paymentStatus={6}">
                                    <HeaderStyle Width="20%" />
                                    <ItemStyle HorizontalAlign="left" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="2%" DataNavigateUrlFields="ID,examID,categoryid,courseid,examyear,regtype,paymentStatus"
                                    DataTextField="description" HeaderText="Application Status" SortExpression="description"
                                    Target="_self" DataNavigateUrlFormatString="?Key={0}&examID={1}&categoryid={2}&courseid={3}&examyear={4}&regtype={5}&paymentStatus={6}">
                                    <HeaderStyle Width="50%" />
                                    <ItemStyle HorizontalAlign="left" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="14%" DataNavigateUrlFields="ID,examID,categoryid,courseid,examyear,regtype,paymentStatus"
            ...
            <asp:GridView ID="gvdetail" runat="server" OnSorting="gvdetail_Sorting" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField HeaderStyle-Width="15%" DataNavigateUrlFields="ID,Appno,apptypeID,key,examID"
                        ...
                        Target="_self" DataNavigateUrlFormatString="ApplicationDetails.aspx?ID={0}&Appno={1}&ApplicationTypeID={2}&key={3}&examID={4}">
