...
public partial class HO_NielitAspirationalCentreStudentEdit : BasePage
{
    int stateid = 0;
...
//Added 6 Sep 2021
    ...
    //Dynamic Array for Paramters_07_11_2024
    ...
    protected void FillddlcentreName()
    {
        try
        {
            ...
            using (EConnectContext context1 = new EConnectContext())
            {
                ...
                //Int32 NielitCentreId = Convert.ToInt32("5007");
                ...
                using (NIELITMISContext context = new NIELITMISContext())
                {
                    ...
                    if (UserTypeid == 11)
                    {
                        ...
                        //var centreName = from s in context.NonAffInstitutes
                        //                 where s.linkedToCentre == NelitCentreLinkId && s.ID == 5007
                        //                 select new { ValueField = s.ID, TextField = s.Name };
                        ...
                        //var NonAfflcentre = (from p in context.NonAffInstitutes
                        //                     where p.linkedToCentre == NelitCentreLinkId && p.ID == 5007
                        //                     select p).FirstOrDefault();
                    ...
                    else
                    {
                        ...
                        //var centreName = from s in context.AffInstitutes
                        //                 where s.linkedToCentre == NelitCentreLinkId && s.instituteID == 5007
                        //                 select new { ValueField = s.instituteID, TextField = s.Name + "(" + s.Accr_No + ")" };
    ...
    {
        Response.Redirect("NielitCentreAspirationalStudentEdit.aspx", true);
        ...
        try
        {
            ...
            using (NIELITMISContext context = new NIELITMISContext())
            {
              ...
              //  NIELITStudentCentreHistory();
                ...
                Response.Redirect("NielitCentreAspirationalStudentEdit.aspx?msg=" + strMessage, true);
            }
        }
            ...
            //else
            {
                using (TransactionScope scope = new TransactionScope())
                {
                    using (NIELITMISContext context = new NIELITMISContext())
                    {
                        ...
                        Response.Redirect("NielitAspirationalCentreStudentEdit.aspx?msg=" + strMessage, true);
                    };
    ...
    protected void btnShow_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            var application1 = (from a in context11.NielitCentreStudent
                                           ...
                                           && a.whetherProjectStudent == true
                                           && a.projectId.ToString ()=="1"
                                           select new
                                           {
            ...
            {
                ShowAlert("Student doesnot belong to Aspirational district or logged in centre");
               return;
                //Commented_24_07_2024
...
*/
				...
				//Added 6 Sep 2021
                                ...
                                BindCourses(SubcetreIdByApplication, 2);
