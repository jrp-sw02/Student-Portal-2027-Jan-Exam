        ...
        <table runat="server" align="center" border="0" cellpadding="3" class="sample3" width="100%"   visible ="true">           
            <tr class ="gdrow1">
                ...
                <td>
                            ...
                            <asp:DropDownList ID="ddlCourseName" runat="server" Height="22px" Width="260px" AutoPostBack="true" OnSelectedIndexChanged="ddlCourseName_SelectedIndexChanged">
            ...
            <tr class ="gdalternate1" runat="server" id="trExamMonth">
                <td>
            ...
            <tr class ="gdrow1"  runat="server" id="trExamYear">
                <td>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                         ...
                         <tr class ="gdrow1" runat="server" id="trExamName" visible="false">
                <td>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlExamName" runat="server" AutoPostBack=" true" Height="22px" Width="260px">
                                <asp:ListItem Value="0"> -- Select One --</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
