<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseExamResultUpload.aspx.cs"
    Inherits="HO_CourseExamResultUpload" MasterPageFile="~/MasterPages/main.master"  Debug="false"%>
...
<asp:content id="Content2" contentplaceholderid="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Upload Result Data"></asp:Label>
</asp:content>
<asp:content id="Content3" contentplaceholderid="cphAddNew" runat="Server">
    ...
    <asp:UpdatePanel EnableViewState="true" ID="upbreadsearch" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
...
<asp:content id="Content5" contentplaceholderid="cphContents" runat="Server">
    ...
    <asp:MultiView ID="mltvTab" runat="server" ActiveViewIndex="0">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvMain" runat="server" DataKeyNames="ID" OnSorting="gvMain_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderStyle-Width="10%" DataNavigateUrlFields="ID,CourseID,ExamID"
                                    DataNavigateUrlFormatString="?Key={0}&CourseID={1}&ExamID={2}"
                                    DataTextField="appNo" HeaderText="Application No." SortExpression="appNo" Target="_self"></asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="15%" DataNavigateUrlFields="ID,CourseID,ExamID"
                                    ...
                                    Target="_self" DataTextFormatString="{0:dd-MMM-yyyy}"></asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="30%" DataNavigateUrlFields="ID,CourseID,ExamID"
                                    DataNavigateUrlFormatString="?Key={0}&CourseID={1}&ExamID={2}"
                                    DataTextField="Name" HeaderText="Candidate Name" SortExpression="Name" Target="_self"><ItemStyle HorizontalAlign="Left" /></asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="25%" DataNavigateUrlFields="ID,CourseID,ExamID"
                                    DataNavigateUrlFormatString="?Key={0}&CourseID={1}&ExamID={2}"
                                    DataTextField="Father" HeaderText="Father/Guardian Name" SortExpression="Father"
                                    Target="_self"></asp:HyperLinkField>
                                <asp:HyperLinkField HeaderStyle-Width="7%" DataNavigateUrlFields="ID,CourseID,ExamID"
                                    DataNavigateUrlFormatString="?Key={0}&CourseID={1}&ExamID={2}"
                                    DataTextField="Rollno" HeaderText="Roll No" SortExpression="Rollno" Target="_self"></asp:HyperLinkField>
                            </Columns>
        ...
        <asp:View ID="New" runat="server">
                ...
                <tr class="even">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            ...
                            <Triggers>
                         <asp:AsyncPostBackTrigger ControlID="ddlcoursecategory" EventName="SelectedIndexChanged" /></Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td style="width: 33%;" valign="top">
                ...
                <tr class="even">
                    <td style="width: 33px;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            ...
                            <Triggers><asp:AsyncPostBackTrigger ControlID="ddlExamCycle" EventName="SelectedIndexChanged" /></Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <Triggers><asp:AsyncPostBackTrigger ControlID="ddlExamYear" EventName="SelectedIndexChanged" /></Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td style="width: 33%;" valign="top"></td>
                </tr>
            ...
            <asp:Label ID="Lbnotresult" runat="server" EnableTheming="false" CssClass="error"
                Width="99%" Style="text-align: left;" Visible="false"></asp:Label>
                        ...
                        <td>
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderStyle-Width="58%" HeaderStyle-BorderColor="Black" HeaderText="Module Name"
          ...
          <%--  <div style="margin-top: 10px" id="divradio" visible="false" runat="server" class="error">
                <table cellpadding="3" cellspacing="0" width="100%">
                    <tr class="gdalternate1">
                        <td valign="top">
                            <asp:Label ID="lbfilter" runat="server" Text="Are you sure you want to change the admit card details of the candidate."
          ...
          <%--  <div style="margin-top: 10px" id="divexamcentre" visible="false" runat="server">
                <table cellpadding="1" cellspacing="0" width="100%" class="sample3" border="0">
                    <tr class="head1">
                        <td align="left" colspan="2">
                    ...
                    <td width="20%">
                        Exam Centre:-</td>
                    <td width="80%">
                        <asp:DropDownList ID="ddlexamcentre" runat="server" width="607px" 
                            onselectedindexchanged="ddlexamcentre_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    </tr>
                    <tr class="gdrow1">
                    ...
                    <tr class="gdrow1">
                        <td align="right" colspan="2">
                            <asp:Button ID="Btnupdate" runat="server" Text="Update" OnClick="Btnupdate_Click"
                                OnClientClick="return ValidateFormFields2();" />
