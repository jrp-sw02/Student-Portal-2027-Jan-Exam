<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullInfo.master" AutoEventWireup="true" CodeFile="DownloadApplicationsPendingCount_Course.aspx.cs"
       ...
       <td>
           <asp:UpdatePanel  ID="Updatepanel1" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:BoundField DataField="Number" HeaderText="Registration Number" SortExpression="BrowserName" ItemStyle-HorizontalAlign="Left" />
