<%@ Page Language="C#" AutoEventWireup="true" CodeFile="centreTrgCalendar.aspx.cs"
    Inherits="HO_centreTrgCalendar" MasterPageFile="~/MasterPages/main.master"
    Debug="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" runat="server" Text="Centre Training Calendar"></asp:Label>
</asp:Content>
                    ...
                    <asp:UpdatePanel EnableViewState="true" RenderMode="Inline" ID="filterPnal_upnlFilter"
                        ...
                        <ContentTemplate>
                            <table cellpadding="0" id="body1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label5" Width="100%" runat="server" Text="Start Date From"></asp:Label>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" Width="100%" runat="server" Text="Start Date To"></asp:Label>
                                ...
                                <img id="img4" src="../images/calendaricon.jpg" style="width: 20px; height: 22px; vertical-align: top;" />
                                  ...
                                  <tr>
                                    <td>
                                        <asp:Label ID="lblFilter2" Width="100%" runat="server" Text="Admission Status"></asp:Label>
                ...
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <asp:TextBox ID="txtstartDate" runat="server" AutoPostBack="True" MaxLength="11" onpaste="return false;"  ReadOnly="false" Width="200px"></asp:TextBox>
                    ...
                    <td style="width: 33%;" valign="top">
                         <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
                        <asp:TextBox ID="txtDurationHours" runat="server" MaxLength="4" onkeypress="checkNumber(this,4,0,event);" SkinID="txt248" Width="200px"></asp:TextBox>
                                 </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="ddlNSQFAligned" EventName ="SelectedIndexChanged" />
                                 <asp:AsyncPostBackTrigger ControlID="ddlCourse" EventName ="SelectedIndexChanged" />
