...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="DownloadApplications_course.aspx.cs" Inherits="HO_DownloadApplications_course"
    Debug="true" %>
...
<asp:content id="Content5" contentplaceholderid="cphContents" runat="Server">
    ...
    <div id="dataCountdiv" runat="server" visible="false">
        <div style="float:left">
          <asp:label runat="server" id="lblApplicationsDetails" style="font-size:11px" cssclass="error" text="" visible="False"
            width="100%" enabletheming="False"></asp:label> 
            </div>
         <div style="float:left">
            <asp:label runat="server" id="lblApplicationsDetails_1" style="font-size:11px" cssclass="error"  text="" visible="False"
            width="100%" enabletheming="False"></asp:label>
            </div>
          <div style="float:left">
            <asp:label runat="server" id="lblApplicationsDetails_2" cssclass="error" style="font-size:11px"  text="" visible="False"
            width="100%" enabletheming="False"></asp:label>
            </div>
        <div style="float:left">
            <asp:label runat="server" id="lblApplicationsDetails_3" cssclass="error" style="font-size:11px"  text="" visible="False"
            width="100%" enabletheming="False"></asp:label>
            </div>
    </div><br/>
