    ...
    protected void BindCourseCategory()
    {
        try
        {
            using (var context = new EConnectContext())
            {
                ...
                //              where (c.CourseTypeID == courseTypeCertificateExam || s.ID != 6)
    ...
    protected void ddlAppType_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (AppTypeId > 0)
            {
                using (EConnectContext context = new EConnectContext())
                {
                    if (courseCatId == 2 ||courseCatId == 6 ||courseCatId == 8 )
                    {
        ...
        try
        {
            ...
            using (var context = new EConnectContext())
            {
                ...
                if (courseId > 0)
                {
                    ...
                    if (courseCatId == 2 || courseCatId == 6 || courseCatId == 8 || courseCatId == 9)
                    {
    ...
    protected void ddlExamName_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                int count = pht1.Count();
                if (count > 0)
                {
                    lblImageDetailsCount.Visible = true;
                    lblImageDetailsCount.Text = "Total Number Of Candidate Photographs: " + pht1.Count();
                }
            };
		...
		context.Database.CommandTimeout = 8000;
                ...
                else
                {
                    if (Convert.ToInt32(ddlCourseCategry.SelectedValue) != 2)
                    {
                       ...
                       // if ((ddlRc.SelectedValue != "0" && ddlCourseCategry.SelectedValue == "6") || (ddlRc.SelectedValue == "0" && ddlCourseCategry.SelectedValue == "3") || (ddlRc.SelectedValue == "0" && ddlCourseCategry.SelectedValue == "4") || (ddlRc.SelectedValue == "0" && ddlCourseCategry.SelectedValue == "5") )
                       // {
