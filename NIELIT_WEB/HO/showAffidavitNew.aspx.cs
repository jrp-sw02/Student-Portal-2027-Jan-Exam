...
public partial class HO_showAffidavitNew : BasePage
{
    Int32 entityID = 0;
    ...
    protected void showData( string appNo,string courseType)
    {
        try
        {
    ...
    protected void BtnBack_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (courseType == "2")
                Response.Redirect("AffidavitVerificationRC.aspx?" + Request.QueryString.ToString());
