<%@ Page Title="MIS Report Details Of Students  ProjectWise CenterWise count" Language="C#" MasterPageFile="~/MasterPages/Report.master" AutoEventWireup="true"
     CodeFile="MISProjectStudentsReport.aspx.cs" Inherits="MISProjectStudentsReport" Debug="false" %>
...
<asp:Content id="Content6" contentplaceholderid="cpReportData" runat="Server">
    <table style="height: 91px; width: 200px">
        <tr>
            <td style="width:180px; text-align:center; border:1px solid #999; padding:2px; background-color:#ded9d9; border-radius:2px;">
        ...
        <tr><td>
         ...
         <tr><td style="width:180px; text-align:center; border:1px solid #999; padding:2px; background-color:#ded9d9; border-radius:2px;">
