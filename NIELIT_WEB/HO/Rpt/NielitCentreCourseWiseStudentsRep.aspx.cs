...
public partial class NielitCentreCourseWiseStudentsRep : BasePage
    {
    Table tbl = new Table();
    ...
    protected void Page_Load(object sender, EventArgs e)
        ...
        try
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "HO/Rpt/NielitCentreCourseWiseStudentsFilter.aspx"))
                {
    ...
    public DataTable CourseWiseStudentsDetailsReport(Int64 centreID, Int64 courseCat, Int64 courseID, DateTime startDate, DateTime endDate)
        ...
        using (SqlConnection con = new SqlConnection(constr))
            {
            using (SqlCommand scCommand = new SqlCommand("RepCourseWiseStudentsDetails", con))
                {
    ...
    protected void ShowTableHeader(string centreName, string coursecat, string courseName)
        ...
        try
            ...
            tc1014.Text = "<b>Start Date : " + datefrom.ToString("dd-MMM-yyyy") + "<b>";
    ...
    protected void imgPDF_Click(object sender, ImageClickEventArgs e)
        ...
        try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=NielitCentreCourseWiseStudentsDetails.pdf");
    ...
    protected void ibExport_Click(object sender, ImageClickEventArgs e)
        ...
        try
            ...
            divReportData.Controls.Add(tbl);
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=NielitCentreCourseWiseStudentsDetails.xls");
            Response.Charset = "";
