<%@ Page Title="NSQF Accreditation Granted For Replacement Report" Language="C#" MasterPageFile="~/MasterPages/Report.master" AutoEventWireup="true"
    CodeFile="NSQFAccrGrantedReplacementRpt.aspx.cs" Debug="false" Inherits="NSQFAccrGrantedReplacementRpt" %>
...
<asp:content id="Content3" contentplaceholderid="cpButtons" runat="server">
    ...
    <asp:ImageButton ClientIDMode="Static" AlternateText="Export to PDF" ToolTip="Export to pdf file"
        ...
        OnClick="imgPDF_Click" Visible="false" height="22%" width="12%" />
    ...
    <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
         ...
         <tr id="dc2" runat="server" visible="true">
             ...
             <td valign="top" colspan="2" >
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlCourseName" runat="server" Height="22px" Width="580px" >
     ...
     <div style="text-align: right; margin-top: 10px">
         <asp:Button ID="btnReportChoice" runat="server" Text="Show Report " OnClientClick="return Validate();"
                ...
                <asp:Button ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" visible="true" />
            </div>     
       
</asp:content>
<asp:content id="Content2" contentplaceholderid="cpReportHeader" runat="Server">
    NSQF Accreditation Granted For Replacement Report</asp:content>
...
<asp:content id="Content6" contentplaceholderid="cpReportData" runat="Server">
    ...
    <asp:Label ID="lblheading" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="NSQF Accreditation Granted For Replacement Report" Visible="false"></asp:Label>     
     <asp:Label ID="lblheadingCandDetails" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="NSQF Accreditation Granted For Replacement Report" Visible="false"></asp:Label><br /><br />
