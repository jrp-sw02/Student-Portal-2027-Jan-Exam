...
public partial class NielitCentreCourseWiseStudentsFormalRep : BasePage
    {
    Table tbl = new Table();
    ...
    protected void Page_Load(object sender, EventArgs e)
        ...
        try
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "HO/Rpt/NielitCentreCourseWiseStudentsFormalFilter.aspx"))
                {
    ...
    public DataTable CourseWiseStudentsDetailsReport(Int64 centreID, Int64 courseCat, Int64 courseID, DateTime startDate, DateTime endDate)
        {
        string constr = ConfigurationManager.ConnectionStrings["NIELITMISContext"].ConnectionString;
        DataTable myDt = new DataTable();
        using (SqlConnection con = new SqlConnection(constr))
            {
            using (SqlCommand scCommand = new SqlCommand("RepCourseWiseStudentsDetailsFormal", con)) 
                {
                ...
                scCommand.Parameters.Add(new SqlParameter("@startDate", SqlDbType.Date));
                scCommand.Parameters["@startDate"].Value = startDate;
                scCommand.Parameters.Add(new SqlParameter("@endDate", SqlDbType.Date));
                scCommand.Parameters["@endDate"].Value = endDate;
    ...
    protected void ShowData()
        ...
        try
            ...
            Int64 courseCat = 0, courseID = 0, Bid=0;
            int Sid = 0;
            ...
            Bid = Convert.ToInt64(Request.QueryString["Bid"]);
            Sid = Convert.ToInt32(Request.QueryString["Sid"]);
            using (DataTable dt = CourseWiseStudentsDetailsReport(centreID, courseCat, courseID, startDate, endDate))
                {
                if (dt.Rows.Count > 0)
                    {
                    var application = (from a in dt.AsEnumerable()
                                       select new
                                       {
                                          ...
                                          // DistrictName = a.Field<string>("DistrictName"),
                                           ...
                                           BatchSemester = a.Field<string>("BatchSemester"),

                                       });
                                       //}).ToList();
                    if (Bid != 0)
                    {
                        application = application.Where(s => s.BatchId == Bid);
                    }
                    if (Sid != 0)
                    {
                        application = application.Where(s => s.SemesterId == Sid);
                    }
                    ...
                    if (application.Count() > 0)
                        ...
                        ShowTableHeader(centreName, courseCategoryName, courseName);
                        //
                        ...
                        foreach (var app in application)
                            ...
                            if (SkipOneRowData != checkRD)
                                ...
                                //tdRow18.Width = Unit.Percentage(15);
                                ...
                                if (aadharnumber != "0")
                                    { //tdRow20.Text = aadharnumber; 

                                    //-----------  12XX XXXX X123
                                    //var firstDigits = aadharnumber.Substring(0, 2);
                                    //var lastDigits = aadharnumber.Substring(aadharnumber.Length - 4, 3);
                                    //var requiredMask = new String('X', aadharnumber.Length - firstDigits.Length - lastDigits.Length);
                                ...
                                tdRow26.Width = Unit.Percentage(8);
                                //tdRow26.Text = app.AdmDate.ToString();    //endDate.ToString("dd-MMM-yyyy")
                                tdRow26.Text = app.AdmDate.ToString("dd-MMM-yyyy");    //endDate.ToString("dd-MMM-yyyy")
                                ...
                                tdRow30.Width = Unit.Percentage(8);
    ...
    protected void ShowTableHeader(string centreName, string coursecat, string courseName)
        {
        try
            {
            int NumberOf_ColumnSpan = 23;
            ...
            datefrom = Convert.ToDateTime(Request.QueryString["startDate"]);
            dateto = Convert.ToDateTime(Request.QueryString["endDate"]);

            tc1.ColumnSpan = NumberOf_ColumnSpan;
            tc1.Text = "NIELIT Center CourseWise Students Details Report For - " + centreName;
            ...
            tc1014.Text = "<b>Start Date From : " + datefrom.ToString("dd-MMM-yyyy") + "<b>";
            ...
            tc1016.Text = "Start Date To: " + dateto.ToString("dd-MMM-yyyy");
            ...
            tcCol5.Text = "<b>Locality / Block / District</b>";
            ...
            tcCol10.Width = Unit.Percentage(15);
            ...
            tcCol6.Text = "<b>Batch // Semester</b>";
            tcCol6.HorizontalAlign = HorizontalAlign.Center;
            th.Cells.Add(tcCol6);

            TableHeaderCell tcCol101 = new TableHeaderCell();
            tcCol101.Width = Unit.Percentage(8);
            tcCol101.Text = "<b>Registration No.</b>";
            ...
            tcCol15.Width = Unit.Percentage(8);
            tcCol15.Text = "<b>Employment Status</b>";
    ...
    protected void imgPDF_Click(object sender, ImageClickEventArgs e)
        ...
        try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=NielitCentreCourseStudentsDetailsFormalReport.pdf");
    ...
    protected void ibExport_Click(object sender, ImageClickEventArgs e)
        ...
        try
            ...
            divReportData.Controls.Add(tbl);
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=NielitCentreCourseStudentsDetailsFormalReport.xls");
            Response.Charset = "";
