...
public partial class HO_Rpt_NielitStatisticsReport : BasePage
{
    Table tbl = new Table(); 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "Admin/NielitStatisticsReportFilter.aspx"))
            {
            ...
            if (!Page.IsPostBack)
            {                
                if ((!string.IsNullOrEmpty(Decrypt(HttpUtility.UrlDecode(Request.QueryString["DateFrom"])))) && (!string.IsNullOrEmpty(Decrypt(HttpUtility.UrlDecode(Request.QueryString["DateTo"])))))
        ...
        try
        {
            ...
            using (EConnectContext context = new EConnectContext())
            {
               ...
               tcCol11.BorderColor = System.Drawing.Color.Chocolate;
                ...
                tcCol3.Text = "Applied / Registered";
                ...
                tcCol7.Text = "Applied / Registered";
                th.Cells.Add(tcCol7);
                ...
                tcCol17.Text = "Applied / Registered";
                ...
                tcCol10.Text = "Total Applied / Registered";
    ...
    protected void ShowTableData()
    {
        try
        {
            ...
            SqlCommand scCommand = new SqlCommand("GetNileitStatisticsReportData", new SqlConnection(con.ConnectionString));
            ...
            for (j = 0; j < ds.Tables[0].Rows.Count; j++)
            {
                ...
                tdRow2.Text = ds.Tables[0].Rows[j]["OwnCentreApplied"].ToString();
                ...
                tdRow3.Text = ds.Tables[0].Rows[j]["OwnCentrePassed"].ToString();               
                ...
                tdRow15.Text = ds.Tables[0].Rows[j]["AccreditedInstituteApplied"].ToString();
                ...
                tdRow14.Text = ds.Tables[0].Rows[j]["AccreditedInstitutePassed"].ToString();
                ...
                tdRow16.Text = ds.Tables[0].Rows[j]["DirectCanApplied"].ToString();
                ...
                tdRow4.Text = ds.Tables[0].Rows[j]["DirectCanPassed"].ToString();
                ...
                Int64 totcountUndrgoingTraining = Convert.ToInt64(ds.Tables[0].Rows[j]["OwnCentreApplied"].ToString()) +
                     Convert.ToInt64(ds.Tables[0].Rows[j]["AccreditedInstituteApplied"].ToString())
                     + Convert.ToInt64(ds.Tables[0].Rows[j]["DirectCanApplied"].ToString());
                ...
                Int64 totcountCumulativeCertified = Convert.ToInt64(ds.Tables[0].Rows[j]["OwnCentrePassed"].ToString()) +
                    Convert.ToInt64(ds.Tables[0].Rows[j]["AccreditedInstitutePassed"].ToString())
                    + Convert.ToInt64(ds.Tables[0].Rows[j]["DirectCanPassed"].ToString());
            ...
            tdNewRow2.Text = "<b>Total candidates Applied/ Registered/Passed</b>";
    ...
    {  
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=NielitStatisticsReport.pdf");
    ...
    protected void ibExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {        
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=NielitStatisticsReport.xls");
