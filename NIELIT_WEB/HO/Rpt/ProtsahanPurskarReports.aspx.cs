...
public partial class ProtsahanPurskarReports : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ExamName();
                BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Download Protsahan Puruskar Reports", "HO/Rpt/ProtsahanPurskarReports.aspx", ""));
            }
    ...
    protected void getDataForPDF()
    {
        try
        {
            ...
            scCommand.Parameters.Add(new SqlParameter("@ExamMonthYear", SqlDbType.VarChar));
            scCommand.Parameters["@ExamMonthYear"].Value = ExamMonthYear;
    ...
    protected void btnDownload4_Click(object sender, EventArgs e)
    {
        ...
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=PuruskarWithHoldReport.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void getDataForPDF3()
    {
        try
        {
            ShowTableHeaderForPDF3();
            //Int64 totAmountReleased = 0;
            string ExamMonthYear = ddlflExam.SelectedValue;
            string constr = ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString;
            SqlConnection con = new SqlConnection(constr);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    string Recommended = ds.Tables[0].Rows[i]["RECOMMENDED"].ToString();
                    if (Recommended == "WITHHOLD")
                    {
                        TableRow tr = new TableRow();
                        if (i % 2 == 0)
                            tr.CssClass = "gdalternate1";
                        ...
                        TableCell tdRow2M = new TableCell();
                        tdRow2M.Width = Unit.Percentage(5);
                        tdRow2M.Text = ds.Tables[0].Rows[i]["MOBILE"].ToString().ToString();
                        tdRow2M.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2M);

                        TableCell tdRow2EM = new TableCell();
                        tdRow2EM.Width = Unit.Percentage(5);
                        tdRow2EM.Text = ds.Tables[0].Rows[i]["MAILID"].ToString().ToString();
                        tdRow2EM.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2EM);
    ...
    protected void ShowTableHeaderForPDF3()
    {
        try
        {
            TableHeaderRow th1 = new TableHeaderRow();
            ...
            tc1.Width = System.Web.UI.WebControls.Unit.Percentage(100);
            tc1.ColumnSpan = 12;
            tc1.Text = "PROTSAHAN PURUSKAR  LIST OF CANDIDATES WITHOLD  FOR THE SESSION OF - " + ddlflExam.SelectedItem.Text.ToUpper() + " REPORT ";
            tc1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th1.Cells.Add(tc1);
            ...
            TableHeaderCell tcCol2M = new TableHeaderCell();
            tcCol2M.Width = Unit.Percentage(5);
            tcCol2M.Text = "MOBLIE";
            tcCol2M.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th.Cells.Add(tcCol2M);

            TableHeaderCell tcCol2EM = new TableHeaderCell();
            tcCol2EM.Width = Unit.Percentage(5);
            tcCol2EM.Text = "MAILID";
            tcCol2EM.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th.Cells.Add(tcCol2EM);
    ...
    #endregion -----With hold Report ------------

    #region -----Reject Reports ------------
    ...
    protected void btnDownload5_Click(object sender, EventArgs e)
    {
        ...
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=PuruskarRejectedReport.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void getDataForPDF4()
    {
        try
        {
            ShowTableHeaderForPDF4();
            //Int64 totAmountReleased = 0;
            string ExamMonthYear = ddlflExam.SelectedValue;
            string constr = ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString;
            SqlConnection con = new SqlConnection(constr);
    ...
    protected void ShowTableHeaderForPDF4()
    {
        try
        {
            TableHeaderRow th1 = new TableHeaderRow();
            ...
            tc1.Width = System.Web.UI.WebControls.Unit.Percentage(100);
            tc1.ColumnSpan = 12;
            tc1.Text = "PROTSAHAN PURUSKAR  LIST OF CANDIDATES REJECTED  FOR THE SESSION OF - " + ddlflExam.SelectedItem.Text.ToUpper() + " REPORT ";
            tc1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th1.Cells.Add(tc1);
    ...
    #endregion -----reject Report ------------

    #region -----Misc Summery Reports ------------
    ...
    protected void btnDownload6_Click(object sender, EventArgs e)
    {
        ...
        tbl.CellPadding = 1;
        tbl.CellSpacing = 1;
        tbl.Width = System.Web.UI.WebControls.Unit.Percentage(30);
        divReportData.Controls.Add(tbl);
        divReportData.RenderControl(hw);
        hw.RenderEndTag();
        Response.Clear();
        ...
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=PuruskarMiscSummaryReport.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void getDataForPDF6()
    {
        try
        {
            ShowTableHeaderForPDF6();
            int f = 0, STM = 0, SCM = 0, PWD = 0, TOTALFORM = 0;
            string ExamMonthYear = ddlflExam.SelectedValue;
            string constr = ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString;
            SqlConnection con = new SqlConnection(constr);
            SqlCommand scCommand = new SqlCommand("GetDataForPurskarApplicationDBTBankReport", con);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    string Female = ds.Tables[0].Rows[i]["Gender"].ToString();
                    if (Female == "Female")
                    {
                        f = f + 1;
                    }

                    string male = ds.Tables[0].Rows[i]["Gender"].ToString();
                    string ccode = ds.Tables[0].Rows[i]["CastCode"].ToString();
                    if (male == "Male" && ccode == "ST")
                    {
                        STM = STM + 1;
                    }
                    if (male == "Male" && ccode == "SC")
                    {
                        SCM = SCM + 1;
                    }

                    string PWDS = ds.Tables[0].Rows[i]["Is_Handicaped"].ToString();
                    if (PWDS == "YES")
                    {
                        PWD = PWD + 1;
                    }
                ...
                for (i = 0; i < 4; i++)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        tdRow2.Width = Unit.Percentage(5);
                        tdRow2.Text = "Female";
                        tdRow2.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2);


                        TableCell tdRow2r = new TableCell();
                        tdRow2r.Width = Unit.Percentage(5);
                        tdRow2r.Text = f.ToString();
                        tdRow2r.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2r);
                    }
                    if (i == 1)
                ...
                if (i % 2 == 0)
                    ...
                    trNew.CssClass = "gdrow1";
                TOTALFORM = f + STM + SCM + PWD;
                TableCell tdNewRow1 = new TableCell();
                tdNewRow1.Width = System.Web.UI.WebControls.Unit.Percentage(1);
                tdNewRow1.Height = System.Web.UI.WebControls.Unit.Percentage(15);
                tdNewRow1.Text = "Total: Forms";
                tdNewRow1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                tdNewRow1.BorderWidth = 0;
                ...
                tdNewRow21.Height = System.Web.UI.WebControls.Unit.Percentage(15);
                tdNewRow21.ColumnSpan = 1;
                tdNewRow21.Text = TOTALFORM.ToString();
    ...
    protected void ShowTableHeaderForPDF6()
    {
        try
        {
            TableHeaderRow th1 = new TableHeaderRow();
            ...
            tc1.Width = System.Web.UI.WebControls.Unit.Percentage(100);
            tc1.ColumnSpan = 3;
            tc1.Text = "CATEGORY WISE DETAILS OF PROTSAHAN PURUSKAR FOR THE SESSION OF - " + ddlflExam.SelectedItem.Text.ToUpper() + " REPORT ";
            tc1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th1.Cells.Add(tc1);
            ...
            TableHeaderCell tcCol2 = new TableHeaderCell();
            tcCol2.Width = Unit.Percentage(5);
            tcCol2.Text = "CATEGORY";
            tcCol2.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th.Cells.Add(tcCol2);

            TableHeaderCell tcCol2M = new TableHeaderCell();
            tcCol2M.Width = Unit.Percentage(5);
            tcCol2M.Text = "TOTAL COUNT";
            tcCol2M.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th.Cells.Add(tcCol2M);
    ...
    protected void btnDownloadRejFinance_Click(object sender, EventArgs e)
    {
        getDataForPDFRejFinance();
        ...
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=PuruskarFinanceRejectedReport.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void getDataForPDFRejFinance()
    {
        try
        {
            ShowTableHeaderForPDFRejFinance();
            //Int64 totAmountReleased = 0;
            string ExamMonthYear = ddlflExam.SelectedValue;
            string constr = ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString;
            SqlConnection con = new SqlConnection(constr);
            SqlCommand scCommand = new SqlCommand("GetDataForPurskarApplicationRejFinance", con);
            scCommand.CommandType = CommandType.StoredProcedure;
            scCommand.Parameters.Add(new SqlParameter("@ExamMonthYear", SqlDbType.VarChar));
            scCommand.Parameters["@ExamMonthYear"].Value = ExamMonthYear;
            scCommand.CommandTimeout = 50000;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (Recommended == "REJECTED")
                    {
                        ...
                        TableCell tdRow2r = new TableCell();
                        tdRow2r.Width = Unit.Percentage(5);
                        tdRow2r.Text = ds.Tables[0].Rows[i]["RECOMMENDED1"].ToString();
                        tdRow2r.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2r);
                        ...
                        TableCell tdRow2rR = new TableCell();
                        tdRow2rR.Width = Unit.Percentage(5);
                        tdRow2rR.Text = ds.Tables[0].Rows[i]["Reason_for_withhold"].ToString();
                        tdRow2rR.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
                        tr.Cells.Add(tdRow2rR);
    ...
    protected void ShowTableHeaderForPDFRejFinance()
    {
        try
        {
            TableHeaderRow th1 = new TableHeaderRow();
            ...
            tc1.Width = System.Web.UI.WebControls.Unit.Percentage(100);
            tc1.ColumnSpan = 12;
            tc1.Text = "PROTSAHAN PURUSKAR  LIST OF CANDIDATES REJECTED BY FINANCE  FOR THE SESSION OF - " + ddlflExam.SelectedItem.Text.ToUpper() + " REPORT ";
            tc1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th1.Cells.Add(tc1);
    ...
    protected void btnDownloadRejExam_Click(object sender, EventArgs e)
    {
        getDataForPDFRejExam();
        ...
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=PuruskarExamRejectedReport.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
    ...
    protected void getDataForPDFRejExam()
    {
        try
        {
            ShowTableHeaderForPDFRejExam();
            //Int64 totAmountReleased = 0;
            string ExamMonthYear = ddlflExam.SelectedValue;
            string constr = ConfigurationManager.ConnectionStrings["EConnectContext"].ConnectionString;
            SqlConnection con = new SqlConnection(constr);
            SqlCommand scCommand = new SqlCommand("GetDataForPurskarApplicationRejExam", con);
            scCommand.CommandType = CommandType.StoredProcedure;
            scCommand.Parameters.Add(new SqlParameter("@ExamMonthYear", SqlDbType.VarChar));
            scCommand.Parameters["@ExamMonthYear"].Value = ExamMonthYear;
            scCommand.CommandTimeout = 50000;
    ...
    protected void ShowTableHeaderForPDFRejExam()
    {
        try
        {
            TableHeaderRow th1 = new TableHeaderRow();
            ...
            tc1.Width = System.Web.UI.WebControls.Unit.Percentage(100);
            tc1.ColumnSpan = 12;
            tc1.Text = "PROTSAHAN PURUSKAR  LIST OF CANDIDATES REJECTED BY EXAM FOR THE SESSION OF - " + ddlflExam.SelectedItem.Text.ToUpper() + " REPORT ";
            tc1.HorizontalAlign = System.Web.UI.WebControls.HorizontalAlign.Center;
            th1.Cells.Add(tc1);
