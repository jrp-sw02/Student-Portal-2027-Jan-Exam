...
public partial class HO_Rpt_StatisticsReport : BasePage
{
    Table tbl = new Table(); 
    ...
    protected void ShowTableData()
    {
        try
        {
            ...
            SqlCommand scCommand = new SqlCommand("GetStatisticsReportData", new SqlConnection(con.ConnectionString));
