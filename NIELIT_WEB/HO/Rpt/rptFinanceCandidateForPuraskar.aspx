<%@ Page Title="Protsahan Puraskar Students Report" Language="C#" MasterPageFile="~/MasterPages/Report.master" AutoEventWireup="true"
    CodeFile="rptFinanceCandidateForPuraskar.aspx.cs" Inherits="rptFinanceCandidateForPuraskar" %>
    ...
    <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
         ...
         <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="lblState" runat="server" Text="State Name" SkinID="CaptionLabel"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label7" runat="server" SkinID="CaptionLabel" Text="Exam Cycle "></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Course Name"
                            Width="100%"></asp:Label>
                    </td>
                </tr>
         <tr class="even">
                    ...
                    <td style="width: 33%;" valign="top">
                         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlExamCycle" runat="server" SkinID="ddl250" >
                ...
                <tr>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label3" runat="server" SkinID="CaptionLabel" Text="Category &lt;b class='mandatory'&gt;*&lt;/b&gt;"
                            Width="100%"></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label4" runat="server" SkinID="CaptionLabel" Text="Physically Handicapped "></asp:Label>
                    </td>
                    <td style="width: 33%;" valign="top">
                        <asp:Label ID="Label10" runat="server" SkinID="CaptionLabel" Text="Gender"
                            Width="100%"></asp:Label>
                    </td>
                </tr>
                <tr class="even">
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                            <ContentTemplate>
                        <asp:DropDownList ID="ddlCastcategory" runat="server" SkinID="ddl250" 
                            Enabled="true" EnableTheming="True">
                            <asp:ListItem>--Select One--</asp:ListItem>
                        </asp:DropDownList>
                                </ContentTemplate>
                             </asp:UpdatePanel>
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                               <asp:DropDownList ID="ddlPWD" runat="server" SkinID="ddl250" >
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlGender" runat="server" SkinID="ddl250" >
                                    <asp:ListItem Value="0">---All---</asp:ListItem>
        ...
        <tr>
            ...
            <td align="left" valign="top" >
                                <asp:Label ID="Label1" runat="server" Text="Application Status">
                                </asp:Label>
                            </td>
           
          <td align="left" valign="top" >
                                <%--<asp:Label ID="Label2" runat="server" Text="Finance Verification Status">
                                </asp:Label>--%>
                            </td>
            <td align="left" valign="top" >
                                <%--<asp:Label ID="Label2" runat="server" Text="Finance Verification Status">
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpReportHeader" runat="Server">
    Protsahan Puraskar Students Report (Finance)</asp:Content>
        ...
        <asp:UpdatePanel EnableViewState="true" ID="uPnlGrid" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="lblheading" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar Students Report (Finance)" Visible="false"></asp:Label><br />
                ...
                <asp:GridView ID="gvMain" runat="server" DataKeyNames="RegnNo" OnSorting="gvMain_Sorting"
                    ...
                    <Columns>
                      ...
                      <asp:HyperLinkField HeaderStyle-Width="10%"
                        ...
                        <asp:HyperLinkField HeaderStyle-Width="15%"
                            DataTextField="TotalExamAppeared" HeaderText="# Exam Appeared" SortExpression="TotalExamAppeared" Target="_self">
                            <HeaderStyle Width="15%" />
                        </asp:HyperLinkField> 
                        <asp:HyperLinkField HeaderStyle-Width="15%"
                            DataTextField="TotalExamPassed" HeaderText="# Exam Passed" SortExpression="TotalExamPassed" Target="_self">
                            <HeaderStyle Width="15%" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField HeaderStyle-Width="15%"
                            DataTextField="AttemptNo" HeaderText="Attempt Number" SortExpression="AttemptNo" Target="_self">
                            <HeaderStyle Width="15%" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField HeaderStyle-Width="15%"
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate> 
                                                ...
                                                <asp:LinkButton ID="lnkViewExam" runat="server" Text="ViewExam" OnClick="viewExam" ForeColor="Blue" Font-Underline="True"
                                                    CommandArgument='<%#Eval("candidateid") + ";" +Eval("RegnNo")+ ";" +Eval("CourseName")%>'></asp:LinkButton><br /><br />
                                                <asp:LinkButton ID="ViewBankdetails" runat="server" Text="AccountDetails" OnClick="viewBankDetails" ForeColor="Blue" Font-Underline="True"
                                                    CommandArgument='<%#Eval("candidateid") + ";" +Eval("RegnNo")%>'></asp:LinkButton><br /><br />
                                                 <asp:LinkButton ID="lnkDocView" runat="server" Text="ViewDocument" OnClick="viewDocument" ForeColor="Blue" Font-Underline="True"
                                                    CommandArgument='<%#Eval("candidateid") + ";" +Eval("RegnNo")%>'></asp:LinkButton>
                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        <%--<asp:ButtonField  Text="View Exam" CommandName="Select" ItemStyle-Width="30" />--%>
                    </Columns>
