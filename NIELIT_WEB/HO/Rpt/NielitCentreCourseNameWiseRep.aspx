<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Report.master" 
    CodeFile="NielitCentreCourseNameWiseRep.aspx.cs" Inherits="NielitCentreCourseNameWiseRep" Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpReportHeader" runat="Server">
    NIELIT Center Course Name Wise Students Report
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    <div id="pdf" runat="server">
        <div id="divpdf" class="text-center" style="font-size: small; color: darkslateblue"  runat="server" visible="false">
            <h2>NIELIT Center Course Name Wise Students Report<br />
            </h2>
        </div>
