...
public partial class HO_NielitCentreMonthlyStudentTrainedFilter : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try 
        {
            BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Nielit Centre Monthly Students Trained", "HO/Rpt/NielitCentreMonthlyStudentTrainedFilter.aspx", ""));
            //currentRoleId = 21;
            //loginUserNo =285714;// 349792; //330672;
            //entityID = 5007; //Give no. from table URM_EXTERNAL_ENTITY for that user
            //UserTypeId = 10;
        ...
        try
        {
            ...
            using (EConnectContext context1 = new EConnectContext())
            {
                ...
                using (NIELITMISContext context2 = new NIELITMISContext())
                {
                    ...
                    // Deep add code for Ho  on 08 July 2021
                    if (UserTypeId == 6)
                    {
                        BindCentres();
