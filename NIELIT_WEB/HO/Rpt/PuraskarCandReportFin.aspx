<%@ Page Title="Protsahan Puraskar Candidates Report" Language="C#" MasterPageFile="~/MasterPages/Report.master" AutoEventWireup="true"
    CodeFile="PuraskarCandReportFin.aspx.cs" Inherits="PuraskarCandReportFin" Debug="false" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateform() {
            ...
            if (!isSelected("<%=ddlExamCycle.ClientID %>", "Exam Cycle"))
                return false;
            if (!isSelected("<%=ddlSessionExam.ClientID %>", "Exam Session"))
                return false;
            return true;
        }
...
<asp:content id="Content3" contentplaceholderid="cpButtons" runat="server">
    ...
    <asp:ImageButton OnClientClick="return printwindow();" ClientIDMode="Static" AlternateText="Print"
        ToolTip="Print" ID="imPrint" ImageUrl="~/images/print.gif" runat="server"  visible="true" />&nbsp;
    <asp:ImageButton ClientIDMode="Static" AlternateText="Export" ToolTip="Export to excel file" visible="false"
        ID="ibExport" ImageUrl="~/images/Export_Exl.jpg" runat="server" OnClick="ibExport_Click" OnClientClick="return validateform();" />
    <asp:ImageButton ClientIDMode="Static" AlternateText="Export to PDF" ToolTip="Export to pdf file"
        ID="imgPDF" ImageUrl="~/images/pdf.jpg" runat="server" visible="true"
        OnClick="imgPDF_Click" height="17%" width="17%" OnClientClick="return validateform();" />
...
<asp:content id="Content4" contentplaceholderid="cpSubHeader" runat="Server">
                ...
                <tr class="even">
                    ...
                    <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlcourse" runat="server" SkinID="ddl250" AutoPostBack="True" Enabled="false"
        ...
        <tr class="even">
            ...
            <td style="width: 33%;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                 <asp:DropDownList ID="ddlExamCycle" runat="server" SkinID="ddl250" AutoPostBack="True" Enabled="false"
                                    OnSelectedIndexChanged="ddlExamCycle_SelectedIndexChanged">
                                     <asp:ListItem Value="1">Half Yearly</asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
    ...
    <div style="text-align: right; margin-top: 10px">
          <asp:Button ID="btnShowReport" runat="server" Text="View " OnClientClick="return validateform();"
...
<asp:content id="Content2" contentplaceholderid="cpReportHeader" runat="Server">
    Protsahan Puraskar Candidates Report (Finance)</asp:content>
...
<asp:content id="Content6" contentplaceholderid="cpReportData" runat="Server">
    ...
    <asp:Label ID="lblheading" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar Candidates Report (Finance)" Visible="false"></asp:Label>     
