...
public partial class NielitCentreStudentsTrainedRep : BasePage
{   
    Table tbl = new Table();  
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "HO/Rpt/NielitCentreStudentTrainedFilter.aspx"))
            {
    ...
    public DataTable GetStudentTrained(Int64 centreId,string centreType, DateTime FromDate, DateTime ToDate)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("GetStudentsTrainedCentre", con))
            {
