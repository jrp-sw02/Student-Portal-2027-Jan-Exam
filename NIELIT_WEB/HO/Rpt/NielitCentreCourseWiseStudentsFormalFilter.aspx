<%@ Page Title="NIELIT Center CourseWise Students Details Report" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true" CodeFile="NielitCentreCourseWiseStudentsFormalFilter.aspx.cs"
     Inherits="NielitCentreCourseWiseStudentsFormalFilter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" Runat="Server">
    NIELIT Center CourseWise Students Details Formal Report
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow()
        {
            ...
            var Bid = document.getElementById('<%=ddlBatch.ClientID %>').value;
            var Sid = document.getElementById('<%=ddlSemesterNo.ClientID %>').value;

            var url = "NielitCentreCourseWiseStudentsFormalRep.aspx?startDate=" + startDate + "&endDate=" + endDate + "&courseCat=" + courseCat + "&centreID=" + centreID + "&courseID=" + courseID + "&Bid=" + Bid + "&Sid=" + Sid;
            window.open(url);
      ...
      <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
        width="100%">
            <tr>
                <td style="width: 34%;" valign="top" colspan="3">
          ...
          <tr class="even">
               <td style="width: 34%;" valign="top" colspan="3">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                <asp:DropDownList ID="ddlCentreName" runat="server" Style="width: 375px;" AutoPostBack="True"
        ...
        <tr>
            ...
            <td style="width: 33%;" valign="top">
                <asp:Label ID="Label2" runat="server" SkinID="CaptionLabel" Text="Batch &lt;b class='mandatory'&gt;&lt;/b&gt;"></asp:Label>
            </td>
        </tr>
        ...
        <tr class="even">
            ...
            <td style="width: 33%;" valign="top" >
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlBatch" runat="server" AutoPostBack="True" Height="22px" Style="width: 270px;"  OnSelectedIndexChanged="ddlBatch_SelectedIndexChanged">
        ...
        <tr>
            ...
            <td width="33%">
                <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Start Date From &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
            </td>
            <td width="33%">
                <asp:Label ID="Label9" runat="server" SkinID="CaptionLabel" Text="Start Date To &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
            </td>
            <td style="width: 33%;" valign="top">
                <asp:Label ID="Label5" runat="server" SkinID="CaptionLabel" Text="Semester &lt;b class='mandatory'&gt;&lt;/b&gt;"></asp:Label>
            </td>
