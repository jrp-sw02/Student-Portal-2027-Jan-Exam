<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Report.master" CodeFile="QuarterYearTrained.aspx.cs" Inherits="HO_Rpt_QuarterYearTrained" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpReportHeader" runat="Server">
    Trained On-Campus/Off-Campus in Quarter and Year
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    <div id="pdf" runat="server">
        <div id="divpdf" class="text-center" style="font-size: small; color: darkslateblue"  runat="server" visible="false">
            <h2>Trained On-Campus/Off-Campus in a Quarter and Year<br />
            </h2>
        </div>
