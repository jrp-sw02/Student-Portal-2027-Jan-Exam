<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Report.master" 
    CodeFile="NielitCentrePeriodWiseStudentRep.aspx.cs" Inherits="NielitCentrePeriodWiseStudentRep" Debug="false" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    <div id="pdf" runat="server">
        <div id="divpdf" class="text-center" style="font-size: small; color: darkslateblue"  runat="server" visible="false">
            <h2>Nielit Centre PeriodWise Students Report<br />
            </h2>
        </div>
        ...
        <table width="100%" id="trdata" runat="server">            
            ...
            <tr>
                <td align="left">
                    ...
                    <%--<asp:Label Width="100%" EnableTheming="false" ID="Label1"
