...
public partial class EELTPStudentsCenterWise : BasePage
{
    Table tbl = new Table();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "Common/EELTPStudentsCenterWiseFilter.aspx"))
            {
    ...
    {      
        try
        {
            ...
            SqlCommand scCommand = new SqlCommand("GetStudentsDetailsProjectWiseCenterWiseEELTP", new SqlConnection(con.ConnectionString));
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    tdRow12a.Text = ds.Tables[0].Rows[i]["Number"].ToString();
                    ...
                    TableCell tdRow5a = new TableCell();
                    tdRow5a.Width = Unit.Percentage(15);
                    tdRow5a.Text = ds.Tables[0].Rows[i]["is_EWS"].ToString();
                    tdRow5a.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow5a);

                    TableCell tdRow14 = new TableCell();
                    tdRow14.Width = Unit.Percentage(15);
                    tdRow14.Text = ds.Tables[0].Rows[i]["State"].ToString();
                    tdRow14.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow14);

                    TableCell tdRow9 = new TableCell();
                    tdRow9.Width = Unit.Percentage(15);
                    tdRow9.Text = ds.Tables[0].Rows[i]["District"].ToString();
                    tdRow9.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow9);

                    TableCell tdRow10 = new TableCell();
                    tdRow10.Width = Unit.Percentage(15);
                    tdRow10.Text = ds.Tables[0].Rows[i]["TPName"].ToString();
                    tdRow10.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow10);

                    TableCell tdRow11 = new TableCell();
                    tdRow11.Width = Unit.Percentage(15);
                    tdRow11.Text = ds.Tables[0].Rows[i]["BatchNameCode"].ToString();
   ...
   {      
       ...
       try
       {
           ...
           tcCol3a.Width = Unit.Percentage(15);
           tcCol3a.Text = "Reference Number";
           ...
           TableHeaderCell tcCol15a = new TableHeaderCell();
           tcCol15a.Width = Unit.Percentage(20);
           tcCol15a.Text = "EWS ";
           tcCol15a.HorizontalAlign = HorizontalAlign.Center;
           th.Cells.Add(tcCol15a);
            ...
            tcCol13.Width = Unit.Percentage(20);
            tcCol13.Text = "District ";
    ...
    {        
        ...
        {        
           ...
           // Document pdfDoc = new Document(PageSize.A4, 5f, 5f, 5f, 0f);
            ...
            Response.AddHeader("content-disposition", "attachment;filename=MisReportProjectWiseCenterWiseEELTP.pdf");
    ...
    protected void imgExcel_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            divReportData.Visible = true;
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=EELTPStudentDetail.xls");
            Response.Charset = "";
