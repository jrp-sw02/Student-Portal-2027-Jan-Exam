<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeptinAbeyanceReport.aspx.cs" Inherits="HO_Rpt_KeptinAbeyanceReport" MasterPageFile="~/MasterPages/Report.master" %>
...
<asp:content id="Content2" contentplaceholderid="cpReportHeader" runat="Server">
    List of Kept in Abeyance Candidates
</asp:content>
...
<asp:content id="Content6" contentplaceholderid="cpReportData" runat="Server">
    <table width="100%">
        <tr>
            ...
            <td align="right">
                <asp:Label Width="100%" EnableTheming="false" ID="lblCount" Visible="false" runat="server"
