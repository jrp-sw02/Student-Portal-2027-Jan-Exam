<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true"
    CodeFile="NielitCentreStudentTrainedFilter.aspx.cs" Inherits="HO_NielitCentreStudentTrainedFilter" Debug="TRUE" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
           ...
           // window.open("NielitCentreStudentsTrainedRep.aspx?centreId=" + InstId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&centrytype=" & centreType, 'report', 'width=1100,height=600,menubar=no,titlebar=no,toolbar=no,status=no,scrollbars=yes,dependent=yes,resizable=yes', false);
            ...
            window.open("NielitCentreStudentsTrainedRep.aspx?centreId=" + InstId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&centreType=" + centreType, 'report', 'width=1100,height=600,menubar=no,titlebar=no,toolbar=no,status=no,scrollbars=yes,dependent=yes,resizable=yes', false);
                        return false;
