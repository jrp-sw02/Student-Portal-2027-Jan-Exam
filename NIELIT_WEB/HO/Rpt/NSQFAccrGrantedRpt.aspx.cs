...
public partial class NSQFAccrGrantedRpt : BasePage
{
    Table tbl = new Table();
    ...
    protected void ShowTableHeaderForStatisticsReport()
    {
        ...
        try
        {
            ...
            {
                tc1.Text = " NSQF Accredidation Courses Grant From " + txtPaymentFromDate.Text + " To " + txPaymentToDate.Text + "";
            }
            else
            {
                tc1.Text = RdoNSQFCourseRptChoice.SelectedItem.Text.ToUpper() + "  Report of NSQF Accredidation Courses Grant";
           ...
           // th2.Cells.Add(tc2);
            ...
            tcCol7.Text = "NSQF Course(s) Granted Accreditation";
    ...
    {      
        try
        {
           ...
           // EConnect.Connections.SqlCon con = new EConnect.Connections.SqlCon();
            ...
            SqlCommand scCommand = new SqlCommand("getGridNSQFFreeCoursesGrantReport", new SqlConnection(con.ConnectionString));
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    tdRow3.Text = ds.Tables[0].Rows[i]["InstituteName"].ToString();
                    tdRow3.HorizontalAlign = HorizontalAlign.Center;
                    tr.Cells.Add(tdRow3);

                    TableCell tdRow33 = new TableCell();
                    tdRow33.Width = Unit.Percentage(5);
                    string s = ds.Tables[0].Rows[i]["InstAddress"].ToString();
