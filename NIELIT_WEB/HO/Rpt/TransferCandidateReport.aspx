<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferCandidateReport.aspx.cs" Inherits="HO_Rpt_TransferCandidateReport" MasterPageFile="~/MasterPages/Report.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpReportHeader" runat="Server">
    Registration Statistics of Level Transfer 
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    ...
    <asp:Label id="lberror" runat="server" CssClass="error"  EnableTheming="false" Width="100%" Visible="false" ></asp:Label> 
</asp:Content>
