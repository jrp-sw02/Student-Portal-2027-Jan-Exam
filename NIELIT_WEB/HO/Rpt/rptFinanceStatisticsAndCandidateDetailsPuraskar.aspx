<%@ Page Title="Protsahan Puraskar Students Report" Language="C#" MasterPageFile="~/MasterPages/Report.master" AutoEventWireup="true"
    CodeFile="rptFinanceStatisticsAndCandidateDetailsPuraskar.aspx.cs" Inherits="rptFinanceStatisticsAndCandidateDetailsPuraskar" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateform() {
            ...
            if (!isSelected("<%=ddlcourse.ClientID %>", "Course Name"))
                return false;
            if (!isBlankDate("<%=txtPaymentFromDate.ClientID %>", "Payment From Date", "dd-MMM-yyyy"))
                return false;
            if (!isBlankDate("<%=txPaymentToDate.ClientID %>", "Payment To Date", "dd-MMM-yyyy"))
                return false;
    ...
    <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
        ...
        <tr>
            ...
            <td align="left" valign="top" >
                                <asp:Label ID="Label1" runat="server" Text="Payment From Date &lt;b class='mandatory'&gt;*&lt;/b&gt;">
                                </asp:Label>
                            </td>
           
          <td align="left" valign="top" >
                                <asp:Label ID="Label2" runat="server" Text="Payment To Date &lt;b class='mandatory'&gt;*&lt;/b&gt;">
                                </asp:Label>
                            </td>
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
             <asp:TextBox ID="txtPaymentFromDate" runat="server" MaxLength="11" onpaste="return false;" Width="200px" ReadOnly="false" ></asp:TextBox>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
            <asp:TextBox ID="txPaymentToDate" runat="server" MaxLength="11" onpaste="return false;" Width="200px"></asp:TextBox>
...
<asp:content id="Content6" contentplaceholderid="cpReportData" runat="Server">
    ...
    <asp:Label ID="lblheading" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar Statistics Report (Finance)" Visible="false"></asp:Label>     
     <asp:Label ID="lblheadingCandDetails" runat="server" ForeColor="blue" Font-Bold="true"
                    Text="Protsahan Puraskar  Candidates Details Report (Finance)" Visible="false"></asp:Label><br /><br />
