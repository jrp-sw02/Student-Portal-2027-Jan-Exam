<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Report.master" CodeFile="CentreWiseSemesterDetailsFormal.aspx.cs" 
    Inherits="HO_Rpt_CentreWiseSemesterDetailsFormal" Debug="false" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    <div id="pdf" runat="server">
        <div id="divpdf" class="text-center" style="font-size: small; color: darkslateblue"  runat="server" visible="false">
            <h2>Certre Wise Semester Details<br />
            </h2>
        </div>
            ...
            <tr>
                <td align="left">
                    <asp:Label Width="100%" EnableTheming="false" ID="lblCount"
                        runat="server" Text="Total Records:"></asp:Label>
                </td>
                <td align="left">
