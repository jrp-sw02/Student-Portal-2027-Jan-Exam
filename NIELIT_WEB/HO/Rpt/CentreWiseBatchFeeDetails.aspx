<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Report.master" CodeFile="CentreWiseBatchFeeDetails.aspx.cs" Inherits="HO_Rpt_CentreWiseBatchFeeDetails" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cpReportData" runat="Server">
    <div id="pdf" runat="server">
        <div id="divpdf" class="text-center" style="font-size: small; color: darkslateblue"  runat="server" visible="false">
            <h2>Certre Wise Batch Fees Details<br />
            </h2>
        </div>
