...
public partial class rptFinanceStatisticsAndCandidateDetailsPuraskar : BasePage
{
    Table tbl = new Table();
    ...
    protected void ShowTableHeaderForStatisticsReport()
    {
        ...
        try
        {
            ...
            tc1.ColumnSpan = 7;
            tc1.Text = "Statistics Report of Protsahan Puraskar  (Finance)  From " + txtPaymentFromDate.Text + " To " + txPaymentToDate.Text + "";
        ...
        {    
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    tdRow2.Text = ds.Tables[0].Rows[i]["Course"].ToString();
                    ...
                    tdRow3.Text = Convert.ToDateTime(ds.Tables[0].Rows[i]["PaymentDate"]).ToString("dd/MMM/yyyy");
                    ...
                    tdRow16.Text = Convert.ToDateTime(ds.Tables[0].Rows[i]["SettledDate"]).ToString("dd/MMM/yyyy");
                    ...
                    tdRow4.Text = ds.Tables[0].Rows[i]["NoOfCandidates"].ToString();
                    ...
                    tdRow5.Text = ds.Tables[0].Rows[i]["TotalAmountpaid"].ToString();
                    ...
                    tdRow7.Text = ds.Tables[0].Rows[i]["PaymentStatus"].ToString();
   ...
   protected void btnShowCandidateDetails_Click(object sender, EventArgs e)
    ...
    protected void imgPDF_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {        
            ...
            if (hddbtnR.Value == "1" && hddbtnR.Value!="")
            {
                ShowData();
            }
            else if (hddbtnR.Value == "2" && hddbtnR.Value != "")
            {
                ShowCandidatesDetailsData();
            }
              ...
              {
                   ShowAlert("Please generate the report.");
               return;
              }
            divReportData.Controls.Add(tbl);
