...
public partial class HO_Rpt_MISReportConsolidated : BasePage
{
    ...
    private void LoadProjects()
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand("nfillprojectsforConsolidatedReport", con))
            {
            ...
            ddlProjects.Items.Insert(1, new System.Web.UI.WebControls.ListItem("All Projects", "-1"));
        }
        catch (Exception ex)
        {
            ShowAlert(ex.Message);
