<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true"
    CodeFile="NielitCentreStudentInstalmentDetailsRepFilter.aspx.cs" Inherits="HO_NielitCentreStudentInstalmentDetailsRepFilter" Debug="true" %>
...
<asp:content id="Content2" contentplaceholderid="chpHeading" runat="Server">
    Nielit Centre Student Installment Details Filter
</asp:content>
    ...
    <script type="text/javascript" language="javascript">
        function OpenWindow() {
           ...
           if (document.getElementById('<%=RdoAffInstOrNonAffInst.ClientID %>').value == "2")
            ...
            //View report                       
            window.open("NielitCentreStudentInstalmentDetailsRep.aspx?CourseId=" + CourseId + "&InstId=" + InstId + "&CourseCatId=" + CourseCatId + "&BatchId=" + BatchId, 'report', 'width=1100,height=600,menubar=no,titlebar=no,toolbar=no,status=no,scrollbars=yes,dependent=yes,resizable=yes', false);
             return false;
         }
    </script>
