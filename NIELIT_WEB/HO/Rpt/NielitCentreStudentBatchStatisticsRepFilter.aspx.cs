...
public partial class HO_NielitCentreStudentBatchStatisticsRepFilter : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try 
        {
            BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("Nielit Centre Student Batch Statistics", "HO/Rpt/NielitCentreStudentBatchFilter.aspx", ""));
                 ...
                 if (coursecatID != 0)
                 {
                     using (NIELITMISContext context = new NIELITMISContext())
                     {
                         ...
                         var CourseList = from p in context.NielitCentreCourses 
                                          ...
                                          orderby (p.Name)
                                          select new { ValueField = d.ID, TextField = p.Name };
