<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VirtualAcademyDayWisePayment.aspx.cs" Inherits="HO_Rpt_VirtualAcademyDayWisePayment"  MasterPageFile="~/MasterPages/Report.master" Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpReportHeader" runat="Server">
    Virtual Academy Day Wise Payment Report
</asp:Content>
