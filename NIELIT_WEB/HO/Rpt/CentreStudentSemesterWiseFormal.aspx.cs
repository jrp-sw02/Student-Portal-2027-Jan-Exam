...
public partial class ReportPgae : BasePage
    {   //CentreStudentSemesterWiseFormal
    Table tbl = new Table();  
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // ShowTableHeader();
            ...
            if (!UserManager.HasRight(currentRoleId, enmRight.View, "Common/CentreStudentSemesterWiseFilterFormal.aspx"))
            {
    ...
    protected void ShowTableHeader()
    {
        try
        {
            ...
            Int64 SemNo = Convert.ToInt64(Request.QueryString["SemNo"]);
            // String CourseName = Request.QueryString["CName"].ToUpper().ToString();
            String CourseName = "TestingCourse....", BatchName="", BatchCode="";
            ...
            {
            if (CourseCatId != 0 && CourseId != 0 && BatchId != 0 && SemNo != 0)
                    {                    
                        //NielitCentreCourse cName = context1.NielitCentreCourses.Where(s => s.ID == CourseId).FirstOrDefault();
                    Int64 courseId = context1.NielitCourseDurations.Find(CourseId).courseID;
                    string courseName = context1.NielitCentreCourses.Find(courseId).Name;
            ...
            tc1.ColumnSpan = 12;
            tc1.Text = " Report of Course ( " + CourseName + "  ) Batch Name: " + BatchName + " <br/>  Semester No : " + SemNo + " "; //<br/>  Batch Code : " + BatchCode + " ";
        ...
        try
        {
            ...
            using (DataTable dt = GetStudentData(InstituteID, BatchId))
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (SemNo != 0)
                    {
                        application = application.Where(s => s.SemmNo == SemNo).ToList();
    ...
    public DataTable GetStudentData(Int64 InstituteID, Int64 BatchId)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("GetStudentDataBatchWiseForFormal", con))
            {
    ...
    {      
        ...
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=CentreStudentSemesterWiseFormalReport.pdf");
    ...
    protected void ibExport_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            divReportData.Controls.Add(tbl);
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=CentreStudentSemesterWiseFormalReport.xls");
            Response.Charset = "";
