<%@ Page Title="NIELIT Center CourseWise Students Details Report" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true" CodeFile="NielitCentreCourseWiseStudentsFilter.aspx.cs"
    Inherits="NielitCentreCourseWiseStudentsFilter" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
            ...
            var url = "NielitCentreCourseWiseStudentsRep.aspx?startDate=" + startDate + "&endDate=" + endDate + "&courseCat=" + courseCat + "&centreID=" + centreID + "&courseID=" + courseID;
            window.open(url);
