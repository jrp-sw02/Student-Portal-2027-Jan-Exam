<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeFile="AffidavitEntryNew.aspx.cs" Inherits="HO_AffidavitEntryNew" Debug="false"  %>

<%@ Register Src="../UserControl/BreadCrumb.ascx" TagName="BreadCrumb" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    Guardian Affidavit Entry Process (New cases) 
</asp:Content>
    ...
    <div class="box" id= "DivSearch" runat="server">
        <table class="sample3" width="100%" border="0" cellpadding="2" cellspacing="0">
            ...
            <tr class="gdrow1">
                ...
                <td>
                    <asp:Label ID="lblRegNo" runat="server" Text="Application  Number &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
                </td>
                <td>
            ...
            <asp:Panel ID="PnlCandidate" runat="server" Visible="False">
                ...
                <table border="0" cellpadding="2" cellspacing="1" class="sample3" style="width: 100%;">
                    ...
                    <tr class="gdalternate1">
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Application Number "></asp:Label>
                        </td>
                        <td>
