<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true" CodeFile="EELTPStudentsCenterWiseFilter.aspx.cs" Inherits="Common_EELTPStudentsCenterWiseFilter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" Runat="Server">
      Details Of Students  for EELTP Project CenterWise  
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">
      ...
      <table class="sample2" id="tbls2" runat="server" cellpadding="0" cellspacing="0"
        ...
        <tr class="even">
            <td style="width: 36%;" valign="top">
                <asp:DropDownList ID="ddlProjectName" runat="server" SkinID="ddl250" 
                   Enabled="false" EnableTheming="True" Height="16px" Width="187px">
