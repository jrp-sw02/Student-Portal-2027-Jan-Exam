<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterdCandidateFilter.aspx.cs"
    Inherits="Common_RegisterdCandidateFilter" MasterPageFile="~/MasterPages/MyInfo.master" Debug="false" %>
...
<asp:content id="Content5" contentplaceholderid="cphContents" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
            ...
            //View report
            window.open("../HO/Rpt/RegisterdCandidateReport.aspx?ExamId=" + ExamId + "&CourseId=" + CourseId + "&RegTypeID=" + RegtypeID + "&TypeId=" + TypeId);
            return false;
        }
    ...
    <table class="sample2" width="100%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr id="TrExamHead" runat="server">
            ...
            <td>
                <asp:Label ID="Label1" runat="server" SkinID="CaptionLabel" Text="Registration Type"></asp:Label>
            </td>
        </tr>
        <tr id="TrExamInput" runat="server" class="even">
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                    <ContentTemplate>
                          <asp:DropDownList ID="ddlregtype" runat="server" Height="22px" SkinID="ddl250" 
                            AutoPostBack="True" >
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
