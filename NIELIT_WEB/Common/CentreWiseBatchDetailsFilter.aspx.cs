...
public partial class Common_CentreWiseBatchDetailsFilter : System.Web.UI.Page
{
    ...
    public void bindCentre()
    {
        try
        {
            using (NIELITMISContext context = new NIELITMISContext())
            {
                ...
                //txtBatchFrom.Text= UserTypeId.ToString();
                if (loginUserType == UserType.Admin || loginUserType == UserType.HeadOffice)
                {
