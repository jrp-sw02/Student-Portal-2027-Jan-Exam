<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/MyInfo.master" CodeFile="CentreWiseBatchFeeDetailsFilter.aspx.cs" Inherits="Common_CentreWiseBatchFeeDetailsFilter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    Centre Wise Batch Fees Details Report
</asp:Content>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
            ...
            if (reportId == "C") {
                ...
                window.open("../HO/Rpt/CentreWiseBatchFeeDetails.aspx?centreId=" + centreId + "&reportId=" + reportId + "&courseId=" + courseId + "&batchId=" + batchId);
                return false;
            }
            else if (reportId == "D") {
                // Batch Dates
            ...
            var batchFromDate = document.getElementById('<%=txtBatchFrom.ClientID %>').value;
                ...
                window.open("../HO/Rpt/CentreWiseBatchFeeDetails.aspx?centreId=" + centreId + "&reportId=" + reportId + "&batchFromDate=" + batchFromDate + "&batchToDate=" + batchToDate);
                return false;
            }
        ...
        <tr class="even">
            ...
            <td>
                        ...
                        <asp:DropDownList ID="ddlReportType" runat="server" Height="22px" SkinID="ddl250" 
                            ...
                            <asp:ListItem Value="C">Batch Fees of a course</asp:ListItem>
                            <asp:ListItem Value="D">Batch Fees for a batch within dates</asp:ListItem>
                        </asp:DropDownList>
