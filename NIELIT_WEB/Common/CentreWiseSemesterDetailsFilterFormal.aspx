<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/MyInfo.master" CodeFile="CentreWiseSemesterDetailsFilterFormal.aspx.cs"
     Inherits="Common_CentreWiseSemesterDetailsFilterFormal" Debug="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    Centre Wise Semester Details Report
</asp:Content>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenWindow() {
            ...
            if (reportId == "C") {
                ...
                window.open("../HO/Rpt/CentreWiseSemesterDetailsFormal.aspx?centreId=" + centreId + "&reportId=" + reportId + "&courseId=" + courseId + "&batchId=" + batchId);
                return false;
            }
            else if (reportId == "D") {
                // Batch Dates
            ...
            var batchFromDate = document.getElementById('<%=txtBatchFrom.ClientID %>').value;
                ...
                window.open("../HO/Rpt/CentreWiseSemesterDetailsFormal.aspx?centreId=" + centreId + "&reportId=" + reportId + "&batchFromDate=" + batchFromDate + "&batchToDate=" + batchToDate);
                return false;
            }
        ...
        <tr class="even">
                ...
                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlCentreName" runat="server" Height="22px" SkinID="ddl250" 
                            AutoPostBack="True" OnSelectedIndexChanged="ddlCentreName_SelectedIndexChanged">
            ...
            <td>
                        ...
                        <asp:DropDownList ID="ddlReportType" runat="server" Height="22px" SkinID="ddl250" 
                            ...
                            <asp:ListItem Value="0">--Select One--</asp:ListItem>
                            <asp:ListItem Value="C">Semester of a Batch</asp:ListItem>
