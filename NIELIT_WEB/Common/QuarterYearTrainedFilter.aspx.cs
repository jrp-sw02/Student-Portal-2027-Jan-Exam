...
public partial class Common_QuarterYearTrainedFilter : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                bindCentre();
                bindYear();
               // txtFromDate.Text =System .DateTime .Today .ToString ("dd-MMM-yyyy");
            }
            BreadCrumb1.Render();
        }
        catch (Exception ex)
    ...
    protected void bindYear()
    {
        ...
        ddlYear.Items[0].Value = "99";
        for (int i = System.DateTime.Today.Year; i >= 2013; i--)
