...
public partial class Common_RunningProjStatusFilter : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                bindCentre();
                txtAsOnDate.Text =System .DateTime .Today .ToString ("dd-MMM-yyyy");
            }
            BreadCrumb1.Render();
        }
        catch (Exception ex)
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        try
        {
          ...
          //  ddlReportType.SelectedValue = "0";
            ...
            txtAsOnDate.Text = System.DateTime .Today.ToString ("dd-Mon-yyyy") ;
         //   txtBatchto.Text = "";
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                lblerror.Text ="Please select centre";
                return;
            }
            centreId =Convert.ToInt32 (ddlCentreName .SelectedValue );
           ...
           asOnDate =Convert.ToDateTime (txtAsOnDate .Text );
            Response .Redirect ("../HO/Rpt/RunningProjStatus.aspx?centreId=" + centreId + "&AsOnDate=" + asOnDate,true );
