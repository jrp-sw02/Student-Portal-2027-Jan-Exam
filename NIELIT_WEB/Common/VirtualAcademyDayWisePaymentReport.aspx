<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VirtualAcademyDayWisePaymentReport.aspx.cs"
    Inherits="Common_VirtualAcademyDayWisePaymentReport" MasterPageFile="~/MasterPages/main.master" Debug="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        function validateFormFields() {
            ...
            if (AppTypeId == '4') {
                //var url = "../HO/Rpt/DayWisePaymentModuleCertificate.aspx?PayModeId=" + PayModeId + "&TransTypeId=" + TransTypeId + "&CourseId=" + CourseId + "&PayFromDate=" + PayFromDate + "&PayToDate=" + PayToDate + "&AppTypeId=" + AppTypeId + "&PayStatusId=" + PayStatusId + "&Datetype=" + datetype;
             }
            else {
                ...
                var url = "../HO/Rpt/VirtualAcademyDayWisePayment.aspx?PayModeId=" + PayModeId + "&TransTypeId=" + TransTypeId + "&CourseCatId=" + CourseCatId + "&CourseId=" + CourseId + "&PayFromDate=" + PayFromDate + "&PayToDate=" + PayToDate + "&AppTypeId=" + AppTypeId + "&PayStatusId=" + PayStatusId + "&Datetype=" + datetype;
            }
             window.open(url);
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="chpHeading" runat="Server">
    <asp:Label ID="lblHeading" Text=" Virtual Academy Day Wise Payment Report" runat="server"></asp:Label>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" runat="Server">
    ...
    <div style="text-align: right; margin-top: 10px">
        <asp:Button ID="btnView" runat="server" Text="View" OnClientClick="return validateFormFields()" OnClick="btnView_Click1" />
