<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyInfo.master" AutoEventWireup="true" CodeFile="CentreStudentSemesterWiseFilterFormal.aspx.cs"
    Inherits="Common_CentreStudentSemesterWiseFilterFormal" Debug="false" %>
...
<asp:content id="Content2" contentplaceholderid="chpHeading" runat="Server">
    Nielit Centre Student Smester Formal Filter
</asp:content>
...
<asp:content id="Content5" contentplaceholderid="cphContents" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function OpenWindow() {
            ...
            //
            var SemNo;
            if (document.getElementById('<%=ddlSemesterNo.ClientID %>').value != "0")
                SemNo = document.getElementById('<%=ddlSemesterNo.ClientID %>').value;
            else {

                alert("Please Select Semester Number !");
                return false;
            }
            //
            //Cast Category 
            ...
            //Project Name   ddlProjectName
            var ProjName = "0";
            //if (document.getElementById('<%=ddlWhProjectStudent.ClientID %>').value != "")
            //ProjName = document.getElementById('<%=ddlWhProjectStudent.ClientID %>').value;
            ...
            //View report                       
            window.open("../HO/Rpt/CentreStudentSemesterWiseFormal.aspx?CourseId=" + CourseId + "&InstId=" + InstId + "&CourseCatId=" + CourseCatId + "&BatchId=" + BatchId + "&SemNo=" + SemNo + "&Category=" + Category + "&Gender=" + Gender + "&PhyH=" + PhyH + "&WhProStu=" + WhProStu + "&ProjName=" + ProjName, 'report', 'width=1100,height=600,menubar=no,titlebar=no,toolbar=no,status=no,scrollbars=yes,dependent=yes,resizable=yes', false);
 ...
 <tr id="rdoRow1" runat="server">
         ...
         <tr class="even" id="rdoRow2" runat="server">
                    <td colspan="2" style="width: 66%;" valign="top">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="Label6" runat="server" SkinID="CaptionLabel" Text="Semester Number &lt;b class='mandatory'&gt;*&lt;/b&gt;"></asp:Label>
            </td>
            <td>
        ...
        <tr class="even" >
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                        <asp:DropDownList ID="ddlSemesterNo" Width="100%" runat="server" SkinID="ddl250"  OnSelectedIndexChanged="ddlSemesterNo_SelectedIndexChanged" >
                             <asp:ListItem Value="0" Text="--Select One--"></asp:ListItem>
                        </asp:DropDownList>
                                                </ContentTemplate>
</asp:UpdatePanel>
        ...
        <tr>
            <td >
                <asp:Label ID="Label8" runat="server" SkinID="CaptionLabel" Text="Cast Category"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label9" runat="server" SkinID="CaptionLabel" Text="Whether project student"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label10" runat="server" SkinID="CaptionLabel" Text="Whether Physically Handicapped"></asp:Label>
                <%--<asp:Label ID="Label10" runat="server" SkinID="CaptionLabel" Text="Project name"></asp:Label>--%>
