<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtsahanPuraskarInstructions.aspx.cs"
    Inherits="ProtsahanPuraskarInstructions" Debug="false" %>
    ...
    <div style="width: 100%; text-align: left;">
        <table align="center" class="sample3" width="98%" cellpadding="3" cellspacing="0">
            ...
            <tr class="gdalternate1">
                <td>
                    <strong style="font-size: large;" class="header">Protsahan Puraskar Payment instructions
                       </strong>
            ...
            <tr>
                <td colspan="2">
                    <iframe runat="server" id="ifrmAboutUs1" width="100%" height="350px" frameborder='0'
         ...
         <tr class="gdalternate1">
            ...
            <tr class="gdalternate1">
                        ...
                        <tr>
                            <td style="text-align: justify;" class="odd1">
                                <asp:CheckBox ID="chk1" runat="server" TabIndex="40" Text="<font color='RED'>*</font>"
                                    align="left" />
                                <span id="spancourse" runat="server" visible="true">
                                    I, hereby declare that, I have read all the instructions carefully and I have read the information document also.
                                </span> 
                ...
                <td align="center" colspan="3" >
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Proceed" TabIndex="42" class="odd"
