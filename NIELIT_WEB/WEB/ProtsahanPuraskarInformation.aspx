<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtsahanPuraskarInformation.aspx.cs"
    Inherits="ProtsahanPuraskarInformation" Debug="false" %>
...
<body style="background-color: White;">
    ...
    <div style="width: 100%; text-align: left;">
        <table align="center" class="sample3" width="98%" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td colspan="2">
                    <iframe runat="server" id="ifrmAboutUs2" width="100%" height="350px" frameborder='0'
