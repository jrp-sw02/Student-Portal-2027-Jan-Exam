...
public partial class ProtsahanPuraskarInformation : BasePage
{
        ...
        try
        {
            using (EConnectContext context = new EConnectContext())
            {
               ...
               var DownloadableFile = Downloadables.FirstOrDefault();
                ifrmAboutUs2.Attributes.Add("src", "../Handlers/UploadedFileHandler.ashx?ID=" + DownloadableFile.fileID);
            }
        }
        catch (Exception ex)
        {
