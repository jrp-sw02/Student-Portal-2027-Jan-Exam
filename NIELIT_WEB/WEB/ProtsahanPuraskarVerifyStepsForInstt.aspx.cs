...
public partial class ProtsahanPuraskarVerifyStepsForInstt : BasePage
{
        ...
        try
        {
            using (EConnectContext context = new EConnectContext())
            {
               ...
               var DownloadableFile = Downloadables.FirstOrDefault();
                ifrmAboutUs.Attributes.Add("src", "../Handlers/UploadedFileHandler.ashx?ID=" + DownloadableFile.fileID);
            }
        }
        catch (Exception ex)
        {
