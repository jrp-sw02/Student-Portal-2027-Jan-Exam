...
public partial class CCStatus : BasePage
{
            ...
            using (EConnectContext context = new EConnectContext())
            {
                ...
                if (currentCourse.enmCourseType == enmCourseType.CertificationCourse && (Request.QueryString["type"] == Convert.ToString(3)))
                {
                    if (Request.UrlReferrer.ToString().ToLower().Contains("aboutcourse.aspx"))
                        BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("View Course Status", "WEB/CCStatus.aspx?ID=" + Request.QueryString["id"], ""));
                    else
                        BreadCrumb1.UpdateLastBreadCrumbItem(new BreadCrumbItem("View Course Status", "WEB/CCStatus.aspx?ID=" + Request.QueryString["id"], ""));
                    lblheading.Text = "View Course Status ";
                ...
                {
                    if (Request.UrlReferrer.ToString().ToLower().Contains("aboutcourse.aspx"))
                        BreadCrumb1.AddNewBreadCrumbItem(new BreadCrumbItem("View Certificate Status", "WEB/CCStatus.aspx?ID=" + Request.QueryString["id"], ""));
                    else
                        BreadCrumb1.UpdateLastBreadCrumbItem(new BreadCrumbItem("View Certificate Status", "WEB/CCStatus.aspx?ID=" + Request.QueryString["id"], ""));
                    lblheading.Text = "View Certificate Status";
                    Lblsubheading.Text = "Course Name";
                    Lblcname.Text = currentCourse.Name;
                    Sidelink.Items.Add(new SideLinkItem("Apply Online", "RulesForOnlineRegistration.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/Apply_Online.jpg"));
                    Sidelink.Items.Add(new SideLinkItem("View Filled Form", "FilledForm.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/Get_Filled_Form.jpg"));
                    Sidelink.Items.Add(new SideLinkItem("Check Form Status", "ApplicationStatus.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/View_Application_Status.jpg"));
                    Sidelink.Items.Add(new SideLinkItem("Download Admit Card", "DownloadAdmitCard.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/Print_Admit_Card.jpg"));
                    Sidelink.Items.Add(new SideLinkItem("View Result", "Result.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/View_Result.jpg"));
                    Sidelink.Items.Add(new SideLinkItem("Search Centre", "FrmAccredetedCentre.aspx?ID=" + Request.QueryString["id"].ToString() + "&type=" + tt + "", "../images/View_Certificate_Status.jpg"));
                    Sidelink.SideLinkType = SideLinkItem.SideLinkType.ButtonWithImageLink;
                    Sidelink.Render();
                }
            };
