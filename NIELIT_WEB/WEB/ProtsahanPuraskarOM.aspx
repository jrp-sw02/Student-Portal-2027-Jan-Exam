<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtsahanPuraskarOM.aspx.cs"
    Inherits="ProtsahanPuraskarOM"  %>
    ...
    <div style="width: 100%; text-align: left;">
        <table align="center" class="sample3" width="98%" cellpadding="3" cellspacing="0">
            ...
            <tr class="gdalternate1">
                <td>
                    <strong style="font-size: large;" class="header">Protsahan Puraskar Office Memorandum
                       </strong>
