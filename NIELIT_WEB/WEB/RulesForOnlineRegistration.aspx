<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RulesForOnlineRegistration.aspx.cs"
    Inherits="RulesForOnlineRegistration" Debug="false" %>
        ...
        <table align="center" class="sample3" width="98%" cellpadding="3" cellspacing="0">
            ...
            <tr class="gdrow1" id="trnotification" runat="server" visible="false">
                <td colspan="4" style="font-size: 14px; text-align: justify; text-transform: inherit;">
                    <strong>Note:-</strong> If you are not already registered with NIELIT for any course(O/A/B/C)
                    level,please click on the agree and proceed button to apply for the course registration,otherwise
                    login into the online student and information system of NIELIT using your Login-ID
                    and password by clicking here <a href="../Index.aspx">Go to Home Page</a>.If you
                    ...
                    yourself with the online student and information system of NIELIT&nbsp; by clicking
                    here <a href="../RegisteredUser.aspx">Register</a>
                </td>
            </tr>
            <tr class="gdalternate1">
                <td colspan="4">
