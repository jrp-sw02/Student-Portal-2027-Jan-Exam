...
using System.Web;
    ...
    public class EncryptDecryptD : System.Web.IHttpModule, System.Web.SessionState.IRequiresSessionState
    {
        static SymmetricAlgorithm mobjCryptoService;

        static EncryptDecryptD()
        {
        ...
        public static string Decrypt(string url)
        {
            try
            {
                if (url.Contains("?qs="))
                {
                    ...
                    url = Decrypting(url.Substring(url.IndexOf('=') + 1), "test");
