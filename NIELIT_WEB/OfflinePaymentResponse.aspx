<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FullInfo.master" AutoEventWireup="true"
    CodeFile="OfflinePaymentResponse.aspx.cs" Inherits="OfflinePaymentResponse"%>
<%@ Register Src="~/usercontrol/normalheader.ascx" TagPrefix="uc" TagName="NormalHeader" %>
...
<uc:NormalHeader runat="server" ID="ucNormalHeader" />
    Paymment Response
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContents" Runat="Server"><br />
    <asp:Label Width="99%" EnableTheming="false" CssClass="error" ID="lblError" Visible="false"
        runat="server"></asp:Label>
    <div id="divResponse" runat="server" visible="false">
        <table id="tblResponse" width="100%" align="center" class="sample" runat="server" style="background-color: #ffffff;">
            <tr>
            ...
            <tr>
                ...
                <td class="even" id="tdPaymentDescription" style="line-height:1.6" runat="server" width="70%">
                </td>
            </tr>
            <tr>
                <td class="odd" width="30%">
            ...
            <tr runat="server" id="trExam" visible="false" >
                <td colspan="2" class="odd" align="left">
                   <b>Note:- <i>Please Attach the payment receipt alongwith your Form and send to the NIELIT Centre as indicated in the application form before last date.</i></b>
                </td>
            </tr>
             <%-- <tr runat="server" id="trReg" visible="false" >
                <td colspan="2" class="odd" align="left">
                   <b>Note:- <i>Please Attach the payment receipt alongwith your Form and send to the NIELIT Head Office as indicated in the application form before last date.</i></b>
                </td>
            </tr>--%>
             <tr>
                <td colspan="2" class="even" align="right">
                    <asp:Button ID="btnHome" runat="server" Text="Go to Home Page" class="even" 
