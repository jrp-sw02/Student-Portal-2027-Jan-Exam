...
{
    public class virtualAcademyCalendar
    {
        [Key]
        ...
        [Column("TimingsFrom")]
        [MaxLength(10)]
        public String TimingsFrom { get; set; }

        [Column("TimingsTo")]
        [MaxLength(10)]
        public String TimingsTo { get; set; }

        [Column("teachingLanguage", TypeName = "bigint")]
        public Int64 teachingLanguage { get; set; }

        [Column("secTeachingLanguage", TypeName = "bigint")]
        public Int64 secTeachingLanguage { get; set; }
