                    ...
                    <table style="width: 100%;" class="sample3" border="0" cellpadding="3" cellspacing="1">
                        ...
                        <tr class="gdalternate1" id="TrPreCentre"  runat="server">
                         ...
                         <tr class="gdalternate1" id="trappno"  runat="server" visible="false">
                            ...
                            <td width="40%" valign="top">
                                Course Type (Registration or Examination)                               
...
<!-- onpaste="return false;" oncopy="return false;" oncut="return false;"-->
                        ...
                        <tr class="gdalternate1">
                            ...
                            <td valign="top" width="57%" colspan="2">
                                <asp:Label ID="LblProjectname" runat="server"  SkinID="CaptionLabel" Text="Project Name :"
                                    ></asp:Label>
                    ...
                    <table id="TblFormDetail" runat="server" class="sample3" style="width: 100%; text-align: left"
                        ...
                        <tr class="head1" id="HeadAadhaartr" runat="server">
                            <td colspan="3">
                                6. Identification Details / पहचान की सूचना
                            </td>
                        </tr>
...
<!--onpaste="return false;" oncopy="return false;" oncut="return false;"-->
                        ...
                        <tr class="head1" id ="trCompanyDetails" runat="server" visible="false">
                            <td colspan="3">
                                7. Company Details / संस्थान के विवरण
                            </td>
                        </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="vertical-align:middle">
                                                    ...
                                                    <asp:ImageButton ID="ImgBtnRefresh" ImageUrl="~/images/refresh.jpg" runat="server"
                                                        CausesValidation="false" Width="30px" Style="vertical-align: top; padding-top: 0px;
                                                        border: none;" OnClick="ImgBtnRefresh_Click" TabIndex="50" />
                                                </td>                                             
                                            </tr>
                                            <tr>
                                                <td align="left">
                        ...
                        <tr id="trnote" runat="server" class="gdrow1" visible="false">
                            <td colspan="3">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <strong style="font-size: 14px; padding-left: 2px; text-align: justify; color: Red;">
                                            Note: Registration does not guarantee admission. It will depend on the availability
